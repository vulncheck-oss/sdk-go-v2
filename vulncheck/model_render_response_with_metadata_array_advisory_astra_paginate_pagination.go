...
// checks if the RenderResponseWithMetadataArrayAdvisoryAstraPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryAstraPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryAstraPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryAstraPaginatePagination
type RenderResponseWithMetadataArrayAdvisoryAstraPaginatePagination struct {
	Benchmark *float32 `json:"_benchmark,omitempty"`
	Meta *PaginatePagination `json:"_meta,omitempty"`
	Data []AdvisoryAstra `json:"data,omitempty"`
}
...
func NewRenderResponseWithMetadataArrayAdvisoryAstraPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryAstraPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryAstraPaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisoryAstra and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryAstraPaginatePagination) SetData(v []AdvisoryAstra) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryAstraPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryAstraPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryAstraPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryAstraPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryAstraPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryAstraPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryAstraPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryAstraPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryAstraPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryAstraPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryAstraPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryAstraPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryAstraPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryAstraPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryAstraPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryAstraPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
