...
// checks if the RenderResponseWithMetadataArrayAdvisoryCurlPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryCurlPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryCurlPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryCurlPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryCurlPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryCurlPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryCurlPaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisoryCurl and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryCurlPaginatePagination) SetData(v []AdvisoryCurl) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryCurlPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryCurlPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryCurlPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryCurlPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryCurlPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryCurlPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryCurlPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryCurlPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryCurlPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryCurlPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryCurlPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryCurlPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryCurlPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryCurlPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryCurlPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryCurlPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
