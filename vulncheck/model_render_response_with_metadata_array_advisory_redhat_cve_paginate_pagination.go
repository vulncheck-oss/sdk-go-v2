...
// checks if the RenderResponseWithMetadataArrayAdvisoryRedhatCVEPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryRedhatCVEPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryRedhatCVEPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryRedhatCVEPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryRedhatCVEPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryRedhatCVEPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryRedhatCVEPaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisoryRedhatCVE and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryRedhatCVEPaginatePagination) SetData(v []AdvisoryRedhatCVE) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryRedhatCVEPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryRedhatCVEPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryRedhatCVEPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryRedhatCVEPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryRedhatCVEPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryRedhatCVEPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryRedhatCVEPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryRedhatCVEPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryRedhatCVEPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryRedhatCVEPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryRedhatCVEPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryRedhatCVEPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryRedhatCVEPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryRedhatCVEPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryRedhatCVEPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryRedhatCVEPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
