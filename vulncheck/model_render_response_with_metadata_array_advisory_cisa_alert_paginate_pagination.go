...
// checks if the RenderResponseWithMetadataArrayAdvisoryCISAAlertPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryCISAAlertPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryCISAAlertPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryCISAAlertPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryCISAAlertPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryCISAAlertPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryCISAAlertPaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisoryCISAAlert and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryCISAAlertPaginatePagination) SetData(v []AdvisoryCISAAlert) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryCISAAlertPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryCISAAlertPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryCISAAlertPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryCISAAlertPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryCISAAlertPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryCISAAlertPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryCISAAlertPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryCISAAlertPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryCISAAlertPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryCISAAlertPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryCISAAlertPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryCISAAlertPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryCISAAlertPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryCISAAlertPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryCISAAlertPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryCISAAlertPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
