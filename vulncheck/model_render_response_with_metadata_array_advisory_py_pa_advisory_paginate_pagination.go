...
// checks if the RenderResponseWithMetadataArrayAdvisoryPyPAAdvisoryPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryPyPAAdvisoryPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryPyPAAdvisoryPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryPyPAAdvisoryPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryPyPAAdvisoryPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryPyPAAdvisoryPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryPyPAAdvisoryPaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisoryPyPAAdvisory and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryPyPAAdvisoryPaginatePagination) SetData(v []AdvisoryPyPAAdvisory) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryPyPAAdvisoryPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryPyPAAdvisoryPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryPyPAAdvisoryPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryPyPAAdvisoryPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryPyPAAdvisoryPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryPyPAAdvisoryPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryPyPAAdvisoryPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryPyPAAdvisoryPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryPyPAAdvisoryPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryPyPAAdvisoryPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryPyPAAdvisoryPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryPyPAAdvisoryPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryPyPAAdvisoryPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryPyPAAdvisoryPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryPyPAAdvisoryPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryPyPAAdvisoryPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
