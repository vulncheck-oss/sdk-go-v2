...
// checks if the RenderResponseWithMetadataArrayAdvisoryZyxelPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryZyxelPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryZyxelPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryZyxelPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryZyxelPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryZyxelPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryZyxelPaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisoryZyxel and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryZyxelPaginatePagination) SetData(v []AdvisoryZyxel) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryZyxelPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryZyxelPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryZyxelPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryZyxelPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryZyxelPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryZyxelPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryZyxelPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryZyxelPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryZyxelPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryZyxelPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryZyxelPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryZyxelPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryZyxelPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryZyxelPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryZyxelPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryZyxelPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
