...
// checks if the RenderResponseWithMetadataArrayAdvisoryMetaDataPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryMetaDataPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryMetaDataPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryMetaDataPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryMetaDataPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryMetaDataPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryMetaDataPaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisoryMetaData and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryMetaDataPaginatePagination) SetData(v []AdvisoryMetaData) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryMetaDataPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryMetaDataPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryMetaDataPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryMetaDataPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryMetaDataPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryMetaDataPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryMetaDataPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryMetaDataPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryMetaDataPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryMetaDataPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryMetaDataPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryMetaDataPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryMetaDataPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryMetaDataPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryMetaDataPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryMetaDataPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
