...
// checks if the AdvisoryOpenJDKCVE type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AdvisoryOpenJDKCVE{}

// AdvisoryOpenJDKCVE struct for AdvisoryOpenJDKCVE
type AdvisoryOpenJDKCVE struct {
...
func (o AdvisoryOpenJDKCVE) MarshalJSON() ([]byte, error) {
...
func (o AdvisoryOpenJDKCVE) ToMap() (map[string]interface{}, error) {
...
type NullableAdvisoryOpenJDKCVE struct {
	value *AdvisoryOpenJDKCVE
	isSet bool
}

func (v NullableAdvisoryOpenJDKCVE) Get() *AdvisoryOpenJDKCVE {
	return v.value
}

func (v *NullableAdvisoryOpenJDKCVE) Set(val *AdvisoryOpenJDKCVE) {
	v.value = val
	v.isSet = true
}

func (v NullableAdvisoryOpenJDKCVE) IsSet() bool {
	return v.isSet
}

func (v *NullableAdvisoryOpenJDKCVE) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAdvisoryOpenJDKCVE(val *AdvisoryOpenJDKCVE) *NullableAdvisoryOpenJDKCVE {
	return &NullableAdvisoryOpenJDKCVE{value: val, isSet: true}
}

func (v NullableAdvisoryOpenJDKCVE) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAdvisoryOpenJDKCVE) UnmarshalJSON(src []byte) error {
	v.isSet = true
