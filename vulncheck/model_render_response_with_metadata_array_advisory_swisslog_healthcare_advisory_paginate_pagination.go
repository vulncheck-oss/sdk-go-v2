...
// checks if the RenderResponseWithMetadataArrayAdvisorySwisslogHealthcareAdvisoryPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisorySwisslogHealthcareAdvisoryPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisorySwisslogHealthcareAdvisoryPaginatePagination struct for RenderResponseWithMetadataArrayAdvisorySwisslogHealthcareAdvisoryPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisorySwisslogHealthcareAdvisoryPaginatePagination() *RenderResponseWithMetadataArrayAdvisorySwisslogHealthcareAdvisoryPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisorySwisslogHealthcareAdvisoryPaginatePagination{}
	return &this
}
...
func (o *RenderResponseWithMetadataArrayAdvisorySwisslogHealthcareAdvisoryPaginatePagination) GetData() []AdvisorySwisslogHealthcareAdvisory {
	if o == nil || IsNil(o.Data) {
		var ret []AdvisorySwisslogHealthcareAdvisory
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []AdvisorySwisslogHealthcareAdvisory and assigns it to the Data field.
...
func (o RenderResponseWithMetadataArrayAdvisorySwisslogHealthcareAdvisoryPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisorySwisslogHealthcareAdvisoryPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisorySwisslogHealthcareAdvisoryPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisorySwisslogHealthcareAdvisoryPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisorySwisslogHealthcareAdvisoryPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisorySwisslogHealthcareAdvisoryPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisorySwisslogHealthcareAdvisoryPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisorySwisslogHealthcareAdvisoryPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisorySwisslogHealthcareAdvisoryPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisorySwisslogHealthcareAdvisoryPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisorySwisslogHealthcareAdvisoryPaginatePagination(val *RenderResponseWithMetadataArrayAdvisorySwisslogHealthcareAdvisoryPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisorySwisslogHealthcareAdvisoryPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisorySwisslogHealthcareAdvisoryPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisorySwisslogHealthcareAdvisoryPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisorySwisslogHealthcareAdvisoryPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
