...
// checks if the RenderResponseWithMetadataArrayAdvisoryDrupalPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryDrupalPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryDrupalPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryDrupalPaginatePagination
type RenderResponseWithMetadataArrayAdvisoryDrupalPaginatePagination struct {
	Benchmark *float32 `json:"_benchmark,omitempty"`
	Meta *PaginatePagination `json:"_meta,omitempty"`
	Data []AdvisoryDrupal `json:"data,omitempty"`
}
...
func NewRenderResponseWithMetadataArrayAdvisoryDrupalPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryDrupalPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryDrupalPaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisoryDrupal and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryDrupalPaginatePagination) SetData(v []AdvisoryDrupal) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryDrupalPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryDrupalPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryDrupalPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryDrupalPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryDrupalPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryDrupalPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryDrupalPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryDrupalPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryDrupalPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryDrupalPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryDrupalPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryDrupalPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryDrupalPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryDrupalPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryDrupalPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryDrupalPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
