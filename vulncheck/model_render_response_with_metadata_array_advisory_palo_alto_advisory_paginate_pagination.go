...
// checks if the RenderResponseWithMetadataArrayAdvisoryPaloAltoAdvisoryPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryPaloAltoAdvisoryPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryPaloAltoAdvisoryPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryPaloAltoAdvisoryPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryPaloAltoAdvisoryPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryPaloAltoAdvisoryPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryPaloAltoAdvisoryPaginatePagination{}
	return &this
}
...
func (o *RenderResponseWithMetadataArrayAdvisoryPaloAltoAdvisoryPaginatePagination) GetData() []AdvisoryPaloAltoAdvisory {
	if o == nil || IsNil(o.Data) {
		var ret []AdvisoryPaloAltoAdvisory
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []AdvisoryPaloAltoAdvisory and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryPaloAltoAdvisoryPaginatePagination) SetData(v []AdvisoryPaloAltoAdvisory) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryPaloAltoAdvisoryPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryPaloAltoAdvisoryPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryPaloAltoAdvisoryPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryPaloAltoAdvisoryPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryPaloAltoAdvisoryPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryPaloAltoAdvisoryPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryPaloAltoAdvisoryPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryPaloAltoAdvisoryPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryPaloAltoAdvisoryPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryPaloAltoAdvisoryPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryPaloAltoAdvisoryPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryPaloAltoAdvisoryPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryPaloAltoAdvisoryPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryPaloAltoAdvisoryPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryPaloAltoAdvisoryPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryPaloAltoAdvisoryPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
