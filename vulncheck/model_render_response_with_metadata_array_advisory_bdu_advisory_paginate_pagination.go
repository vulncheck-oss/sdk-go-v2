...
// checks if the RenderResponseWithMetadataArrayAdvisoryBDUAdvisoryPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryBDUAdvisoryPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryBDUAdvisoryPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryBDUAdvisoryPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryBDUAdvisoryPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryBDUAdvisoryPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryBDUAdvisoryPaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisoryBDUAdvisory and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryBDUAdvisoryPaginatePagination) SetData(v []AdvisoryBDUAdvisory) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryBDUAdvisoryPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryBDUAdvisoryPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryBDUAdvisoryPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryBDUAdvisoryPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryBDUAdvisoryPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryBDUAdvisoryPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryBDUAdvisoryPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryBDUAdvisoryPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryBDUAdvisoryPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryBDUAdvisoryPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryBDUAdvisoryPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryBDUAdvisoryPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryBDUAdvisoryPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryBDUAdvisoryPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryBDUAdvisoryPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryBDUAdvisoryPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
