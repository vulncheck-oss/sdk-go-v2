...
// checks if the RenderResponseWithMetadataArrayAdvisoryUbuntuCVEPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryUbuntuCVEPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryUbuntuCVEPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryUbuntuCVEPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryUbuntuCVEPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryUbuntuCVEPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryUbuntuCVEPaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisoryUbuntuCVE and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryUbuntuCVEPaginatePagination) SetData(v []AdvisoryUbuntuCVE) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryUbuntuCVEPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryUbuntuCVEPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryUbuntuCVEPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryUbuntuCVEPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryUbuntuCVEPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryUbuntuCVEPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryUbuntuCVEPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryUbuntuCVEPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryUbuntuCVEPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryUbuntuCVEPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryUbuntuCVEPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryUbuntuCVEPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryUbuntuCVEPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryUbuntuCVEPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryUbuntuCVEPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryUbuntuCVEPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
