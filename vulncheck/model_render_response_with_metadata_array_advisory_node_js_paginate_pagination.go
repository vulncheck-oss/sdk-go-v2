...
// checks if the RenderResponseWithMetadataArrayAdvisoryNodeJSPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryNodeJSPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryNodeJSPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryNodeJSPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryNodeJSPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryNodeJSPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryNodeJSPaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisoryNodeJS and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryNodeJSPaginatePagination) SetData(v []AdvisoryNodeJS) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryNodeJSPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryNodeJSPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryNodeJSPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryNodeJSPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryNodeJSPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryNodeJSPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryNodeJSPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryNodeJSPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryNodeJSPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryNodeJSPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryNodeJSPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryNodeJSPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryNodeJSPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryNodeJSPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryNodeJSPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryNodeJSPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
