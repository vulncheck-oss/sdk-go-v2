...
// checks if the RenderResponseWithMetadataArrayAdvisoryArchIssuePaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryArchIssuePaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryArchIssuePaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryArchIssuePaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryArchIssuePaginatePagination() *RenderResponseWithMetadataArrayAdvisoryArchIssuePaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryArchIssuePaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisoryArchIssue and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryArchIssuePaginatePagination) SetData(v []AdvisoryArchIssue) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryArchIssuePaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryArchIssuePaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryArchIssuePaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryArchIssuePaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryArchIssuePaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryArchIssuePaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryArchIssuePaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryArchIssuePaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryArchIssuePaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryArchIssuePaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryArchIssuePaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryArchIssuePaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryArchIssuePaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryArchIssuePaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryArchIssuePaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryArchIssuePaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
