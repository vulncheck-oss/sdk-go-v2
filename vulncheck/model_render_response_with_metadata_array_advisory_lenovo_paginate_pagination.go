...
// checks if the RenderResponseWithMetadataArrayAdvisoryLenovoPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryLenovoPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryLenovoPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryLenovoPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryLenovoPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryLenovoPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryLenovoPaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisoryLenovo and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryLenovoPaginatePagination) SetData(v []AdvisoryLenovo) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryLenovoPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryLenovoPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryLenovoPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryLenovoPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryLenovoPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryLenovoPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryLenovoPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryLenovoPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryLenovoPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryLenovoPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryLenovoPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryLenovoPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryLenovoPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryLenovoPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryLenovoPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryLenovoPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
