...
// checks if the RenderResponseWithMetadataArrayAdvisoryAdvisoryPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryAdvisoryPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryAdvisoryPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryAdvisoryPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryAdvisoryPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryAdvisoryPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryAdvisoryPaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisoryAdvisory and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryAdvisoryPaginatePagination) SetData(v []AdvisoryAdvisory) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryAdvisoryPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryAdvisoryPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryAdvisoryPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryAdvisoryPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryAdvisoryPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryAdvisoryPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryAdvisoryPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryAdvisoryPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryAdvisoryPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryAdvisoryPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryAdvisoryPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryAdvisoryPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryAdvisoryPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryAdvisoryPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryAdvisoryPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryAdvisoryPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
