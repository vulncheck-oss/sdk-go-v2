...
// checks if the RenderResponseWithMetadataArrayAdvisoryTibcoPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryTibcoPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryTibcoPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryTibcoPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryTibcoPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryTibcoPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryTibcoPaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisoryTibco and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryTibcoPaginatePagination) SetData(v []AdvisoryTibco) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryTibcoPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryTibcoPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryTibcoPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryTibcoPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryTibcoPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryTibcoPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryTibcoPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryTibcoPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryTibcoPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryTibcoPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryTibcoPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryTibcoPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryTibcoPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryTibcoPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryTibcoPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryTibcoPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
