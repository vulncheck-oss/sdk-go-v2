...
// checks if the RenderResponseWithMetadataArrayAdvisoryVapidLabsAdvisoryPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryVapidLabsAdvisoryPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryVapidLabsAdvisoryPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryVapidLabsAdvisoryPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryVapidLabsAdvisoryPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryVapidLabsAdvisoryPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryVapidLabsAdvisoryPaginatePagination{}
	return &this
}
...
func (o *RenderResponseWithMetadataArrayAdvisoryVapidLabsAdvisoryPaginatePagination) GetData() []AdvisoryVapidLabsAdvisory {
	if o == nil || IsNil(o.Data) {
		var ret []AdvisoryVapidLabsAdvisory
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []AdvisoryVapidLabsAdvisory and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryVapidLabsAdvisoryPaginatePagination) SetData(v []AdvisoryVapidLabsAdvisory) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryVapidLabsAdvisoryPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryVapidLabsAdvisoryPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryVapidLabsAdvisoryPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryVapidLabsAdvisoryPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryVapidLabsAdvisoryPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryVapidLabsAdvisoryPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryVapidLabsAdvisoryPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryVapidLabsAdvisoryPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryVapidLabsAdvisoryPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryVapidLabsAdvisoryPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryVapidLabsAdvisoryPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryVapidLabsAdvisoryPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryVapidLabsAdvisoryPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryVapidLabsAdvisoryPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryVapidLabsAdvisoryPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryVapidLabsAdvisoryPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
