...
// checks if the RenderResponseWithMetadataArrayAdvisoryAlpineLinuxSecDBPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryAlpineLinuxSecDBPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryAlpineLinuxSecDBPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryAlpineLinuxSecDBPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryAlpineLinuxSecDBPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryAlpineLinuxSecDBPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryAlpineLinuxSecDBPaginatePagination{}
	return &this
}
...
func (o *RenderResponseWithMetadataArrayAdvisoryAlpineLinuxSecDBPaginatePagination) GetData() []AdvisoryAlpineLinuxSecDB {
	if o == nil || IsNil(o.Data) {
		var ret []AdvisoryAlpineLinuxSecDB
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []AdvisoryAlpineLinuxSecDB and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryAlpineLinuxSecDBPaginatePagination) SetData(v []AdvisoryAlpineLinuxSecDB) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryAlpineLinuxSecDBPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryAlpineLinuxSecDBPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryAlpineLinuxSecDBPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryAlpineLinuxSecDBPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryAlpineLinuxSecDBPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryAlpineLinuxSecDBPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryAlpineLinuxSecDBPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryAlpineLinuxSecDBPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryAlpineLinuxSecDBPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryAlpineLinuxSecDBPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryAlpineLinuxSecDBPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryAlpineLinuxSecDBPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryAlpineLinuxSecDBPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryAlpineLinuxSecDBPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryAlpineLinuxSecDBPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryAlpineLinuxSecDBPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
