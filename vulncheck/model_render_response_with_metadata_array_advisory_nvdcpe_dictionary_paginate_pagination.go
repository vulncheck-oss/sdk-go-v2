...
// checks if the RenderResponseWithMetadataArrayAdvisoryNVDCPEDictionaryPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryNVDCPEDictionaryPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryNVDCPEDictionaryPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryNVDCPEDictionaryPaginatePagination
type RenderResponseWithMetadataArrayAdvisoryNVDCPEDictionaryPaginatePagination struct {
	Benchmark *float32 `json:"_benchmark,omitempty"`
	Meta *PaginatePagination `json:"_meta,omitempty"`
	Data []AdvisoryNVDCPEDictionary `json:"data,omitempty"`
}
...
func NewRenderResponseWithMetadataArrayAdvisoryNVDCPEDictionaryPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryNVDCPEDictionaryPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryNVDCPEDictionaryPaginatePagination{}
	return &this
}
...
func (o *RenderResponseWithMetadataArrayAdvisoryNVDCPEDictionaryPaginatePagination) GetData() []AdvisoryNVDCPEDictionary {
	if o == nil || IsNil(o.Data) {
		var ret []AdvisoryNVDCPEDictionary
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []AdvisoryNVDCPEDictionary and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryNVDCPEDictionaryPaginatePagination) SetData(v []AdvisoryNVDCPEDictionary) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryNVDCPEDictionaryPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryNVDCPEDictionaryPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryNVDCPEDictionaryPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryNVDCPEDictionaryPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryNVDCPEDictionaryPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryNVDCPEDictionaryPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryNVDCPEDictionaryPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryNVDCPEDictionaryPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryNVDCPEDictionaryPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryNVDCPEDictionaryPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryNVDCPEDictionaryPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryNVDCPEDictionaryPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryNVDCPEDictionaryPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryNVDCPEDictionaryPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryNVDCPEDictionaryPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryNVDCPEDictionaryPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
