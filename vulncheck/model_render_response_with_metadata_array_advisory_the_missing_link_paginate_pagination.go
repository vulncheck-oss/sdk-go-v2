...
// checks if the RenderResponseWithMetadataArrayAdvisoryTheMissingLinkPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryTheMissingLinkPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryTheMissingLinkPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryTheMissingLinkPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryTheMissingLinkPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryTheMissingLinkPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryTheMissingLinkPaginatePagination{}
	return &this
}
...
func (o *RenderResponseWithMetadataArrayAdvisoryTheMissingLinkPaginatePagination) GetData() []AdvisoryTheMissingLink {
	if o == nil || IsNil(o.Data) {
		var ret []AdvisoryTheMissingLink
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []AdvisoryTheMissingLink and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryTheMissingLinkPaginatePagination) SetData(v []AdvisoryTheMissingLink) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryTheMissingLinkPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryTheMissingLinkPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryTheMissingLinkPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryTheMissingLinkPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryTheMissingLinkPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryTheMissingLinkPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryTheMissingLinkPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryTheMissingLinkPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryTheMissingLinkPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryTheMissingLinkPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryTheMissingLinkPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryTheMissingLinkPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryTheMissingLinkPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryTheMissingLinkPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryTheMissingLinkPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryTheMissingLinkPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
