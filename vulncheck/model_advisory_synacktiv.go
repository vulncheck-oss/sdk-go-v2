...
// checks if the AdvisorySynacktiv type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AdvisorySynacktiv{}

// AdvisorySynacktiv struct for AdvisorySynacktiv
...
func (o AdvisorySynacktiv) MarshalJSON() ([]byte, error) {
...
func (o AdvisorySynacktiv) ToMap() (map[string]interface{}, error) {
...
type NullableAdvisorySynacktiv struct {
	value *AdvisorySynacktiv
	isSet bool
}

func (v NullableAdvisorySynacktiv) Get() *AdvisorySynacktiv {
	return v.value
}

func (v *NullableAdvisorySynacktiv) Set(val *AdvisorySynacktiv) {
	v.value = val
	v.isSet = true
}

func (v NullableAdvisorySynacktiv) IsSet() bool {
	return v.isSet
}

func (v *NullableAdvisorySynacktiv) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAdvisorySynacktiv(val *AdvisorySynacktiv) *NullableAdvisorySynacktiv {
	return &NullableAdvisorySynacktiv{value: val, isSet: true}
}

func (v NullableAdvisorySynacktiv) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAdvisorySynacktiv) UnmarshalJSON(src []byte) error {
	v.isSet = true
