...
// checks if the RenderResponseWithMetadataArrayAdvisoryXenPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryXenPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryXenPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryXenPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryXenPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryXenPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryXenPaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisoryXen and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryXenPaginatePagination) SetData(v []AdvisoryXen) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryXenPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryXenPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryXenPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryXenPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryXenPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryXenPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryXenPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryXenPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryXenPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryXenPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryXenPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryXenPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryXenPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryXenPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryXenPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryXenPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
