...
// checks if the RenderResponseWithMetadataArrayAdvisoryWhatsAppPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryWhatsAppPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryWhatsAppPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryWhatsAppPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryWhatsAppPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryWhatsAppPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryWhatsAppPaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisoryWhatsApp and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryWhatsAppPaginatePagination) SetData(v []AdvisoryWhatsApp) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryWhatsAppPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryWhatsAppPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryWhatsAppPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryWhatsAppPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryWhatsAppPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryWhatsAppPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryWhatsAppPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryWhatsAppPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryWhatsAppPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryWhatsAppPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryWhatsAppPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryWhatsAppPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryWhatsAppPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryWhatsAppPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryWhatsAppPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryWhatsAppPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
