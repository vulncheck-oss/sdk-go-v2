...
// checks if the RenderResponseWithMetadataArrayAdvisoryMcAfeePaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryMcAfeePaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryMcAfeePaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryMcAfeePaginatePagination
type RenderResponseWithMetadataArrayAdvisoryMcAfeePaginatePagination struct {
	Benchmark *float32 `json:"_benchmark,omitempty"`
	Meta *PaginatePagination `json:"_meta,omitempty"`
	Data []AdvisoryMcAfee `json:"data,omitempty"`
}
...
func NewRenderResponseWithMetadataArrayAdvisoryMcAfeePaginatePagination() *RenderResponseWithMetadataArrayAdvisoryMcAfeePaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryMcAfeePaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisoryMcAfee and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryMcAfeePaginatePagination) SetData(v []AdvisoryMcAfee) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryMcAfeePaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryMcAfeePaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryMcAfeePaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryMcAfeePaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryMcAfeePaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryMcAfeePaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryMcAfeePaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryMcAfeePaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryMcAfeePaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryMcAfeePaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryMcAfeePaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryMcAfeePaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryMcAfeePaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryMcAfeePaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryMcAfeePaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryMcAfeePaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
