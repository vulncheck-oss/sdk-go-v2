...
// checks if the AdvisoryGoVulnPackage type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AdvisoryGoVulnPackage{}

// AdvisoryGoVulnPackage struct for AdvisoryGoVulnPackage
type AdvisoryGoVulnPackage struct {
...
func (o AdvisoryGoVulnPackage) MarshalJSON() ([]byte, error) {
...
func (o AdvisoryGoVulnPackage) ToMap() (map[string]interface{}, error) {
...
type NullableAdvisoryGoVulnPackage struct {
	value *AdvisoryGoVulnPackage
	isSet bool
}

func (v NullableAdvisoryGoVulnPackage) Get() *AdvisoryGoVulnPackage {
	return v.value
}

func (v *NullableAdvisoryGoVulnPackage) Set(val *AdvisoryGoVulnPackage) {
	v.value = val
	v.isSet = true
}

func (v NullableAdvisoryGoVulnPackage) IsSet() bool {
	return v.isSet
}

func (v *NullableAdvisoryGoVulnPackage) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAdvisoryGoVulnPackage(val *AdvisoryGoVulnPackage) *NullableAdvisoryGoVulnPackage {
	return &NullableAdvisoryGoVulnPackage{value: val, isSet: true}
}

func (v NullableAdvisoryGoVulnPackage) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAdvisoryGoVulnPackage) UnmarshalJSON(src []byte) error {
	v.isSet = true
