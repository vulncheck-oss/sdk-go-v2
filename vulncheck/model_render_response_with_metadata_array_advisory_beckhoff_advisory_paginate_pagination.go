...
// checks if the RenderResponseWithMetadataArrayAdvisoryBeckhoffAdvisoryPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryBeckhoffAdvisoryPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryBeckhoffAdvisoryPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryBeckhoffAdvisoryPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryBeckhoffAdvisoryPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryBeckhoffAdvisoryPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryBeckhoffAdvisoryPaginatePagination{}
	return &this
}
...
func (o *RenderResponseWithMetadataArrayAdvisoryBeckhoffAdvisoryPaginatePagination) GetData() []AdvisoryBeckhoffAdvisory {
	if o == nil || IsNil(o.Data) {
		var ret []AdvisoryBeckhoffAdvisory
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []AdvisoryBeckhoffAdvisory and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryBeckhoffAdvisoryPaginatePagination) SetData(v []AdvisoryBeckhoffAdvisory) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryBeckhoffAdvisoryPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryBeckhoffAdvisoryPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryBeckhoffAdvisoryPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryBeckhoffAdvisoryPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryBeckhoffAdvisoryPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryBeckhoffAdvisoryPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryBeckhoffAdvisoryPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryBeckhoffAdvisoryPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryBeckhoffAdvisoryPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryBeckhoffAdvisoryPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryBeckhoffAdvisoryPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryBeckhoffAdvisoryPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryBeckhoffAdvisoryPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryBeckhoffAdvisoryPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryBeckhoffAdvisoryPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryBeckhoffAdvisoryPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
