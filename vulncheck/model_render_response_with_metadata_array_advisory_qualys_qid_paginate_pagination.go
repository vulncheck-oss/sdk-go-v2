...
// checks if the RenderResponseWithMetadataArrayAdvisoryQualysQIDPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryQualysQIDPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryQualysQIDPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryQualysQIDPaginatePagination
type RenderResponseWithMetadataArrayAdvisoryQualysQIDPaginatePagination struct {
	Benchmark *float32 `json:"_benchmark,omitempty"`
	Meta *PaginatePagination `json:"_meta,omitempty"`
	Data []AdvisoryQualysQID `json:"data,omitempty"`
}
...
func NewRenderResponseWithMetadataArrayAdvisoryQualysQIDPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryQualysQIDPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryQualysQIDPaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisoryQualysQID and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryQualysQIDPaginatePagination) SetData(v []AdvisoryQualysQID) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryQualysQIDPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryQualysQIDPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryQualysQIDPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryQualysQIDPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryQualysQIDPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryQualysQIDPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryQualysQIDPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryQualysQIDPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryQualysQIDPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryQualysQIDPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryQualysQIDPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryQualysQIDPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryQualysQIDPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryQualysQIDPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryQualysQIDPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryQualysQIDPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
