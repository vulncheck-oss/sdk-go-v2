...
// checks if the RenderResponseWithMetadataArrayAdvisoryApacheGuacamolePaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryApacheGuacamolePaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryApacheGuacamolePaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryApacheGuacamolePaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryApacheGuacamolePaginatePagination() *RenderResponseWithMetadataArrayAdvisoryApacheGuacamolePaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryApacheGuacamolePaginatePagination{}
	return &this
}
...
func (o *RenderResponseWithMetadataArrayAdvisoryApacheGuacamolePaginatePagination) GetData() []AdvisoryApacheGuacamole {
	if o == nil || IsNil(o.Data) {
		var ret []AdvisoryApacheGuacamole
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []AdvisoryApacheGuacamole and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryApacheGuacamolePaginatePagination) SetData(v []AdvisoryApacheGuacamole) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryApacheGuacamolePaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryApacheGuacamolePaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryApacheGuacamolePaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryApacheGuacamolePaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryApacheGuacamolePaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryApacheGuacamolePaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryApacheGuacamolePaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryApacheGuacamolePaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryApacheGuacamolePaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryApacheGuacamolePaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryApacheGuacamolePaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryApacheGuacamolePaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryApacheGuacamolePaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryApacheGuacamolePaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryApacheGuacamolePaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryApacheGuacamolePaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
