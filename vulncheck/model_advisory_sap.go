...
// checks if the AdvisorySAP type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AdvisorySAP{}

// AdvisorySAP struct for AdvisorySAP
...
func (o AdvisorySAP) MarshalJSON() ([]byte, error) {
...
func (o AdvisorySAP) ToMap() (map[string]interface{}, error) {
...
type NullableAdvisorySAP struct {
	value *AdvisorySAP
	isSet bool
}

func (v NullableAdvisorySAP) Get() *AdvisorySAP {
	return v.value
}

func (v *NullableAdvisorySAP) Set(val *AdvisorySAP) {
	v.value = val
	v.isSet = true
}

func (v NullableAdvisorySAP) IsSet() bool {
	return v.isSet
}

func (v *NullableAdvisorySAP) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAdvisorySAP(val *AdvisorySAP) *NullableAdvisorySAP {
	return &NullableAdvisorySAP{value: val, isSet: true}
}

func (v NullableAdvisorySAP) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAdvisorySAP) UnmarshalJSON(src []byte) error {
	v.isSet = true
