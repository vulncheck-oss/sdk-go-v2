...
// checks if the RenderResponseWithMetadataArrayApiCWEPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayApiCWEPaginatePagination{}

// RenderResponseWithMetadataArrayApiCWEPaginatePagination struct for RenderResponseWithMetadataArrayApiCWEPaginatePagination
...
func NewRenderResponseWithMetadataArrayApiCWEPaginatePagination() *RenderResponseWithMetadataArrayApiCWEPaginatePagination {
	this := RenderResponseWithMetadataArrayApiCWEPaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []ApiCWE and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayApiCWEPaginatePagination) SetData(v []ApiCWE) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayApiCWEPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayApiCWEPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayApiCWEPaginatePagination struct {
	value *RenderResponseWithMetadataArrayApiCWEPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayApiCWEPaginatePagination) Get() *RenderResponseWithMetadataArrayApiCWEPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayApiCWEPaginatePagination) Set(val *RenderResponseWithMetadataArrayApiCWEPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayApiCWEPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayApiCWEPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayApiCWEPaginatePagination(val *RenderResponseWithMetadataArrayApiCWEPaginatePagination) *NullableRenderResponseWithMetadataArrayApiCWEPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayApiCWEPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayApiCWEPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayApiCWEPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
