...
// checks if the RenderResponseWithMetadataArrayAdvisoryDNNPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryDNNPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryDNNPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryDNNPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryDNNPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryDNNPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryDNNPaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisoryDNN and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryDNNPaginatePagination) SetData(v []AdvisoryDNN) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryDNNPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryDNNPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryDNNPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryDNNPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryDNNPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryDNNPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryDNNPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryDNNPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryDNNPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryDNNPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryDNNPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryDNNPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryDNNPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryDNNPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryDNNPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryDNNPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
