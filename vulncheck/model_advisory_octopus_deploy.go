...
// checks if the AdvisoryOctopusDeploy type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AdvisoryOctopusDeploy{}

// AdvisoryOctopusDeploy struct for AdvisoryOctopusDeploy
...
func (o AdvisoryOctopusDeploy) MarshalJSON() ([]byte, error) {
...
func (o AdvisoryOctopusDeploy) ToMap() (map[string]interface{}, error) {
...
type NullableAdvisoryOctopusDeploy struct {
	value *AdvisoryOctopusDeploy
	isSet bool
}

func (v NullableAdvisoryOctopusDeploy) Get() *AdvisoryOctopusDeploy {
	return v.value
}

func (v *NullableAdvisoryOctopusDeploy) Set(val *AdvisoryOctopusDeploy) {
	v.value = val
	v.isSet = true
}

func (v NullableAdvisoryOctopusDeploy) IsSet() bool {
	return v.isSet
}

func (v *NullableAdvisoryOctopusDeploy) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAdvisoryOctopusDeploy(val *AdvisoryOctopusDeploy) *NullableAdvisoryOctopusDeploy {
	return &NullableAdvisoryOctopusDeploy{value: val, isSet: true}
}

func (v NullableAdvisoryOctopusDeploy) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAdvisoryOctopusDeploy) UnmarshalJSON(src []byte) error {
	v.isSet = true
