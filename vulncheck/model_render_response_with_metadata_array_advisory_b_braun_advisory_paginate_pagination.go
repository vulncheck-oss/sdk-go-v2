...
// checks if the RenderResponseWithMetadataArrayAdvisoryBBraunAdvisoryPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryBBraunAdvisoryPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryBBraunAdvisoryPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryBBraunAdvisoryPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryBBraunAdvisoryPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryBBraunAdvisoryPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryBBraunAdvisoryPaginatePagination{}
	return &this
}
...
func (o *RenderResponseWithMetadataArrayAdvisoryBBraunAdvisoryPaginatePagination) GetData() []AdvisoryBBraunAdvisory {
	if o == nil || IsNil(o.Data) {
		var ret []AdvisoryBBraunAdvisory
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []AdvisoryBBraunAdvisory and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryBBraunAdvisoryPaginatePagination) SetData(v []AdvisoryBBraunAdvisory) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryBBraunAdvisoryPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryBBraunAdvisoryPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryBBraunAdvisoryPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryBBraunAdvisoryPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryBBraunAdvisoryPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryBBraunAdvisoryPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryBBraunAdvisoryPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryBBraunAdvisoryPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryBBraunAdvisoryPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryBBraunAdvisoryPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryBBraunAdvisoryPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryBBraunAdvisoryPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryBBraunAdvisoryPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryBBraunAdvisoryPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryBBraunAdvisoryPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryBBraunAdvisoryPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
