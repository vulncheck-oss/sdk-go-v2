...
// checks if the RenderResponseWithMetadataArrayAdvisoryVCVulnerableCPEsPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryVCVulnerableCPEsPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryVCVulnerableCPEsPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryVCVulnerableCPEsPaginatePagination
type RenderResponseWithMetadataArrayAdvisoryVCVulnerableCPEsPaginatePagination struct {
	Benchmark *float32 `json:"_benchmark,omitempty"`
	Meta *PaginatePagination `json:"_meta,omitempty"`
	Data []AdvisoryVCVulnerableCPEs `json:"data,omitempty"`
}
...
func NewRenderResponseWithMetadataArrayAdvisoryVCVulnerableCPEsPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryVCVulnerableCPEsPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryVCVulnerableCPEsPaginatePagination{}
	return &this
}
...
func (o *RenderResponseWithMetadataArrayAdvisoryVCVulnerableCPEsPaginatePagination) GetData() []AdvisoryVCVulnerableCPEs {
	if o == nil || IsNil(o.Data) {
		var ret []AdvisoryVCVulnerableCPEs
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []AdvisoryVCVulnerableCPEs and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryVCVulnerableCPEsPaginatePagination) SetData(v []AdvisoryVCVulnerableCPEs) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryVCVulnerableCPEsPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryVCVulnerableCPEsPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryVCVulnerableCPEsPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryVCVulnerableCPEsPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryVCVulnerableCPEsPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryVCVulnerableCPEsPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryVCVulnerableCPEsPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryVCVulnerableCPEsPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryVCVulnerableCPEsPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryVCVulnerableCPEsPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryVCVulnerableCPEsPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryVCVulnerableCPEsPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryVCVulnerableCPEsPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryVCVulnerableCPEsPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryVCVulnerableCPEsPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryVCVulnerableCPEsPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
