...
// checks if the RenderResponseWithMetadataArrayAdvisoryAsteriskPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryAsteriskPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryAsteriskPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryAsteriskPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryAsteriskPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryAsteriskPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryAsteriskPaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisoryAsterisk and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryAsteriskPaginatePagination) SetData(v []AdvisoryAsterisk) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryAsteriskPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryAsteriskPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryAsteriskPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryAsteriskPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryAsteriskPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryAsteriskPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryAsteriskPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryAsteriskPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryAsteriskPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryAsteriskPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryAsteriskPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryAsteriskPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryAsteriskPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryAsteriskPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryAsteriskPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryAsteriskPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
