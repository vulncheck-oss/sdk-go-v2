...
// checks if the RenderResponseWithMetadataArrayAdvisoryCertSEPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryCertSEPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryCertSEPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryCertSEPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryCertSEPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryCertSEPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryCertSEPaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisoryCertSE and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryCertSEPaginatePagination) SetData(v []AdvisoryCertSE) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryCertSEPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryCertSEPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryCertSEPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryCertSEPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryCertSEPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryCertSEPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryCertSEPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryCertSEPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryCertSEPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryCertSEPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryCertSEPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryCertSEPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryCertSEPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryCertSEPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryCertSEPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryCertSEPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
