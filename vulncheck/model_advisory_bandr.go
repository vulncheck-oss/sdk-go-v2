...
// checks if the AdvisoryBandr type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AdvisoryBandr{}

// AdvisoryBandr struct for AdvisoryBandr
...
func (o AdvisoryBandr) MarshalJSON() ([]byte, error) {
...
func (o AdvisoryBandr) ToMap() (map[string]interface{}, error) {
...
type NullableAdvisoryBandr struct {
	value *AdvisoryBandr
	isSet bool
}

func (v NullableAdvisoryBandr) Get() *AdvisoryBandr {
	return v.value
}

func (v *NullableAdvisoryBandr) Set(val *AdvisoryBandr) {
	v.value = val
	v.isSet = true
}

func (v NullableAdvisoryBandr) IsSet() bool {
	return v.isSet
}

func (v *NullableAdvisoryBandr) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAdvisoryBandr(val *AdvisoryBandr) *NullableAdvisoryBandr {
	return &NullableAdvisoryBandr{value: val, isSet: true}
}

func (v NullableAdvisoryBandr) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAdvisoryBandr) UnmarshalJSON(src []byte) error {
	v.isSet = true
