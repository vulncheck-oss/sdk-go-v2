...
// checks if the RenderResponseWithMetadataArrayAdvisorySecurityBulletinPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisorySecurityBulletinPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisorySecurityBulletinPaginatePagination struct for RenderResponseWithMetadataArrayAdvisorySecurityBulletinPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisorySecurityBulletinPaginatePagination() *RenderResponseWithMetadataArrayAdvisorySecurityBulletinPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisorySecurityBulletinPaginatePagination{}
	return &this
}
...
func (o *RenderResponseWithMetadataArrayAdvisorySecurityBulletinPaginatePagination) GetData() []AdvisorySecurityBulletin {
	if o == nil || IsNil(o.Data) {
		var ret []AdvisorySecurityBulletin
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []AdvisorySecurityBulletin and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisorySecurityBulletinPaginatePagination) SetData(v []AdvisorySecurityBulletin) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisorySecurityBulletinPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisorySecurityBulletinPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisorySecurityBulletinPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisorySecurityBulletinPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisorySecurityBulletinPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisorySecurityBulletinPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisorySecurityBulletinPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisorySecurityBulletinPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisorySecurityBulletinPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisorySecurityBulletinPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisorySecurityBulletinPaginatePagination(val *RenderResponseWithMetadataArrayAdvisorySecurityBulletinPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisorySecurityBulletinPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisorySecurityBulletinPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisorySecurityBulletinPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisorySecurityBulletinPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
