...
// checks if the AdvisoryPTC type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AdvisoryPTC{}

// AdvisoryPTC struct for AdvisoryPTC
...
func (o AdvisoryPTC) MarshalJSON() ([]byte, error) {
...
func (o AdvisoryPTC) ToMap() (map[string]interface{}, error) {
...
type NullableAdvisoryPTC struct {
	value *AdvisoryPTC
	isSet bool
}

func (v NullableAdvisoryPTC) Get() *AdvisoryPTC {
	return v.value
}

func (v *NullableAdvisoryPTC) Set(val *AdvisoryPTC) {
	v.value = val
	v.isSet = true
}

func (v NullableAdvisoryPTC) IsSet() bool {
	return v.isSet
}

func (v *NullableAdvisoryPTC) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAdvisoryPTC(val *AdvisoryPTC) *NullableAdvisoryPTC {
	return &NullableAdvisoryPTC{value: val, isSet: true}
}

func (v NullableAdvisoryPTC) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAdvisoryPTC) UnmarshalJSON(src []byte) error {
	v.isSet = true
