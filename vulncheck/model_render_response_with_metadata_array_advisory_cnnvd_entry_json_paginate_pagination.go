...
// checks if the RenderResponseWithMetadataArrayAdvisoryCNNVDEntryJSONPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryCNNVDEntryJSONPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryCNNVDEntryJSONPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryCNNVDEntryJSONPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryCNNVDEntryJSONPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryCNNVDEntryJSONPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryCNNVDEntryJSONPaginatePagination{}
	return &this
}
...
func (o *RenderResponseWithMetadataArrayAdvisoryCNNVDEntryJSONPaginatePagination) GetData() []AdvisoryCNNVDEntryJSON {
	if o == nil || IsNil(o.Data) {
		var ret []AdvisoryCNNVDEntryJSON
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []AdvisoryCNNVDEntryJSON and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryCNNVDEntryJSONPaginatePagination) SetData(v []AdvisoryCNNVDEntryJSON) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryCNNVDEntryJSONPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryCNNVDEntryJSONPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryCNNVDEntryJSONPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryCNNVDEntryJSONPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryCNNVDEntryJSONPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryCNNVDEntryJSONPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryCNNVDEntryJSONPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryCNNVDEntryJSONPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryCNNVDEntryJSONPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryCNNVDEntryJSONPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryCNNVDEntryJSONPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryCNNVDEntryJSONPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryCNNVDEntryJSONPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryCNNVDEntryJSONPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryCNNVDEntryJSONPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryCNNVDEntryJSONPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
