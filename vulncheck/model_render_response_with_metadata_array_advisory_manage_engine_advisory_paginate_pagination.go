...
// checks if the RenderResponseWithMetadataArrayAdvisoryManageEngineAdvisoryPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryManageEngineAdvisoryPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryManageEngineAdvisoryPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryManageEngineAdvisoryPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryManageEngineAdvisoryPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryManageEngineAdvisoryPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryManageEngineAdvisoryPaginatePagination{}
	return &this
}
...
func (o *RenderResponseWithMetadataArrayAdvisoryManageEngineAdvisoryPaginatePagination) GetData() []AdvisoryManageEngineAdvisory {
	if o == nil || IsNil(o.Data) {
		var ret []AdvisoryManageEngineAdvisory
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []AdvisoryManageEngineAdvisory and assigns it to the Data field.
...
func (o RenderResponseWithMetadataArrayAdvisoryManageEngineAdvisoryPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryManageEngineAdvisoryPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryManageEngineAdvisoryPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryManageEngineAdvisoryPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryManageEngineAdvisoryPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryManageEngineAdvisoryPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryManageEngineAdvisoryPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryManageEngineAdvisoryPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryManageEngineAdvisoryPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryManageEngineAdvisoryPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryManageEngineAdvisoryPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryManageEngineAdvisoryPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryManageEngineAdvisoryPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryManageEngineAdvisoryPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryManageEngineAdvisoryPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryManageEngineAdvisoryPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
