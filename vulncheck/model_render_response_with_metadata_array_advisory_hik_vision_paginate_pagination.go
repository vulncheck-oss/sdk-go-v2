...
// checks if the RenderResponseWithMetadataArrayAdvisoryHIKVisionPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryHIKVisionPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryHIKVisionPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryHIKVisionPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryHIKVisionPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryHIKVisionPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryHIKVisionPaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisoryHIKVision and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryHIKVisionPaginatePagination) SetData(v []AdvisoryHIKVision) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryHIKVisionPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryHIKVisionPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryHIKVisionPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryHIKVisionPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryHIKVisionPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryHIKVisionPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryHIKVisionPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryHIKVisionPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryHIKVisionPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryHIKVisionPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryHIKVisionPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryHIKVisionPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryHIKVisionPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryHIKVisionPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryHIKVisionPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryHIKVisionPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
