...
// checks if the RenderResponseWithMetadataArrayAdvisoryOmronPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryOmronPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryOmronPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryOmronPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryOmronPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryOmronPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryOmronPaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisoryOmron and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryOmronPaginatePagination) SetData(v []AdvisoryOmron) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryOmronPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryOmronPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryOmronPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryOmronPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryOmronPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryOmronPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryOmronPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryOmronPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryOmronPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryOmronPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryOmronPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryOmronPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryOmronPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryOmronPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryOmronPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryOmronPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
