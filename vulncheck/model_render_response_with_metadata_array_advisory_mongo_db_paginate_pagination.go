...
// checks if the RenderResponseWithMetadataArrayAdvisoryMongoDBPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryMongoDBPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryMongoDBPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryMongoDBPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryMongoDBPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryMongoDBPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryMongoDBPaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisoryMongoDB and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryMongoDBPaginatePagination) SetData(v []AdvisoryMongoDB) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryMongoDBPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryMongoDBPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryMongoDBPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryMongoDBPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryMongoDBPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryMongoDBPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryMongoDBPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryMongoDBPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryMongoDBPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryMongoDBPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryMongoDBPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryMongoDBPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryMongoDBPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryMongoDBPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryMongoDBPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryMongoDBPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
