...
// checks if the AdvisoryWibu type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AdvisoryWibu{}

// AdvisoryWibu struct for AdvisoryWibu
...
func (o AdvisoryWibu) MarshalJSON() ([]byte, error) {
...
func (o AdvisoryWibu) ToMap() (map[string]interface{}, error) {
...
type NullableAdvisoryWibu struct {
	value *AdvisoryWibu
	isSet bool
}

func (v NullableAdvisoryWibu) Get() *AdvisoryWibu {
	return v.value
}

func (v *NullableAdvisoryWibu) Set(val *AdvisoryWibu) {
	v.value = val
	v.isSet = true
}

func (v NullableAdvisoryWibu) IsSet() bool {
	return v.isSet
}

func (v *NullableAdvisoryWibu) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAdvisoryWibu(val *AdvisoryWibu) *NullableAdvisoryWibu {
	return &NullableAdvisoryWibu{value: val, isSet: true}
}

func (v NullableAdvisoryWibu) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAdvisoryWibu) UnmarshalJSON(src []byte) error {
	v.isSet = true
