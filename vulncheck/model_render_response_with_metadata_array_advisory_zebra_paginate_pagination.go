...
// checks if the RenderResponseWithMetadataArrayAdvisoryZebraPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryZebraPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryZebraPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryZebraPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryZebraPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryZebraPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryZebraPaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisoryZebra and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryZebraPaginatePagination) SetData(v []AdvisoryZebra) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryZebraPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryZebraPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryZebraPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryZebraPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryZebraPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryZebraPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryZebraPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryZebraPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryZebraPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryZebraPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryZebraPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryZebraPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryZebraPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryZebraPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryZebraPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryZebraPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
