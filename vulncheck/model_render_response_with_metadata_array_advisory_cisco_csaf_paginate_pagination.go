...
// checks if the RenderResponseWithMetadataArrayAdvisoryCiscoCSAFPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryCiscoCSAFPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryCiscoCSAFPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryCiscoCSAFPaginatePagination
type RenderResponseWithMetadataArrayAdvisoryCiscoCSAFPaginatePagination struct {
	Benchmark *float32 `json:"_benchmark,omitempty"`
	Meta *PaginatePagination `json:"_meta,omitempty"`
	Data []AdvisoryCiscoCSAF `json:"data,omitempty"`
}
...
func NewRenderResponseWithMetadataArrayAdvisoryCiscoCSAFPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryCiscoCSAFPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryCiscoCSAFPaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisoryCiscoCSAF and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryCiscoCSAFPaginatePagination) SetData(v []AdvisoryCiscoCSAF) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryCiscoCSAFPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryCiscoCSAFPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryCiscoCSAFPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryCiscoCSAFPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryCiscoCSAFPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryCiscoCSAFPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryCiscoCSAFPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryCiscoCSAFPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryCiscoCSAFPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryCiscoCSAFPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryCiscoCSAFPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryCiscoCSAFPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryCiscoCSAFPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryCiscoCSAFPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryCiscoCSAFPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryCiscoCSAFPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
