...
// checks if the AdvisoryApacheTomcat type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AdvisoryApacheTomcat{}

// AdvisoryApacheTomcat struct for AdvisoryApacheTomcat
...
func (o AdvisoryApacheTomcat) MarshalJSON() ([]byte, error) {
...
func (o AdvisoryApacheTomcat) ToMap() (map[string]interface{}, error) {
...
type NullableAdvisoryApacheTomcat struct {
	value *AdvisoryApacheTomcat
	isSet bool
}

func (v NullableAdvisoryApacheTomcat) Get() *AdvisoryApacheTomcat {
	return v.value
}

func (v *NullableAdvisoryApacheTomcat) Set(val *AdvisoryApacheTomcat) {
	v.value = val
	v.isSet = true
}

func (v NullableAdvisoryApacheTomcat) IsSet() bool {
	return v.isSet
}

func (v *NullableAdvisoryApacheTomcat) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAdvisoryApacheTomcat(val *AdvisoryApacheTomcat) *NullableAdvisoryApacheTomcat {
	return &NullableAdvisoryApacheTomcat{value: val, isSet: true}
}

func (v NullableAdvisoryApacheTomcat) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAdvisoryApacheTomcat) UnmarshalJSON(src []byte) error {
	v.isSet = true
