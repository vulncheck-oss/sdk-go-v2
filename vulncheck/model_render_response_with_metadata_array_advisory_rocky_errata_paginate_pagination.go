...
// checks if the RenderResponseWithMetadataArrayAdvisoryRockyErrataPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryRockyErrataPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryRockyErrataPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryRockyErrataPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryRockyErrataPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryRockyErrataPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryRockyErrataPaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisoryRockyErrata and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryRockyErrataPaginatePagination) SetData(v []AdvisoryRockyErrata) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryRockyErrataPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryRockyErrataPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryRockyErrataPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryRockyErrataPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryRockyErrataPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryRockyErrataPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryRockyErrataPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryRockyErrataPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryRockyErrataPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryRockyErrataPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryRockyErrataPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryRockyErrataPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryRockyErrataPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryRockyErrataPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryRockyErrataPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryRockyErrataPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
