...
// checks if the RenderResponseWithMetadataArrayAdvisoryQualysPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryQualysPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryQualysPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryQualysPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryQualysPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryQualysPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryQualysPaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisoryQualys and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryQualysPaginatePagination) SetData(v []AdvisoryQualys) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryQualysPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryQualysPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryQualysPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryQualysPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryQualysPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryQualysPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryQualysPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryQualysPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryQualysPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryQualysPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryQualysPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryQualysPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryQualysPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryQualysPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryQualysPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryQualysPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
