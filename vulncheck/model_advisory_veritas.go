...
// checks if the AdvisoryVeritas type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AdvisoryVeritas{}

// AdvisoryVeritas struct for AdvisoryVeritas
...
func (o AdvisoryVeritas) MarshalJSON() ([]byte, error) {
...
func (o AdvisoryVeritas) ToMap() (map[string]interface{}, error) {
...
type NullableAdvisoryVeritas struct {
	value *AdvisoryVeritas
	isSet bool
}

func (v NullableAdvisoryVeritas) Get() *AdvisoryVeritas {
	return v.value
}

func (v *NullableAdvisoryVeritas) Set(val *AdvisoryVeritas) {
	v.value = val
	v.isSet = true
}

func (v NullableAdvisoryVeritas) IsSet() bool {
	return v.isSet
}

func (v *NullableAdvisoryVeritas) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAdvisoryVeritas(val *AdvisoryVeritas) *NullableAdvisoryVeritas {
	return &NullableAdvisoryVeritas{value: val, isSet: true}
}

func (v NullableAdvisoryVeritas) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAdvisoryVeritas) UnmarshalJSON(src []byte) error {
	v.isSet = true
