...
// checks if the RenderResponseWithMetadataArrayAdvisoryAzulPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryAzulPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryAzulPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryAzulPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryAzulPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryAzulPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryAzulPaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisoryAzul and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryAzulPaginatePagination) SetData(v []AdvisoryAzul) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryAzulPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryAzulPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryAzulPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryAzulPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryAzulPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryAzulPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryAzulPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryAzulPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryAzulPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryAzulPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryAzulPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryAzulPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryAzulPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryAzulPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryAzulPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryAzulPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
