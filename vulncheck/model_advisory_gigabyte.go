...
// checks if the AdvisoryGigabyte type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AdvisoryGigabyte{}

// AdvisoryGigabyte struct for AdvisoryGigabyte
...
func (o AdvisoryGigabyte) MarshalJSON() ([]byte, error) {
...
func (o AdvisoryGigabyte) ToMap() (map[string]interface{}, error) {
...
type NullableAdvisoryGigabyte struct {
	value *AdvisoryGigabyte
	isSet bool
}

func (v NullableAdvisoryGigabyte) Get() *AdvisoryGigabyte {
	return v.value
}

func (v *NullableAdvisoryGigabyte) Set(val *AdvisoryGigabyte) {
	v.value = val
	v.isSet = true
}

func (v NullableAdvisoryGigabyte) IsSet() bool {
	return v.isSet
}

func (v *NullableAdvisoryGigabyte) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAdvisoryGigabyte(val *AdvisoryGigabyte) *NullableAdvisoryGigabyte {
	return &NullableAdvisoryGigabyte{value: val, isSet: true}
}

func (v NullableAdvisoryGigabyte) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAdvisoryGigabyte) UnmarshalJSON(src []byte) error {
	v.isSet = true
