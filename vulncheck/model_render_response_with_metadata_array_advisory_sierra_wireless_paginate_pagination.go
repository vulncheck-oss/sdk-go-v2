...
// checks if the RenderResponseWithMetadataArrayAdvisorySierraWirelessPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisorySierraWirelessPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisorySierraWirelessPaginatePagination struct for RenderResponseWithMetadataArrayAdvisorySierraWirelessPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisorySierraWirelessPaginatePagination() *RenderResponseWithMetadataArrayAdvisorySierraWirelessPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisorySierraWirelessPaginatePagination{}
	return &this
}
...
func (o *RenderResponseWithMetadataArrayAdvisorySierraWirelessPaginatePagination) GetData() []AdvisorySierraWireless {
	if o == nil || IsNil(o.Data) {
		var ret []AdvisorySierraWireless
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []AdvisorySierraWireless and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisorySierraWirelessPaginatePagination) SetData(v []AdvisorySierraWireless) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisorySierraWirelessPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisorySierraWirelessPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisorySierraWirelessPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisorySierraWirelessPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisorySierraWirelessPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisorySierraWirelessPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisorySierraWirelessPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisorySierraWirelessPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisorySierraWirelessPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisorySierraWirelessPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisorySierraWirelessPaginatePagination(val *RenderResponseWithMetadataArrayAdvisorySierraWirelessPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisorySierraWirelessPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisorySierraWirelessPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisorySierraWirelessPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisorySierraWirelessPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
