...
// checks if the RenderResponseWithMetadataArrayAdvisoryShielderPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryShielderPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryShielderPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryShielderPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryShielderPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryShielderPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryShielderPaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisoryShielder and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryShielderPaginatePagination) SetData(v []AdvisoryShielder) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryShielderPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryShielderPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryShielderPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryShielderPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryShielderPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryShielderPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryShielderPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryShielderPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryShielderPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryShielderPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryShielderPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryShielderPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryShielderPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryShielderPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryShielderPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryShielderPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
