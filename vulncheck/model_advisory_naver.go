...
// checks if the AdvisoryNaver type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AdvisoryNaver{}

// AdvisoryNaver struct for AdvisoryNaver
...
func (o AdvisoryNaver) MarshalJSON() ([]byte, error) {
...
func (o AdvisoryNaver) ToMap() (map[string]interface{}, error) {
...
type NullableAdvisoryNaver struct {
	value *AdvisoryNaver
	isSet bool
}

func (v NullableAdvisoryNaver) Get() *AdvisoryNaver {
	return v.value
}

func (v *NullableAdvisoryNaver) Set(val *AdvisoryNaver) {
	v.value = val
	v.isSet = true
}

func (v NullableAdvisoryNaver) IsSet() bool {
	return v.isSet
}

func (v *NullableAdvisoryNaver) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAdvisoryNaver(val *AdvisoryNaver) *NullableAdvisoryNaver {
	return &NullableAdvisoryNaver{value: val, isSet: true}
}

func (v NullableAdvisoryNaver) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAdvisoryNaver) UnmarshalJSON(src []byte) error {
	v.isSet = true
