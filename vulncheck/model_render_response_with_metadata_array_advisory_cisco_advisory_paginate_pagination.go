...
// checks if the RenderResponseWithMetadataArrayAdvisoryCiscoAdvisoryPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryCiscoAdvisoryPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryCiscoAdvisoryPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryCiscoAdvisoryPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryCiscoAdvisoryPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryCiscoAdvisoryPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryCiscoAdvisoryPaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisoryCiscoAdvisory and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryCiscoAdvisoryPaginatePagination) SetData(v []AdvisoryCiscoAdvisory) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryCiscoAdvisoryPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryCiscoAdvisoryPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryCiscoAdvisoryPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryCiscoAdvisoryPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryCiscoAdvisoryPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryCiscoAdvisoryPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryCiscoAdvisoryPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryCiscoAdvisoryPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryCiscoAdvisoryPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryCiscoAdvisoryPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryCiscoAdvisoryPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryCiscoAdvisoryPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryCiscoAdvisoryPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryCiscoAdvisoryPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryCiscoAdvisoryPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryCiscoAdvisoryPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
