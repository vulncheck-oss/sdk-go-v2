...
// checks if the AdvisoryZscaler type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AdvisoryZscaler{}

// AdvisoryZscaler struct for AdvisoryZscaler
...
func (o AdvisoryZscaler) MarshalJSON() ([]byte, error) {
...
func (o AdvisoryZscaler) ToMap() (map[string]interface{}, error) {
...
type NullableAdvisoryZscaler struct {
	value *AdvisoryZscaler
	isSet bool
}

func (v NullableAdvisoryZscaler) Get() *AdvisoryZscaler {
	return v.value
}

func (v *NullableAdvisoryZscaler) Set(val *AdvisoryZscaler) {
	v.value = val
	v.isSet = true
}

func (v NullableAdvisoryZscaler) IsSet() bool {
	return v.isSet
}

func (v *NullableAdvisoryZscaler) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAdvisoryZscaler(val *AdvisoryZscaler) *NullableAdvisoryZscaler {
	return &NullableAdvisoryZscaler{value: val, isSet: true}
}

func (v NullableAdvisoryZscaler) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAdvisoryZscaler) UnmarshalJSON(src []byte) error {
	v.isSet = true
