...
// checks if the RenderResponseWithMetadataArrayAdvisoryRevivePaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryRevivePaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryRevivePaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryRevivePaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryRevivePaginatePagination() *RenderResponseWithMetadataArrayAdvisoryRevivePaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryRevivePaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisoryRevive and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryRevivePaginatePagination) SetData(v []AdvisoryRevive) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryRevivePaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryRevivePaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryRevivePaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryRevivePaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryRevivePaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryRevivePaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryRevivePaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryRevivePaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryRevivePaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryRevivePaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryRevivePaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryRevivePaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryRevivePaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryRevivePaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryRevivePaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryRevivePaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
