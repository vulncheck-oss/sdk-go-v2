...
// checks if the AdvisoryGenetec type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AdvisoryGenetec{}

// AdvisoryGenetec struct for AdvisoryGenetec
...
func (o AdvisoryGenetec) MarshalJSON() ([]byte, error) {
...
func (o AdvisoryGenetec) ToMap() (map[string]interface{}, error) {
...
type NullableAdvisoryGenetec struct {
	value *AdvisoryGenetec
	isSet bool
}

func (v NullableAdvisoryGenetec) Get() *AdvisoryGenetec {
	return v.value
}

func (v *NullableAdvisoryGenetec) Set(val *AdvisoryGenetec) {
	v.value = val
	v.isSet = true
}

func (v NullableAdvisoryGenetec) IsSet() bool {
	return v.isSet
}

func (v *NullableAdvisoryGenetec) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAdvisoryGenetec(val *AdvisoryGenetec) *NullableAdvisoryGenetec {
	return &NullableAdvisoryGenetec{value: val, isSet: true}
}

func (v NullableAdvisoryGenetec) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAdvisoryGenetec) UnmarshalJSON(src []byte) error {
	v.isSet = true
