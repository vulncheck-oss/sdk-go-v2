...
// checks if the RenderResponseWithMetadataArrayAdvisoryAmazonCVEPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryAmazonCVEPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryAmazonCVEPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryAmazonCVEPaginatePagination
type RenderResponseWithMetadataArrayAdvisoryAmazonCVEPaginatePagination struct {
	Benchmark *float32 `json:"_benchmark,omitempty"`
	Meta *PaginatePagination `json:"_meta,omitempty"`
	Data []AdvisoryAmazonCVE `json:"data,omitempty"`
}
...
func NewRenderResponseWithMetadataArrayAdvisoryAmazonCVEPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryAmazonCVEPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryAmazonCVEPaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisoryAmazonCVE and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryAmazonCVEPaginatePagination) SetData(v []AdvisoryAmazonCVE) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryAmazonCVEPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryAmazonCVEPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryAmazonCVEPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryAmazonCVEPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryAmazonCVEPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryAmazonCVEPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryAmazonCVEPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryAmazonCVEPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryAmazonCVEPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryAmazonCVEPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryAmazonCVEPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryAmazonCVEPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryAmazonCVEPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryAmazonCVEPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryAmazonCVEPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryAmazonCVEPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
