...
// checks if the RenderResponseWithMetadataArrayAdvisoryA10PaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryA10PaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryA10PaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryA10PaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryA10PaginatePagination() *RenderResponseWithMetadataArrayAdvisoryA10PaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryA10PaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisoryA10 and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryA10PaginatePagination) SetData(v []AdvisoryA10) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryA10PaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryA10PaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryA10PaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryA10PaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryA10PaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryA10PaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryA10PaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryA10PaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryA10PaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryA10PaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryA10PaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryA10PaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryA10PaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryA10PaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryA10PaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryA10PaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
