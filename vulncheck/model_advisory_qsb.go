...
// checks if the AdvisoryQSB type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AdvisoryQSB{}

// AdvisoryQSB struct for AdvisoryQSB
...
func (o AdvisoryQSB) MarshalJSON() ([]byte, error) {
...
func (o AdvisoryQSB) ToMap() (map[string]interface{}, error) {
...
type NullableAdvisoryQSB struct {
	value *AdvisoryQSB
	isSet bool
}

func (v NullableAdvisoryQSB) Get() *AdvisoryQSB {
	return v.value
}

func (v *NullableAdvisoryQSB) Set(val *AdvisoryQSB) {
	v.value = val
	v.isSet = true
}

func (v NullableAdvisoryQSB) IsSet() bool {
	return v.isSet
}

func (v *NullableAdvisoryQSB) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAdvisoryQSB(val *AdvisoryQSB) *NullableAdvisoryQSB {
	return &NullableAdvisoryQSB{value: val, isSet: true}
}

func (v NullableAdvisoryQSB) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAdvisoryQSB) UnmarshalJSON(src []byte) error {
	v.isSet = true
