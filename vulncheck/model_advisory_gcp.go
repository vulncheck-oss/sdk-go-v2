...
// checks if the AdvisoryGCP type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AdvisoryGCP{}

// AdvisoryGCP struct for AdvisoryGCP
...
func (o *AdvisoryGCP) GetReferences() []string {
...
func (o AdvisoryGCP) MarshalJSON() ([]byte, error) {
...
func (o AdvisoryGCP) ToMap() (map[string]interface{}, error) {
...
type NullableAdvisoryGCP struct {
	value *AdvisoryGCP
	isSet bool
}

func (v NullableAdvisoryGCP) Get() *AdvisoryGCP {
	return v.value
}

func (v *NullableAdvisoryGCP) Set(val *AdvisoryGCP) {
	v.value = val
	v.isSet = true
}

func (v NullableAdvisoryGCP) IsSet() bool {
	return v.isSet
}

func (v *NullableAdvisoryGCP) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAdvisoryGCP(val *AdvisoryGCP) *NullableAdvisoryGCP {
	return &NullableAdvisoryGCP{value: val, isSet: true}
}

func (v NullableAdvisoryGCP) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAdvisoryGCP) UnmarshalJSON(src []byte) error {
	v.isSet = true
