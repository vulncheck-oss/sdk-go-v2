...
// checks if the RenderResponseWithMetadataArrayAdvisoryNCSCCVEPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryNCSCCVEPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryNCSCCVEPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryNCSCCVEPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryNCSCCVEPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryNCSCCVEPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryNCSCCVEPaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisoryNCSCCVE and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryNCSCCVEPaginatePagination) SetData(v []AdvisoryNCSCCVE) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryNCSCCVEPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryNCSCCVEPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryNCSCCVEPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryNCSCCVEPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryNCSCCVEPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryNCSCCVEPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryNCSCCVEPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryNCSCCVEPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryNCSCCVEPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryNCSCCVEPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryNCSCCVEPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryNCSCCVEPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryNCSCCVEPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryNCSCCVEPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryNCSCCVEPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryNCSCCVEPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
