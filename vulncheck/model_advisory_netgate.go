...
// checks if the AdvisoryNetgate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AdvisoryNetgate{}

// AdvisoryNetgate struct for AdvisoryNetgate
...
func (o AdvisoryNetgate) MarshalJSON() ([]byte, error) {
...
func (o AdvisoryNetgate) ToMap() (map[string]interface{}, error) {
...
type NullableAdvisoryNetgate struct {
	value *AdvisoryNetgate
	isSet bool
}

func (v NullableAdvisoryNetgate) Get() *AdvisoryNetgate {
	return v.value
}

func (v *NullableAdvisoryNetgate) Set(val *AdvisoryNetgate) {
	v.value = val
	v.isSet = true
}

func (v NullableAdvisoryNetgate) IsSet() bool {
	return v.isSet
}

func (v *NullableAdvisoryNetgate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAdvisoryNetgate(val *AdvisoryNetgate) *NullableAdvisoryNetgate {
	return &NullableAdvisoryNetgate{value: val, isSet: true}
}

func (v NullableAdvisoryNetgate) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAdvisoryNetgate) UnmarshalJSON(src []byte) error {
	v.isSet = true
