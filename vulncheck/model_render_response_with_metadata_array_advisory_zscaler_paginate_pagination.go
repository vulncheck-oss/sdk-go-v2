...
// checks if the RenderResponseWithMetadataArrayAdvisoryZscalerPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryZscalerPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryZscalerPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryZscalerPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryZscalerPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryZscalerPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryZscalerPaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisoryZscaler and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryZscalerPaginatePagination) SetData(v []AdvisoryZscaler) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryZscalerPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryZscalerPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryZscalerPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryZscalerPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryZscalerPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryZscalerPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryZscalerPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryZscalerPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryZscalerPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryZscalerPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryZscalerPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryZscalerPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryZscalerPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryZscalerPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryZscalerPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryZscalerPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
