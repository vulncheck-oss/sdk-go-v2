...
// checks if the RenderResponseWithMetadataArrayAdvisoryGCPPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryGCPPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryGCPPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryGCPPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryGCPPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryGCPPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryGCPPaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisoryGCP and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryGCPPaginatePagination) SetData(v []AdvisoryGCP) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryGCPPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryGCPPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryGCPPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryGCPPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryGCPPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryGCPPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryGCPPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryGCPPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryGCPPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryGCPPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryGCPPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryGCPPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryGCPPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryGCPPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryGCPPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryGCPPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
