...
// checks if the AdvisoryBostonScientificAdvisory type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AdvisoryBostonScientificAdvisory{}

// AdvisoryBostonScientificAdvisory struct for AdvisoryBostonScientificAdvisory
...
func NewAdvisoryBostonScientificAdvisory() *AdvisoryBostonScientificAdvisory {
	this := AdvisoryBostonScientificAdvisory{}
	return &this
}
...
func (o AdvisoryBostonScientificAdvisory) MarshalJSON() ([]byte, error) {
...
func (o AdvisoryBostonScientificAdvisory) ToMap() (map[string]interface{}, error) {
...
type NullableAdvisoryBostonScientificAdvisory struct {
	value *AdvisoryBostonScientificAdvisory
	isSet bool
}

func (v NullableAdvisoryBostonScientificAdvisory) Get() *AdvisoryBostonScientificAdvisory {
	return v.value
}

func (v *NullableAdvisoryBostonScientificAdvisory) Set(val *AdvisoryBostonScientificAdvisory) {
	v.value = val
	v.isSet = true
}

func (v NullableAdvisoryBostonScientificAdvisory) IsSet() bool {
	return v.isSet
}

func (v *NullableAdvisoryBostonScientificAdvisory) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAdvisoryBostonScientificAdvisory(val *AdvisoryBostonScientificAdvisory) *NullableAdvisoryBostonScientificAdvisory {
	return &NullableAdvisoryBostonScientificAdvisory{value: val, isSet: true}
}

func (v NullableAdvisoryBostonScientificAdvisory) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAdvisoryBostonScientificAdvisory) UnmarshalJSON(src []byte) error {
	v.isSet = true
