...
// checks if the RenderResponseWithMetadataArrayAdvisoryVulnCheckKEVPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryVulnCheckKEVPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryVulnCheckKEVPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryVulnCheckKEVPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryVulnCheckKEVPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryVulnCheckKEVPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryVulnCheckKEVPaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisoryVulnCheckKEV and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryVulnCheckKEVPaginatePagination) SetData(v []AdvisoryVulnCheckKEV) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryVulnCheckKEVPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryVulnCheckKEVPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryVulnCheckKEVPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryVulnCheckKEVPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryVulnCheckKEVPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryVulnCheckKEVPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryVulnCheckKEVPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryVulnCheckKEVPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryVulnCheckKEVPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryVulnCheckKEVPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryVulnCheckKEVPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryVulnCheckKEVPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryVulnCheckKEVPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryVulnCheckKEVPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryVulnCheckKEVPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryVulnCheckKEVPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
