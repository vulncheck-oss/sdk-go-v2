...
// checks if the RenderResponseWithMetadataArrayAdvisoryWolfiPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryWolfiPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryWolfiPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryWolfiPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryWolfiPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryWolfiPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryWolfiPaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisoryWolfi and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryWolfiPaginatePagination) SetData(v []AdvisoryWolfi) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryWolfiPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryWolfiPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryWolfiPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryWolfiPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryWolfiPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryWolfiPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryWolfiPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryWolfiPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryWolfiPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryWolfiPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryWolfiPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryWolfiPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryWolfiPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryWolfiPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryWolfiPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryWolfiPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
