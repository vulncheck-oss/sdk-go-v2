...
// checks if the RenderResponseWithMetadataArrayAdvisoryBandrPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryBandrPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryBandrPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryBandrPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryBandrPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryBandrPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryBandrPaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisoryBandr and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryBandrPaginatePagination) SetData(v []AdvisoryBandr) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryBandrPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryBandrPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryBandrPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryBandrPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryBandrPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryBandrPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryBandrPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryBandrPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryBandrPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryBandrPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryBandrPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryBandrPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryBandrPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryBandrPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryBandrPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryBandrPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
