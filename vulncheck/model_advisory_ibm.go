...
// checks if the AdvisoryIBM type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AdvisoryIBM{}

// AdvisoryIBM struct for AdvisoryIBM
...
func (o AdvisoryIBM) MarshalJSON() ([]byte, error) {
...
func (o AdvisoryIBM) ToMap() (map[string]interface{}, error) {
...
type NullableAdvisoryIBM struct {
	value *AdvisoryIBM
	isSet bool
}

func (v NullableAdvisoryIBM) Get() *AdvisoryIBM {
	return v.value
}

func (v *NullableAdvisoryIBM) Set(val *AdvisoryIBM) {
	v.value = val
	v.isSet = true
}

func (v NullableAdvisoryIBM) IsSet() bool {
	return v.isSet
}

func (v *NullableAdvisoryIBM) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAdvisoryIBM(val *AdvisoryIBM) *NullableAdvisoryIBM {
	return &NullableAdvisoryIBM{value: val, isSet: true}
}

func (v NullableAdvisoryIBM) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAdvisoryIBM) UnmarshalJSON(src []byte) error {
	v.isSet = true
