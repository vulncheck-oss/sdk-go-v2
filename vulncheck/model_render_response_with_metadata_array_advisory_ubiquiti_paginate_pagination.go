...
// checks if the RenderResponseWithMetadataArrayAdvisoryUbiquitiPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryUbiquitiPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryUbiquitiPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryUbiquitiPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryUbiquitiPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryUbiquitiPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryUbiquitiPaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisoryUbiquiti and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryUbiquitiPaginatePagination) SetData(v []AdvisoryUbiquiti) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryUbiquitiPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryUbiquitiPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryUbiquitiPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryUbiquitiPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryUbiquitiPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryUbiquitiPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryUbiquitiPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryUbiquitiPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryUbiquitiPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryUbiquitiPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryUbiquitiPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryUbiquitiPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryUbiquitiPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryUbiquitiPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryUbiquitiPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryUbiquitiPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
