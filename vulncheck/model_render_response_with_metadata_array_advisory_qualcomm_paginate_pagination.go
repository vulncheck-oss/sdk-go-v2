...
// checks if the RenderResponseWithMetadataArrayAdvisoryQualcommPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryQualcommPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryQualcommPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryQualcommPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryQualcommPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryQualcommPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryQualcommPaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisoryQualcomm and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryQualcommPaginatePagination) SetData(v []AdvisoryQualcomm) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryQualcommPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryQualcommPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryQualcommPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryQualcommPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryQualcommPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryQualcommPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryQualcommPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryQualcommPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryQualcommPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryQualcommPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryQualcommPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryQualcommPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryQualcommPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryQualcommPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryQualcommPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryQualcommPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
