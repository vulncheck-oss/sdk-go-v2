...
// checks if the RenderResponseWithMetadataArrayAdvisoryApacheLoggingServicesPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryApacheLoggingServicesPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryApacheLoggingServicesPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryApacheLoggingServicesPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryApacheLoggingServicesPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryApacheLoggingServicesPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryApacheLoggingServicesPaginatePagination{}
	return &this
}
...
func (o *RenderResponseWithMetadataArrayAdvisoryApacheLoggingServicesPaginatePagination) GetData() []AdvisoryApacheLoggingServices {
	if o == nil || IsNil(o.Data) {
		var ret []AdvisoryApacheLoggingServices
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []AdvisoryApacheLoggingServices and assigns it to the Data field.
...
func (o RenderResponseWithMetadataArrayAdvisoryApacheLoggingServicesPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryApacheLoggingServicesPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryApacheLoggingServicesPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryApacheLoggingServicesPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryApacheLoggingServicesPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryApacheLoggingServicesPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryApacheLoggingServicesPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryApacheLoggingServicesPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryApacheLoggingServicesPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryApacheLoggingServicesPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryApacheLoggingServicesPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryApacheLoggingServicesPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryApacheLoggingServicesPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryApacheLoggingServicesPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryApacheLoggingServicesPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryApacheLoggingServicesPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
