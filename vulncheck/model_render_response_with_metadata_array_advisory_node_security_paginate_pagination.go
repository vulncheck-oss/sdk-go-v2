...
// checks if the RenderResponseWithMetadataArrayAdvisoryNodeSecurityPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryNodeSecurityPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryNodeSecurityPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryNodeSecurityPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryNodeSecurityPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryNodeSecurityPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryNodeSecurityPaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisoryNodeSecurity and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryNodeSecurityPaginatePagination) SetData(v []AdvisoryNodeSecurity) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryNodeSecurityPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryNodeSecurityPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryNodeSecurityPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryNodeSecurityPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryNodeSecurityPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryNodeSecurityPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryNodeSecurityPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryNodeSecurityPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryNodeSecurityPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryNodeSecurityPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryNodeSecurityPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryNodeSecurityPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryNodeSecurityPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryNodeSecurityPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryNodeSecurityPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryNodeSecurityPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
