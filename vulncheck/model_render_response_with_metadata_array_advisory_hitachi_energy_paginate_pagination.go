...
// checks if the RenderResponseWithMetadataArrayAdvisoryHitachiEnergyPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryHitachiEnergyPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryHitachiEnergyPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryHitachiEnergyPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryHitachiEnergyPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryHitachiEnergyPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryHitachiEnergyPaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisoryHitachiEnergy and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryHitachiEnergyPaginatePagination) SetData(v []AdvisoryHitachiEnergy) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryHitachiEnergyPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryHitachiEnergyPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryHitachiEnergyPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryHitachiEnergyPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryHitachiEnergyPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryHitachiEnergyPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryHitachiEnergyPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryHitachiEnergyPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryHitachiEnergyPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryHitachiEnergyPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryHitachiEnergyPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryHitachiEnergyPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryHitachiEnergyPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryHitachiEnergyPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryHitachiEnergyPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryHitachiEnergyPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
