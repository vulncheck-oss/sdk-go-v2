...
// checks if the RenderResponseWithMetadataArrayAdvisoryNCSCPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryNCSCPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryNCSCPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryNCSCPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryNCSCPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryNCSCPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryNCSCPaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisoryNCSC and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryNCSCPaginatePagination) SetData(v []AdvisoryNCSC) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryNCSCPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryNCSCPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryNCSCPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryNCSCPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryNCSCPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryNCSCPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryNCSCPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryNCSCPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryNCSCPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryNCSCPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryNCSCPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryNCSCPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryNCSCPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryNCSCPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryNCSCPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryNCSCPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
