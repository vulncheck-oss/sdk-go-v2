...
// checks if the RenderResponseWithMetadataArrayAdvisoryFestoPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryFestoPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryFestoPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryFestoPaginatePagination
type RenderResponseWithMetadataArrayAdvisoryFestoPaginatePagination struct {
	Benchmark *float32 `json:"_benchmark,omitempty"`
	Meta *PaginatePagination `json:"_meta,omitempty"`
	Data []AdvisoryFesto `json:"data,omitempty"`
}
...
func NewRenderResponseWithMetadataArrayAdvisoryFestoPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryFestoPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryFestoPaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisoryFesto and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryFestoPaginatePagination) SetData(v []AdvisoryFesto) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryFestoPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryFestoPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryFestoPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryFestoPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryFestoPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryFestoPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryFestoPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryFestoPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryFestoPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryFestoPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryFestoPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryFestoPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryFestoPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryFestoPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryFestoPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryFestoPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
