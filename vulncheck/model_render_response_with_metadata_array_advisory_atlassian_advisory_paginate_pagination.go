...
// checks if the RenderResponseWithMetadataArrayAdvisoryAtlassianAdvisoryPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryAtlassianAdvisoryPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryAtlassianAdvisoryPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryAtlassianAdvisoryPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryAtlassianAdvisoryPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryAtlassianAdvisoryPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryAtlassianAdvisoryPaginatePagination{}
	return &this
}
...
func (o *RenderResponseWithMetadataArrayAdvisoryAtlassianAdvisoryPaginatePagination) GetData() []AdvisoryAtlassianAdvisory {
	if o == nil || IsNil(o.Data) {
		var ret []AdvisoryAtlassianAdvisory
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []AdvisoryAtlassianAdvisory and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryAtlassianAdvisoryPaginatePagination) SetData(v []AdvisoryAtlassianAdvisory) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryAtlassianAdvisoryPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryAtlassianAdvisoryPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryAtlassianAdvisoryPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryAtlassianAdvisoryPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryAtlassianAdvisoryPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryAtlassianAdvisoryPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryAtlassianAdvisoryPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryAtlassianAdvisoryPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryAtlassianAdvisoryPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryAtlassianAdvisoryPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryAtlassianAdvisoryPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryAtlassianAdvisoryPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryAtlassianAdvisoryPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryAtlassianAdvisoryPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryAtlassianAdvisoryPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryAtlassianAdvisoryPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
