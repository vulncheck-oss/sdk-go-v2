...
// checks if the RenderResponseWithMetadataArrayAdvisorySAPPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisorySAPPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisorySAPPaginatePagination struct for RenderResponseWithMetadataArrayAdvisorySAPPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisorySAPPaginatePagination() *RenderResponseWithMetadataArrayAdvisorySAPPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisorySAPPaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisorySAP and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisorySAPPaginatePagination) SetData(v []AdvisorySAP) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisorySAPPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisorySAPPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisorySAPPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisorySAPPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisorySAPPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisorySAPPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisorySAPPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisorySAPPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisorySAPPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisorySAPPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisorySAPPaginatePagination(val *RenderResponseWithMetadataArrayAdvisorySAPPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisorySAPPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisorySAPPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisorySAPPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisorySAPPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
