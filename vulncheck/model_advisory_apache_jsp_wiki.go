...
// checks if the AdvisoryApacheJSPWiki type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AdvisoryApacheJSPWiki{}

// AdvisoryApacheJSPWiki struct for AdvisoryApacheJSPWiki
...
func (o AdvisoryApacheJSPWiki) MarshalJSON() ([]byte, error) {
...
func (o AdvisoryApacheJSPWiki) ToMap() (map[string]interface{}, error) {
...
type NullableAdvisoryApacheJSPWiki struct {
	value *AdvisoryApacheJSPWiki
	isSet bool
}

func (v NullableAdvisoryApacheJSPWiki) Get() *AdvisoryApacheJSPWiki {
	return v.value
}

func (v *NullableAdvisoryApacheJSPWiki) Set(val *AdvisoryApacheJSPWiki) {
	v.value = val
	v.isSet = true
}

func (v NullableAdvisoryApacheJSPWiki) IsSet() bool {
	return v.isSet
}

func (v *NullableAdvisoryApacheJSPWiki) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAdvisoryApacheJSPWiki(val *AdvisoryApacheJSPWiki) *NullableAdvisoryApacheJSPWiki {
	return &NullableAdvisoryApacheJSPWiki{value: val, isSet: true}
}

func (v NullableAdvisoryApacheJSPWiki) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAdvisoryApacheJSPWiki) UnmarshalJSON(src []byte) error {
	v.isSet = true
