...
// checks if the RenderResponseWithMetadataArrayAdvisoryUnisocPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryUnisocPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryUnisocPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryUnisocPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryUnisocPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryUnisocPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryUnisocPaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisoryUnisoc and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryUnisocPaginatePagination) SetData(v []AdvisoryUnisoc) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryUnisocPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryUnisocPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryUnisocPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryUnisocPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryUnisocPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryUnisocPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryUnisocPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryUnisocPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryUnisocPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryUnisocPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryUnisocPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryUnisocPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryUnisocPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryUnisocPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryUnisocPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryUnisocPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
