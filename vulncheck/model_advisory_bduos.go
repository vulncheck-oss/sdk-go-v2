...
// checks if the AdvisoryBDUOs type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AdvisoryBDUOs{}

// AdvisoryBDUOs struct for AdvisoryBDUOs
...
func (o AdvisoryBDUOs) MarshalJSON() ([]byte, error) {
...
func (o AdvisoryBDUOs) ToMap() (map[string]interface{}, error) {
...
type NullableAdvisoryBDUOs struct {
	value *AdvisoryBDUOs
	isSet bool
}

func (v NullableAdvisoryBDUOs) Get() *AdvisoryBDUOs {
	return v.value
}

func (v *NullableAdvisoryBDUOs) Set(val *AdvisoryBDUOs) {
	v.value = val
	v.isSet = true
}

func (v NullableAdvisoryBDUOs) IsSet() bool {
	return v.isSet
}

func (v *NullableAdvisoryBDUOs) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAdvisoryBDUOs(val *AdvisoryBDUOs) *NullableAdvisoryBDUOs {
	return &NullableAdvisoryBDUOs{value: val, isSet: true}
}

func (v NullableAdvisoryBDUOs) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAdvisoryBDUOs) UnmarshalJSON(src []byte) error {
	v.isSet = true
