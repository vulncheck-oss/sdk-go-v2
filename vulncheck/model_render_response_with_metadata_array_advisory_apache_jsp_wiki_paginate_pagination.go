...
// checks if the RenderResponseWithMetadataArrayAdvisoryApacheJSPWikiPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryApacheJSPWikiPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryApacheJSPWikiPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryApacheJSPWikiPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryApacheJSPWikiPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryApacheJSPWikiPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryApacheJSPWikiPaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisoryApacheJSPWiki and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryApacheJSPWikiPaginatePagination) SetData(v []AdvisoryApacheJSPWiki) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryApacheJSPWikiPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryApacheJSPWikiPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryApacheJSPWikiPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryApacheJSPWikiPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryApacheJSPWikiPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryApacheJSPWikiPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryApacheJSPWikiPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryApacheJSPWikiPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryApacheJSPWikiPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryApacheJSPWikiPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryApacheJSPWikiPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryApacheJSPWikiPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryApacheJSPWikiPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryApacheJSPWikiPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryApacheJSPWikiPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryApacheJSPWikiPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
