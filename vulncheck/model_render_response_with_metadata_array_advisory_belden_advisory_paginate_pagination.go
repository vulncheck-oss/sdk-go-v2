...
// checks if the RenderResponseWithMetadataArrayAdvisoryBeldenAdvisoryPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryBeldenAdvisoryPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryBeldenAdvisoryPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryBeldenAdvisoryPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryBeldenAdvisoryPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryBeldenAdvisoryPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryBeldenAdvisoryPaginatePagination{}
	return &this
}
...
func (o *RenderResponseWithMetadataArrayAdvisoryBeldenAdvisoryPaginatePagination) GetData() []AdvisoryBeldenAdvisory {
	if o == nil || IsNil(o.Data) {
		var ret []AdvisoryBeldenAdvisory
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []AdvisoryBeldenAdvisory and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryBeldenAdvisoryPaginatePagination) SetData(v []AdvisoryBeldenAdvisory) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryBeldenAdvisoryPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryBeldenAdvisoryPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryBeldenAdvisoryPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryBeldenAdvisoryPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryBeldenAdvisoryPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryBeldenAdvisoryPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryBeldenAdvisoryPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryBeldenAdvisoryPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryBeldenAdvisoryPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryBeldenAdvisoryPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryBeldenAdvisoryPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryBeldenAdvisoryPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryBeldenAdvisoryPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryBeldenAdvisoryPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryBeldenAdvisoryPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryBeldenAdvisoryPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
