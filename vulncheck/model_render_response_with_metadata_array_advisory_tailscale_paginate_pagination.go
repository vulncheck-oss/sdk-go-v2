...
// checks if the RenderResponseWithMetadataArrayAdvisoryTailscalePaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryTailscalePaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryTailscalePaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryTailscalePaginatePagination
type RenderResponseWithMetadataArrayAdvisoryTailscalePaginatePagination struct {
	Benchmark *float32 `json:"_benchmark,omitempty"`
	Meta *PaginatePagination `json:"_meta,omitempty"`
	Data []AdvisoryTailscale `json:"data,omitempty"`
}
...
func NewRenderResponseWithMetadataArrayAdvisoryTailscalePaginatePagination() *RenderResponseWithMetadataArrayAdvisoryTailscalePaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryTailscalePaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisoryTailscale and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryTailscalePaginatePagination) SetData(v []AdvisoryTailscale) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryTailscalePaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryTailscalePaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryTailscalePaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryTailscalePaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryTailscalePaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryTailscalePaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryTailscalePaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryTailscalePaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryTailscalePaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryTailscalePaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryTailscalePaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryTailscalePaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryTailscalePaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryTailscalePaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryTailscalePaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryTailscalePaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
