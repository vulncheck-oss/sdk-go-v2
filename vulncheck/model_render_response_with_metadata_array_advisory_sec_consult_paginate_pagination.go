...
// checks if the RenderResponseWithMetadataArrayAdvisorySECConsultPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisorySECConsultPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisorySECConsultPaginatePagination struct for RenderResponseWithMetadataArrayAdvisorySECConsultPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisorySECConsultPaginatePagination() *RenderResponseWithMetadataArrayAdvisorySECConsultPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisorySECConsultPaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisorySECConsult and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisorySECConsultPaginatePagination) SetData(v []AdvisorySECConsult) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisorySECConsultPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisorySECConsultPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisorySECConsultPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisorySECConsultPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisorySECConsultPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisorySECConsultPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisorySECConsultPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisorySECConsultPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisorySECConsultPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisorySECConsultPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisorySECConsultPaginatePagination(val *RenderResponseWithMetadataArrayAdvisorySECConsultPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisorySECConsultPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisorySECConsultPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisorySECConsultPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisorySECConsultPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
