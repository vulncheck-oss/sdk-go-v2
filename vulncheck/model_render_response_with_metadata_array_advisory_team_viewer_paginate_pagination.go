...
// checks if the RenderResponseWithMetadataArrayAdvisoryTeamViewerPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryTeamViewerPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryTeamViewerPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryTeamViewerPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryTeamViewerPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryTeamViewerPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryTeamViewerPaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisoryTeamViewer and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryTeamViewerPaginatePagination) SetData(v []AdvisoryTeamViewer) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryTeamViewerPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryTeamViewerPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryTeamViewerPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryTeamViewerPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryTeamViewerPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryTeamViewerPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryTeamViewerPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryTeamViewerPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryTeamViewerPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryTeamViewerPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryTeamViewerPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryTeamViewerPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryTeamViewerPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryTeamViewerPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryTeamViewerPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryTeamViewerPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
