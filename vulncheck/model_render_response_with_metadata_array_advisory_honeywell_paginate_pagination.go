...
// checks if the RenderResponseWithMetadataArrayAdvisoryHoneywellPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryHoneywellPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryHoneywellPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryHoneywellPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryHoneywellPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryHoneywellPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryHoneywellPaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisoryHoneywell and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryHoneywellPaginatePagination) SetData(v []AdvisoryHoneywell) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryHoneywellPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryHoneywellPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryHoneywellPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryHoneywellPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryHoneywellPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryHoneywellPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryHoneywellPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryHoneywellPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryHoneywellPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryHoneywellPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryHoneywellPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryHoneywellPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryHoneywellPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryHoneywellPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryHoneywellPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryHoneywellPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
