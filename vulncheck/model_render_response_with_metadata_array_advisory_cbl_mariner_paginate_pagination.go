...
// checks if the RenderResponseWithMetadataArrayAdvisoryCBLMarinerPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryCBLMarinerPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryCBLMarinerPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryCBLMarinerPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryCBLMarinerPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryCBLMarinerPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryCBLMarinerPaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisoryCBLMariner and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryCBLMarinerPaginatePagination) SetData(v []AdvisoryCBLMariner) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryCBLMarinerPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryCBLMarinerPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryCBLMarinerPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryCBLMarinerPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryCBLMarinerPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryCBLMarinerPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryCBLMarinerPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryCBLMarinerPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryCBLMarinerPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryCBLMarinerPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryCBLMarinerPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryCBLMarinerPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryCBLMarinerPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryCBLMarinerPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryCBLMarinerPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryCBLMarinerPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
