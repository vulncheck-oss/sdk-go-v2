...
// checks if the RenderResponseWithMetadataArrayAdvisoryEmersonAdvisoryPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryEmersonAdvisoryPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryEmersonAdvisoryPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryEmersonAdvisoryPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryEmersonAdvisoryPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryEmersonAdvisoryPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryEmersonAdvisoryPaginatePagination{}
	return &this
}
...
func (o *RenderResponseWithMetadataArrayAdvisoryEmersonAdvisoryPaginatePagination) GetData() []AdvisoryEmersonAdvisory {
	if o == nil || IsNil(o.Data) {
		var ret []AdvisoryEmersonAdvisory
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []AdvisoryEmersonAdvisory and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryEmersonAdvisoryPaginatePagination) SetData(v []AdvisoryEmersonAdvisory) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryEmersonAdvisoryPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryEmersonAdvisoryPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryEmersonAdvisoryPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryEmersonAdvisoryPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryEmersonAdvisoryPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryEmersonAdvisoryPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryEmersonAdvisoryPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryEmersonAdvisoryPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryEmersonAdvisoryPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryEmersonAdvisoryPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryEmersonAdvisoryPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryEmersonAdvisoryPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryEmersonAdvisoryPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryEmersonAdvisoryPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryEmersonAdvisoryPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryEmersonAdvisoryPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
