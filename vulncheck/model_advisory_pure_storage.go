...
// checks if the AdvisoryPureStorage type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AdvisoryPureStorage{}

// AdvisoryPureStorage struct for AdvisoryPureStorage
...
func (o *AdvisoryPureStorage) GetDateAdded() string {
...
func (o AdvisoryPureStorage) MarshalJSON() ([]byte, error) {
...
func (o AdvisoryPureStorage) ToMap() (map[string]interface{}, error) {
...
type NullableAdvisoryPureStorage struct {
	value *AdvisoryPureStorage
	isSet bool
}

func (v NullableAdvisoryPureStorage) Get() *AdvisoryPureStorage {
	return v.value
}

func (v *NullableAdvisoryPureStorage) Set(val *AdvisoryPureStorage) {
	v.value = val
	v.isSet = true
}

func (v NullableAdvisoryPureStorage) IsSet() bool {
	return v.isSet
}

func (v *NullableAdvisoryPureStorage) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAdvisoryPureStorage(val *AdvisoryPureStorage) *NullableAdvisoryPureStorage {
	return &NullableAdvisoryPureStorage{value: val, isSet: true}
}

func (v NullableAdvisoryPureStorage) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAdvisoryPureStorage) UnmarshalJSON(src []byte) error {
	v.isSet = true
