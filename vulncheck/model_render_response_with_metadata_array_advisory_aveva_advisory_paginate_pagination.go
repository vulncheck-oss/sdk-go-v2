...
// checks if the RenderResponseWithMetadataArrayAdvisoryAVEVAAdvisoryPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryAVEVAAdvisoryPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryAVEVAAdvisoryPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryAVEVAAdvisoryPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryAVEVAAdvisoryPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryAVEVAAdvisoryPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryAVEVAAdvisoryPaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisoryAVEVAAdvisory and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryAVEVAAdvisoryPaginatePagination) SetData(v []AdvisoryAVEVAAdvisory) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryAVEVAAdvisoryPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryAVEVAAdvisoryPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryAVEVAAdvisoryPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryAVEVAAdvisoryPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryAVEVAAdvisoryPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryAVEVAAdvisoryPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryAVEVAAdvisoryPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryAVEVAAdvisoryPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryAVEVAAdvisoryPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryAVEVAAdvisoryPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryAVEVAAdvisoryPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryAVEVAAdvisoryPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryAVEVAAdvisoryPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryAVEVAAdvisoryPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryAVEVAAdvisoryPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryAVEVAAdvisoryPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
