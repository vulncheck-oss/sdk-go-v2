...
// checks if the RenderResponseWithMetadataArrayAdvisoryMedtronicAdvisoryPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryMedtronicAdvisoryPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryMedtronicAdvisoryPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryMedtronicAdvisoryPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryMedtronicAdvisoryPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryMedtronicAdvisoryPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryMedtronicAdvisoryPaginatePagination{}
	return &this
}
...
func (o *RenderResponseWithMetadataArrayAdvisoryMedtronicAdvisoryPaginatePagination) GetData() []AdvisoryMedtronicAdvisory {
	if o == nil || IsNil(o.Data) {
		var ret []AdvisoryMedtronicAdvisory
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []AdvisoryMedtronicAdvisory and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryMedtronicAdvisoryPaginatePagination) SetData(v []AdvisoryMedtronicAdvisory) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryMedtronicAdvisoryPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryMedtronicAdvisoryPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryMedtronicAdvisoryPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryMedtronicAdvisoryPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryMedtronicAdvisoryPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryMedtronicAdvisoryPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryMedtronicAdvisoryPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryMedtronicAdvisoryPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryMedtronicAdvisoryPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryMedtronicAdvisoryPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryMedtronicAdvisoryPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryMedtronicAdvisoryPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryMedtronicAdvisoryPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryMedtronicAdvisoryPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryMedtronicAdvisoryPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryMedtronicAdvisoryPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
