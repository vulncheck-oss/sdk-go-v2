...
// checks if the AdvisorySpacelabsHealthcareAdvisory type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AdvisorySpacelabsHealthcareAdvisory{}

// AdvisorySpacelabsHealthcareAdvisory struct for AdvisorySpacelabsHealthcareAdvisory
...
func NewAdvisorySpacelabsHealthcareAdvisory() *AdvisorySpacelabsHealthcareAdvisory {
	this := AdvisorySpacelabsHealthcareAdvisory{}
	return &this
}
...
func (o AdvisorySpacelabsHealthcareAdvisory) MarshalJSON() ([]byte, error) {
...
func (o AdvisorySpacelabsHealthcareAdvisory) ToMap() (map[string]interface{}, error) {
...
type NullableAdvisorySpacelabsHealthcareAdvisory struct {
	value *AdvisorySpacelabsHealthcareAdvisory
	isSet bool
}

func (v NullableAdvisorySpacelabsHealthcareAdvisory) Get() *AdvisorySpacelabsHealthcareAdvisory {
	return v.value
}

func (v *NullableAdvisorySpacelabsHealthcareAdvisory) Set(val *AdvisorySpacelabsHealthcareAdvisory) {
	v.value = val
	v.isSet = true
}

func (v NullableAdvisorySpacelabsHealthcareAdvisory) IsSet() bool {
	return v.isSet
}

func (v *NullableAdvisorySpacelabsHealthcareAdvisory) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAdvisorySpacelabsHealthcareAdvisory(val *AdvisorySpacelabsHealthcareAdvisory) *NullableAdvisorySpacelabsHealthcareAdvisory {
	return &NullableAdvisorySpacelabsHealthcareAdvisory{value: val, isSet: true}
}

func (v NullableAdvisorySpacelabsHealthcareAdvisory) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAdvisorySpacelabsHealthcareAdvisory) UnmarshalJSON(src []byte) error {
	v.isSet = true
