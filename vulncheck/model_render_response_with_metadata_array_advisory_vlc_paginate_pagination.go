...
// checks if the RenderResponseWithMetadataArrayAdvisoryVLCPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryVLCPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryVLCPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryVLCPaginatePagination
type RenderResponseWithMetadataArrayAdvisoryVLCPaginatePagination struct {
	Benchmark *float32 `json:"_benchmark,omitempty"`
	Meta *PaginatePagination `json:"_meta,omitempty"`
	Data []AdvisoryVLC `json:"data,omitempty"`
}
...
func NewRenderResponseWithMetadataArrayAdvisoryVLCPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryVLCPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryVLCPaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisoryVLC and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryVLCPaginatePagination) SetData(v []AdvisoryVLC) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryVLCPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryVLCPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryVLCPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryVLCPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryVLCPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryVLCPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryVLCPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryVLCPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryVLCPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryVLCPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryVLCPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryVLCPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryVLCPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryVLCPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryVLCPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryVLCPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
