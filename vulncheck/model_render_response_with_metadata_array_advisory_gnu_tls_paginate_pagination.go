...
// checks if the RenderResponseWithMetadataArrayAdvisoryGnuTLSPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryGnuTLSPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryGnuTLSPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryGnuTLSPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryGnuTLSPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryGnuTLSPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryGnuTLSPaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisoryGnuTLS and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryGnuTLSPaginatePagination) SetData(v []AdvisoryGnuTLS) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryGnuTLSPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryGnuTLSPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryGnuTLSPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryGnuTLSPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryGnuTLSPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryGnuTLSPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryGnuTLSPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryGnuTLSPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryGnuTLSPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryGnuTLSPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryGnuTLSPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryGnuTLSPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryGnuTLSPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryGnuTLSPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryGnuTLSPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryGnuTLSPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
