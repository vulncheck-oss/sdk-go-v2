...
// checks if the RenderResponseWithMetadataArrayAdvisorySpacelabsHealthcareAdvisoryPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisorySpacelabsHealthcareAdvisoryPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisorySpacelabsHealthcareAdvisoryPaginatePagination struct for RenderResponseWithMetadataArrayAdvisorySpacelabsHealthcareAdvisoryPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisorySpacelabsHealthcareAdvisoryPaginatePagination() *RenderResponseWithMetadataArrayAdvisorySpacelabsHealthcareAdvisoryPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisorySpacelabsHealthcareAdvisoryPaginatePagination{}
	return &this
}
...
func (o *RenderResponseWithMetadataArrayAdvisorySpacelabsHealthcareAdvisoryPaginatePagination) GetData() []AdvisorySpacelabsHealthcareAdvisory {
	if o == nil || IsNil(o.Data) {
		var ret []AdvisorySpacelabsHealthcareAdvisory
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []AdvisorySpacelabsHealthcareAdvisory and assigns it to the Data field.
...
func (o RenderResponseWithMetadataArrayAdvisorySpacelabsHealthcareAdvisoryPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisorySpacelabsHealthcareAdvisoryPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisorySpacelabsHealthcareAdvisoryPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisorySpacelabsHealthcareAdvisoryPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisorySpacelabsHealthcareAdvisoryPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisorySpacelabsHealthcareAdvisoryPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisorySpacelabsHealthcareAdvisoryPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisorySpacelabsHealthcareAdvisoryPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisorySpacelabsHealthcareAdvisoryPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisorySpacelabsHealthcareAdvisoryPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisorySpacelabsHealthcareAdvisoryPaginatePagination(val *RenderResponseWithMetadataArrayAdvisorySpacelabsHealthcareAdvisoryPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisorySpacelabsHealthcareAdvisoryPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisorySpacelabsHealthcareAdvisoryPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisorySpacelabsHealthcareAdvisoryPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisorySpacelabsHealthcareAdvisoryPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
