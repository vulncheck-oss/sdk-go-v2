...
// checks if the RenderResponseWithMetadataArrayAdvisoryPostgresSQLPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryPostgresSQLPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryPostgresSQLPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryPostgresSQLPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryPostgresSQLPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryPostgresSQLPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryPostgresSQLPaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisoryPostgresSQL and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryPostgresSQLPaginatePagination) SetData(v []AdvisoryPostgresSQL) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryPostgresSQLPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryPostgresSQLPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryPostgresSQLPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryPostgresSQLPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryPostgresSQLPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryPostgresSQLPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryPostgresSQLPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryPostgresSQLPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryPostgresSQLPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryPostgresSQLPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryPostgresSQLPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryPostgresSQLPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryPostgresSQLPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryPostgresSQLPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryPostgresSQLPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryPostgresSQLPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
