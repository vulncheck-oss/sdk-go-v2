...
// checks if the RenderResponseWithMetadataArrayAdvisoryZusoPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryZusoPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryZusoPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryZusoPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryZusoPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryZusoPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryZusoPaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisoryZuso and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryZusoPaginatePagination) SetData(v []AdvisoryZuso) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryZusoPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryZusoPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryZusoPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryZusoPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryZusoPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryZusoPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryZusoPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryZusoPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryZusoPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryZusoPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryZusoPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryZusoPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryZusoPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryZusoPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryZusoPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryZusoPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
