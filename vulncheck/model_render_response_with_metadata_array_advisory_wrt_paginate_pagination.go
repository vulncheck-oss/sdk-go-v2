...
// checks if the RenderResponseWithMetadataArrayAdvisoryWRTPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryWRTPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryWRTPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryWRTPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryWRTPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryWRTPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryWRTPaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisoryWRT and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryWRTPaginatePagination) SetData(v []AdvisoryWRT) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryWRTPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryWRTPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryWRTPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryWRTPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryWRTPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryWRTPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryWRTPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryWRTPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryWRTPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryWRTPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryWRTPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryWRTPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryWRTPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryWRTPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryWRTPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryWRTPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
