...
// checks if the RenderResponseWithMetadataArrayAdvisoryApacheHadoopPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryApacheHadoopPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryApacheHadoopPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryApacheHadoopPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryApacheHadoopPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryApacheHadoopPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryApacheHadoopPaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisoryApacheHadoop and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryApacheHadoopPaginatePagination) SetData(v []AdvisoryApacheHadoop) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryApacheHadoopPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryApacheHadoopPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryApacheHadoopPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryApacheHadoopPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryApacheHadoopPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryApacheHadoopPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryApacheHadoopPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryApacheHadoopPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryApacheHadoopPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryApacheHadoopPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryApacheHadoopPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryApacheHadoopPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryApacheHadoopPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryApacheHadoopPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryApacheHadoopPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryApacheHadoopPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
