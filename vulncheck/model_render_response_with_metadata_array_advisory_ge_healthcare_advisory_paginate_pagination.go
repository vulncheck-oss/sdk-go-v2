...
// checks if the RenderResponseWithMetadataArrayAdvisoryGEHealthcareAdvisoryPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryGEHealthcareAdvisoryPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryGEHealthcareAdvisoryPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryGEHealthcareAdvisoryPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryGEHealthcareAdvisoryPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryGEHealthcareAdvisoryPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryGEHealthcareAdvisoryPaginatePagination{}
	return &this
}
...
func (o *RenderResponseWithMetadataArrayAdvisoryGEHealthcareAdvisoryPaginatePagination) GetData() []AdvisoryGEHealthcareAdvisory {
	if o == nil || IsNil(o.Data) {
		var ret []AdvisoryGEHealthcareAdvisory
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []AdvisoryGEHealthcareAdvisory and assigns it to the Data field.
...
func (o RenderResponseWithMetadataArrayAdvisoryGEHealthcareAdvisoryPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryGEHealthcareAdvisoryPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryGEHealthcareAdvisoryPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryGEHealthcareAdvisoryPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryGEHealthcareAdvisoryPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryGEHealthcareAdvisoryPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryGEHealthcareAdvisoryPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryGEHealthcareAdvisoryPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryGEHealthcareAdvisoryPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryGEHealthcareAdvisoryPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryGEHealthcareAdvisoryPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryGEHealthcareAdvisoryPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryGEHealthcareAdvisoryPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryGEHealthcareAdvisoryPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryGEHealthcareAdvisoryPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryGEHealthcareAdvisoryPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
