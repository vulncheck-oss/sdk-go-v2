...
// checks if the RenderResponseWithMetadataArrayAdvisoryRockwellPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryRockwellPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryRockwellPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryRockwellPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryRockwellPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryRockwellPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryRockwellPaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisoryRockwell and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryRockwellPaginatePagination) SetData(v []AdvisoryRockwell) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryRockwellPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryRockwellPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryRockwellPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryRockwellPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryRockwellPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryRockwellPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryRockwellPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryRockwellPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryRockwellPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryRockwellPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryRockwellPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryRockwellPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryRockwellPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryRockwellPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryRockwellPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryRockwellPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
