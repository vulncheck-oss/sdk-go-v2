...
// checks if the RenderResponseWithMetadataArrayAdvisoryGHAdvisoryJSONLeanPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryGHAdvisoryJSONLeanPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryGHAdvisoryJSONLeanPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryGHAdvisoryJSONLeanPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryGHAdvisoryJSONLeanPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryGHAdvisoryJSONLeanPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryGHAdvisoryJSONLeanPaginatePagination{}
	return &this
}
...
func (o *RenderResponseWithMetadataArrayAdvisoryGHAdvisoryJSONLeanPaginatePagination) GetData() []AdvisoryGHAdvisoryJSONLean {
	if o == nil || IsNil(o.Data) {
		var ret []AdvisoryGHAdvisoryJSONLean
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []AdvisoryGHAdvisoryJSONLean and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryGHAdvisoryJSONLeanPaginatePagination) SetData(v []AdvisoryGHAdvisoryJSONLean) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryGHAdvisoryJSONLeanPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryGHAdvisoryJSONLeanPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryGHAdvisoryJSONLeanPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryGHAdvisoryJSONLeanPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryGHAdvisoryJSONLeanPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryGHAdvisoryJSONLeanPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryGHAdvisoryJSONLeanPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryGHAdvisoryJSONLeanPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryGHAdvisoryJSONLeanPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryGHAdvisoryJSONLeanPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryGHAdvisoryJSONLeanPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryGHAdvisoryJSONLeanPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryGHAdvisoryJSONLeanPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryGHAdvisoryJSONLeanPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryGHAdvisoryJSONLeanPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryGHAdvisoryJSONLeanPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
