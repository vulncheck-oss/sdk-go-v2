...
// checks if the RenderResponseWithMetadataArrayAdvisoryAppgatePaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryAppgatePaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryAppgatePaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryAppgatePaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryAppgatePaginatePagination() *RenderResponseWithMetadataArrayAdvisoryAppgatePaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryAppgatePaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisoryAppgate and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryAppgatePaginatePagination) SetData(v []AdvisoryAppgate) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryAppgatePaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryAppgatePaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryAppgatePaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryAppgatePaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryAppgatePaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryAppgatePaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryAppgatePaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryAppgatePaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryAppgatePaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryAppgatePaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryAppgatePaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryAppgatePaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryAppgatePaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryAppgatePaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryAppgatePaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryAppgatePaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
