...
// checks if the RenderResponseWithMetadataArrayAdvisoryMitelPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryMitelPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryMitelPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryMitelPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryMitelPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryMitelPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryMitelPaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisoryMitel and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryMitelPaginatePagination) SetData(v []AdvisoryMitel) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryMitelPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryMitelPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryMitelPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryMitelPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryMitelPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryMitelPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryMitelPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryMitelPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryMitelPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryMitelPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryMitelPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryMitelPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryMitelPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryMitelPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryMitelPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryMitelPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
