...
// checks if the RenderResponseWithMetadataArrayAdvisoryQSBPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryQSBPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryQSBPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryQSBPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryQSBPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryQSBPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryQSBPaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisoryQSB and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryQSBPaginatePagination) SetData(v []AdvisoryQSB) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryQSBPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryQSBPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryQSBPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryQSBPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryQSBPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryQSBPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryQSBPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryQSBPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryQSBPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryQSBPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryQSBPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryQSBPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryQSBPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryQSBPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryQSBPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryQSBPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
