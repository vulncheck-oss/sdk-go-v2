...
// checks if the RenderResponseWithMetadataArrayAdvisoryMACertPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryMACertPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryMACertPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryMACertPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryMACertPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryMACertPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryMACertPaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisoryMACert and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryMACertPaginatePagination) SetData(v []AdvisoryMACert) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryMACertPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryMACertPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryMACertPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryMACertPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryMACertPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryMACertPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryMACertPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryMACertPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryMACertPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryMACertPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryMACertPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryMACertPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryMACertPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryMACertPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryMACertPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryMACertPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
