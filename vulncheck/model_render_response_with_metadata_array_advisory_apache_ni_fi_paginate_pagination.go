...
// checks if the RenderResponseWithMetadataArrayAdvisoryApacheNiFiPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryApacheNiFiPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryApacheNiFiPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryApacheNiFiPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryApacheNiFiPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryApacheNiFiPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryApacheNiFiPaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisoryApacheNiFi and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryApacheNiFiPaginatePagination) SetData(v []AdvisoryApacheNiFi) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryApacheNiFiPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryApacheNiFiPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryApacheNiFiPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryApacheNiFiPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryApacheNiFiPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryApacheNiFiPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryApacheNiFiPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryApacheNiFiPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryApacheNiFiPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryApacheNiFiPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryApacheNiFiPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryApacheNiFiPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryApacheNiFiPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryApacheNiFiPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryApacheNiFiPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryApacheNiFiPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
