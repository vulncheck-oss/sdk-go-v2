...
// checks if the AdvisoryMitel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AdvisoryMitel{}

// AdvisoryMitel struct for AdvisoryMitel
...
func (o *AdvisoryMitel) GetReferences() []string {
...
func (o AdvisoryMitel) MarshalJSON() ([]byte, error) {
...
func (o AdvisoryMitel) ToMap() (map[string]interface{}, error) {
...
type NullableAdvisoryMitel struct {
	value *AdvisoryMitel
	isSet bool
}

func (v NullableAdvisoryMitel) Get() *AdvisoryMitel {
	return v.value
}

func (v *NullableAdvisoryMitel) Set(val *AdvisoryMitel) {
	v.value = val
	v.isSet = true
}

func (v NullableAdvisoryMitel) IsSet() bool {
	return v.isSet
}

func (v *NullableAdvisoryMitel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAdvisoryMitel(val *AdvisoryMitel) *NullableAdvisoryMitel {
	return &NullableAdvisoryMitel{value: val, isSet: true}
}

func (v NullableAdvisoryMitel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAdvisoryMitel) UnmarshalJSON(src []byte) error {
	v.isSet = true
