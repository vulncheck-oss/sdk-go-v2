...
// checks if the AdvisoryOpenSSH type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AdvisoryOpenSSH{}

// AdvisoryOpenSSH struct for AdvisoryOpenSSH
...
func (o AdvisoryOpenSSH) MarshalJSON() ([]byte, error) {
...
func (o AdvisoryOpenSSH) ToMap() (map[string]interface{}, error) {
...
type NullableAdvisoryOpenSSH struct {
	value *AdvisoryOpenSSH
	isSet bool
}

func (v NullableAdvisoryOpenSSH) Get() *AdvisoryOpenSSH {
	return v.value
}

func (v *NullableAdvisoryOpenSSH) Set(val *AdvisoryOpenSSH) {
	v.value = val
	v.isSet = true
}

func (v NullableAdvisoryOpenSSH) IsSet() bool {
	return v.isSet
}

func (v *NullableAdvisoryOpenSSH) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAdvisoryOpenSSH(val *AdvisoryOpenSSH) *NullableAdvisoryOpenSSH {
	return &NullableAdvisoryOpenSSH{value: val, isSet: true}
}

func (v NullableAdvisoryOpenSSH) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAdvisoryOpenSSH) UnmarshalJSON(src []byte) error {
	v.isSet = true
