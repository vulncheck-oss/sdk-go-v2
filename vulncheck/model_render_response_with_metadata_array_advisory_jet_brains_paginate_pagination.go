...
// checks if the RenderResponseWithMetadataArrayAdvisoryJetBrainsPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryJetBrainsPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryJetBrainsPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryJetBrainsPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryJetBrainsPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryJetBrainsPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryJetBrainsPaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisoryJetBrains and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryJetBrainsPaginatePagination) SetData(v []AdvisoryJetBrains) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryJetBrainsPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryJetBrainsPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryJetBrainsPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryJetBrainsPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryJetBrainsPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryJetBrainsPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryJetBrainsPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryJetBrainsPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryJetBrainsPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryJetBrainsPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryJetBrainsPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryJetBrainsPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryJetBrainsPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryJetBrainsPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryJetBrainsPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryJetBrainsPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
