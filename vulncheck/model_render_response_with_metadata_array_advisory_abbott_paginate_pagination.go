...
// checks if the RenderResponseWithMetadataArrayAdvisoryAbbottPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryAbbottPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryAbbottPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryAbbottPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryAbbottPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryAbbottPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryAbbottPaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisoryAbbott and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryAbbottPaginatePagination) SetData(v []AdvisoryAbbott) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryAbbottPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryAbbottPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryAbbottPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryAbbottPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryAbbottPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryAbbottPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryAbbottPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryAbbottPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryAbbottPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryAbbottPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryAbbottPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryAbbottPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryAbbottPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryAbbottPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryAbbottPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryAbbottPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
