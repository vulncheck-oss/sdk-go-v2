...
// checks if the AdvisoryRsync type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AdvisoryRsync{}

// AdvisoryRsync struct for AdvisoryRsync
type AdvisoryRsync struct {
...
func (o AdvisoryRsync) MarshalJSON() ([]byte, error) {
...
func (o AdvisoryRsync) ToMap() (map[string]interface{}, error) {
...
type NullableAdvisoryRsync struct {
	value *AdvisoryRsync
	isSet bool
}

func (v NullableAdvisoryRsync) Get() *AdvisoryRsync {
	return v.value
}

func (v *NullableAdvisoryRsync) Set(val *AdvisoryRsync) {
	v.value = val
	v.isSet = true
}

func (v NullableAdvisoryRsync) IsSet() bool {
	return v.isSet
}

func (v *NullableAdvisoryRsync) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAdvisoryRsync(val *AdvisoryRsync) *NullableAdvisoryRsync {
	return &NullableAdvisoryRsync{value: val, isSet: true}
}

func (v NullableAdvisoryRsync) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAdvisoryRsync) UnmarshalJSON(src []byte) error {
	v.isSet = true
