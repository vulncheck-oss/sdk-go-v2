...
// checks if the RenderResponseWithMetadataArrayAdvisoryFastlyPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryFastlyPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryFastlyPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryFastlyPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryFastlyPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryFastlyPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryFastlyPaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisoryFastly and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryFastlyPaginatePagination) SetData(v []AdvisoryFastly) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryFastlyPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryFastlyPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryFastlyPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryFastlyPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryFastlyPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryFastlyPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryFastlyPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryFastlyPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryFastlyPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryFastlyPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryFastlyPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryFastlyPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryFastlyPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryFastlyPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryFastlyPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryFastlyPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
