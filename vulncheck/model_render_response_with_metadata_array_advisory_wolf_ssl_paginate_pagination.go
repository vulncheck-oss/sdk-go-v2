...
// checks if the RenderResponseWithMetadataArrayAdvisoryWolfSSLPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryWolfSSLPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryWolfSSLPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryWolfSSLPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryWolfSSLPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryWolfSSLPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryWolfSSLPaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisoryWolfSSL and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryWolfSSLPaginatePagination) SetData(v []AdvisoryWolfSSL) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryWolfSSLPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryWolfSSLPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryWolfSSLPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryWolfSSLPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryWolfSSLPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryWolfSSLPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryWolfSSLPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryWolfSSLPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryWolfSSLPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryWolfSSLPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryWolfSSLPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryWolfSSLPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryWolfSSLPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryWolfSSLPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryWolfSSLPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryWolfSSLPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
