...
// checks if the AdvisoryVLC type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AdvisoryVLC{}

// AdvisoryVLC struct for AdvisoryVLC
type AdvisoryVLC struct {
...
func (o AdvisoryVLC) MarshalJSON() ([]byte, error) {
...
func (o AdvisoryVLC) ToMap() (map[string]interface{}, error) {
...
type NullableAdvisoryVLC struct {
	value *AdvisoryVLC
	isSet bool
}

func (v NullableAdvisoryVLC) Get() *AdvisoryVLC {
	return v.value
}

func (v *NullableAdvisoryVLC) Set(val *AdvisoryVLC) {
	v.value = val
	v.isSet = true
}

func (v NullableAdvisoryVLC) IsSet() bool {
	return v.isSet
}

func (v *NullableAdvisoryVLC) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAdvisoryVLC(val *AdvisoryVLC) *NullableAdvisoryVLC {
	return &NullableAdvisoryVLC{value: val, isSet: true}
}

func (v NullableAdvisoryVLC) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAdvisoryVLC) UnmarshalJSON(src []byte) error {
	v.isSet = true
