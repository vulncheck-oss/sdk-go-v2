...
// checks if the RenderResponseWithMetadataArrayAdvisorySiemensAdvisoryPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisorySiemensAdvisoryPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisorySiemensAdvisoryPaginatePagination struct for RenderResponseWithMetadataArrayAdvisorySiemensAdvisoryPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisorySiemensAdvisoryPaginatePagination() *RenderResponseWithMetadataArrayAdvisorySiemensAdvisoryPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisorySiemensAdvisoryPaginatePagination{}
	return &this
}
...
func (o *RenderResponseWithMetadataArrayAdvisorySiemensAdvisoryPaginatePagination) GetData() []AdvisorySiemensAdvisory {
	if o == nil || IsNil(o.Data) {
		var ret []AdvisorySiemensAdvisory
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []AdvisorySiemensAdvisory and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisorySiemensAdvisoryPaginatePagination) SetData(v []AdvisorySiemensAdvisory) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisorySiemensAdvisoryPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisorySiemensAdvisoryPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisorySiemensAdvisoryPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisorySiemensAdvisoryPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisorySiemensAdvisoryPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisorySiemensAdvisoryPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisorySiemensAdvisoryPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisorySiemensAdvisoryPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisorySiemensAdvisoryPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisorySiemensAdvisoryPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisorySiemensAdvisoryPaginatePagination(val *RenderResponseWithMetadataArrayAdvisorySiemensAdvisoryPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisorySiemensAdvisoryPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisorySiemensAdvisoryPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisorySiemensAdvisoryPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisorySiemensAdvisoryPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
