...
// checks if the RenderResponseWithMetadataArrayAdvisoryApacheCouchDBPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryApacheCouchDBPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryApacheCouchDBPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryApacheCouchDBPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryApacheCouchDBPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryApacheCouchDBPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryApacheCouchDBPaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisoryApacheCouchDB and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryApacheCouchDBPaginatePagination) SetData(v []AdvisoryApacheCouchDB) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryApacheCouchDBPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryApacheCouchDBPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryApacheCouchDBPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryApacheCouchDBPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryApacheCouchDBPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryApacheCouchDBPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryApacheCouchDBPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryApacheCouchDBPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryApacheCouchDBPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryApacheCouchDBPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryApacheCouchDBPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryApacheCouchDBPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryApacheCouchDBPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryApacheCouchDBPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryApacheCouchDBPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryApacheCouchDBPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
