...
// checks if the RenderResponseWithMetadataArrayAdvisoryNozomiPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryNozomiPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryNozomiPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryNozomiPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryNozomiPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryNozomiPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryNozomiPaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisoryNozomi and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryNozomiPaginatePagination) SetData(v []AdvisoryNozomi) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryNozomiPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryNozomiPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryNozomiPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryNozomiPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryNozomiPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryNozomiPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryNozomiPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryNozomiPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryNozomiPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryNozomiPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryNozomiPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryNozomiPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryNozomiPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryNozomiPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryNozomiPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryNozomiPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
