...
// checks if the RenderResponseWithMetadataArrayAdvisoryAppleAdvisoryPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryAppleAdvisoryPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryAppleAdvisoryPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryAppleAdvisoryPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryAppleAdvisoryPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryAppleAdvisoryPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryAppleAdvisoryPaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisoryAppleAdvisory and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryAppleAdvisoryPaginatePagination) SetData(v []AdvisoryAppleAdvisory) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryAppleAdvisoryPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryAppleAdvisoryPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryAppleAdvisoryPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryAppleAdvisoryPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryAppleAdvisoryPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryAppleAdvisoryPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryAppleAdvisoryPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryAppleAdvisoryPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryAppleAdvisoryPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryAppleAdvisoryPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryAppleAdvisoryPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryAppleAdvisoryPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryAppleAdvisoryPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryAppleAdvisoryPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryAppleAdvisoryPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryAppleAdvisoryPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
