...
// checks if the RenderResponseWithMetadataArrayAdvisoryXeroxPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryXeroxPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryXeroxPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryXeroxPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryXeroxPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryXeroxPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryXeroxPaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisoryXerox and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryXeroxPaginatePagination) SetData(v []AdvisoryXerox) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryXeroxPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryXeroxPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryXeroxPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryXeroxPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryXeroxPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryXeroxPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryXeroxPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryXeroxPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryXeroxPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryXeroxPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryXeroxPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryXeroxPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryXeroxPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryXeroxPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryXeroxPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryXeroxPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
