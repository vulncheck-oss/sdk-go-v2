...
// checks if the RenderResponseWithMetadataArrayAdvisoryTPLinkPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryTPLinkPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryTPLinkPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryTPLinkPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryTPLinkPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryTPLinkPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryTPLinkPaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisoryTPLink and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryTPLinkPaginatePagination) SetData(v []AdvisoryTPLink) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryTPLinkPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryTPLinkPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryTPLinkPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryTPLinkPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryTPLinkPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryTPLinkPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryTPLinkPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryTPLinkPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryTPLinkPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryTPLinkPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryTPLinkPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryTPLinkPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryTPLinkPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryTPLinkPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryTPLinkPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryTPLinkPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
