...
// checks if the AdvisoryApachePulsar type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AdvisoryApachePulsar{}

// AdvisoryApachePulsar struct for AdvisoryApachePulsar
...
func (o AdvisoryApachePulsar) MarshalJSON() ([]byte, error) {
...
func (o AdvisoryApachePulsar) ToMap() (map[string]interface{}, error) {
...
type NullableAdvisoryApachePulsar struct {
	value *AdvisoryApachePulsar
	isSet bool
}

func (v NullableAdvisoryApachePulsar) Get() *AdvisoryApachePulsar {
	return v.value
}

func (v *NullableAdvisoryApachePulsar) Set(val *AdvisoryApachePulsar) {
	v.value = val
	v.isSet = true
}

func (v NullableAdvisoryApachePulsar) IsSet() bool {
	return v.isSet
}

func (v *NullableAdvisoryApachePulsar) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAdvisoryApachePulsar(val *AdvisoryApachePulsar) *NullableAdvisoryApachePulsar {
	return &NullableAdvisoryApachePulsar{value: val, isSet: true}
}

func (v NullableAdvisoryApachePulsar) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAdvisoryApachePulsar) UnmarshalJSON(src []byte) error {
	v.isSet = true
