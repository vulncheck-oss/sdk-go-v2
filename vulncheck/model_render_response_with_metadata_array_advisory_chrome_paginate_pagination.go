...
// checks if the RenderResponseWithMetadataArrayAdvisoryChromePaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryChromePaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryChromePaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryChromePaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryChromePaginatePagination() *RenderResponseWithMetadataArrayAdvisoryChromePaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryChromePaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisoryChrome and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryChromePaginatePagination) SetData(v []AdvisoryChrome) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryChromePaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryChromePaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryChromePaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryChromePaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryChromePaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryChromePaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryChromePaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryChromePaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryChromePaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryChromePaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryChromePaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryChromePaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryChromePaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryChromePaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryChromePaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryChromePaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
