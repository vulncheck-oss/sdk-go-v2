...
// checks if the AdvisoryApacheCommons type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AdvisoryApacheCommons{}

// AdvisoryApacheCommons struct for AdvisoryApacheCommons
...
func (o AdvisoryApacheCommons) MarshalJSON() ([]byte, error) {
...
func (o AdvisoryApacheCommons) ToMap() (map[string]interface{}, error) {
...
type NullableAdvisoryApacheCommons struct {
	value *AdvisoryApacheCommons
	isSet bool
}

func (v NullableAdvisoryApacheCommons) Get() *AdvisoryApacheCommons {
	return v.value
}

func (v *NullableAdvisoryApacheCommons) Set(val *AdvisoryApacheCommons) {
	v.value = val
	v.isSet = true
}

func (v NullableAdvisoryApacheCommons) IsSet() bool {
	return v.isSet
}

func (v *NullableAdvisoryApacheCommons) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAdvisoryApacheCommons(val *AdvisoryApacheCommons) *NullableAdvisoryApacheCommons {
	return &NullableAdvisoryApacheCommons{value: val, isSet: true}
}

func (v NullableAdvisoryApacheCommons) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAdvisoryApacheCommons) UnmarshalJSON(src []byte) error {
	v.isSet = true
