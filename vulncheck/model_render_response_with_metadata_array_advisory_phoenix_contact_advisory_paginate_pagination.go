...
func NewRenderResponseWithMetadataArrayAdvisoryPhoenixContactAdvisoryPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryPhoenixContactAdvisoryPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryPhoenixContactAdvisoryPaginatePagination{}
	return &this
}
...
func (o *RenderResponseWithMetadataArrayAdvisoryPhoenixContactAdvisoryPaginatePagination) GetData() []AdvisoryPhoenixContactAdvisory {
	if o == nil || IsNil(o.Data) {
		var ret []AdvisoryPhoenixContactAdvisory
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []AdvisoryPhoenixContactAdvisory and assigns it to the Data field.
...
func (o RenderResponseWithMetadataArrayAdvisoryPhoenixContactAdvisoryPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryPhoenixContactAdvisoryPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryPhoenixContactAdvisoryPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryPhoenixContactAdvisoryPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryPhoenixContactAdvisoryPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryPhoenixContactAdvisoryPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryPhoenixContactAdvisoryPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryPhoenixContactAdvisoryPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryPhoenixContactAdvisoryPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryPhoenixContactAdvisoryPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryPhoenixContactAdvisoryPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryPhoenixContactAdvisoryPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryPhoenixContactAdvisoryPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryPhoenixContactAdvisoryPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryPhoenixContactAdvisoryPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryPhoenixContactAdvisoryPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
