...
// checks if the RenderResponseWithMetadataArrayAdvisoryOpenJDKPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryOpenJDKPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryOpenJDKPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryOpenJDKPaginatePagination
type RenderResponseWithMetadataArrayAdvisoryOpenJDKPaginatePagination struct {
	Benchmark *float32 `json:"_benchmark,omitempty"`
	Meta *PaginatePagination `json:"_meta,omitempty"`
	Data []AdvisoryOpenJDK `json:"data,omitempty"`
}
...
func NewRenderResponseWithMetadataArrayAdvisoryOpenJDKPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryOpenJDKPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryOpenJDKPaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisoryOpenJDK and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryOpenJDKPaginatePagination) SetData(v []AdvisoryOpenJDK) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryOpenJDKPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryOpenJDKPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryOpenJDKPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryOpenJDKPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryOpenJDKPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryOpenJDKPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryOpenJDKPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryOpenJDKPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryOpenJDKPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryOpenJDKPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryOpenJDKPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryOpenJDKPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryOpenJDKPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryOpenJDKPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryOpenJDKPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryOpenJDKPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
