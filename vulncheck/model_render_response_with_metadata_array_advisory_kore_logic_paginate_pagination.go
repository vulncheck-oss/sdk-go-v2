...
// checks if the RenderResponseWithMetadataArrayAdvisoryKoreLogicPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryKoreLogicPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryKoreLogicPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryKoreLogicPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryKoreLogicPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryKoreLogicPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryKoreLogicPaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisoryKoreLogic and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryKoreLogicPaginatePagination) SetData(v []AdvisoryKoreLogic) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryKoreLogicPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryKoreLogicPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryKoreLogicPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryKoreLogicPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryKoreLogicPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryKoreLogicPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryKoreLogicPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryKoreLogicPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryKoreLogicPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryKoreLogicPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryKoreLogicPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryKoreLogicPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryKoreLogicPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryKoreLogicPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryKoreLogicPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryKoreLogicPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
