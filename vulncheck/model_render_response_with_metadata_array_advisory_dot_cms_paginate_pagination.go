...
// checks if the RenderResponseWithMetadataArrayAdvisoryDotCMSPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryDotCMSPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryDotCMSPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryDotCMSPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryDotCMSPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryDotCMSPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryDotCMSPaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisoryDotCMS and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryDotCMSPaginatePagination) SetData(v []AdvisoryDotCMS) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryDotCMSPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryDotCMSPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryDotCMSPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryDotCMSPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryDotCMSPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryDotCMSPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryDotCMSPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryDotCMSPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryDotCMSPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryDotCMSPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryDotCMSPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryDotCMSPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryDotCMSPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryDotCMSPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryDotCMSPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryDotCMSPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
