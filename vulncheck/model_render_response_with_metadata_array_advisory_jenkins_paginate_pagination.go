...
// checks if the RenderResponseWithMetadataArrayAdvisoryJenkinsPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryJenkinsPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryJenkinsPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryJenkinsPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryJenkinsPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryJenkinsPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryJenkinsPaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisoryJenkins and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryJenkinsPaginatePagination) SetData(v []AdvisoryJenkins) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryJenkinsPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryJenkinsPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryJenkinsPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryJenkinsPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryJenkinsPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryJenkinsPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryJenkinsPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryJenkinsPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryJenkinsPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryJenkinsPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryJenkinsPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryJenkinsPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryJenkinsPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryJenkinsPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryJenkinsPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryJenkinsPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
