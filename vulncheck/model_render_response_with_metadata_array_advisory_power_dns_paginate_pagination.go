...
// checks if the RenderResponseWithMetadataArrayAdvisoryPowerDNSPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryPowerDNSPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryPowerDNSPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryPowerDNSPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryPowerDNSPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryPowerDNSPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryPowerDNSPaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisoryPowerDNS and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryPowerDNSPaginatePagination) SetData(v []AdvisoryPowerDNS) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryPowerDNSPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryPowerDNSPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryPowerDNSPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryPowerDNSPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryPowerDNSPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryPowerDNSPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryPowerDNSPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryPowerDNSPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryPowerDNSPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryPowerDNSPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryPowerDNSPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryPowerDNSPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryPowerDNSPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryPowerDNSPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryPowerDNSPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryPowerDNSPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
