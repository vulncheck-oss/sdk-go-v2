...
// checks if the AdvisoryApacheOFBiz type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AdvisoryApacheOFBiz{}

// AdvisoryApacheOFBiz struct for AdvisoryApacheOFBiz
...
func (o AdvisoryApacheOFBiz) MarshalJSON() ([]byte, error) {
...
func (o AdvisoryApacheOFBiz) ToMap() (map[string]interface{}, error) {
...
type NullableAdvisoryApacheOFBiz struct {
	value *AdvisoryApacheOFBiz
	isSet bool
}

func (v NullableAdvisoryApacheOFBiz) Get() *AdvisoryApacheOFBiz {
	return v.value
}

func (v *NullableAdvisoryApacheOFBiz) Set(val *AdvisoryApacheOFBiz) {
	v.value = val
	v.isSet = true
}

func (v NullableAdvisoryApacheOFBiz) IsSet() bool {
	return v.isSet
}

func (v *NullableAdvisoryApacheOFBiz) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAdvisoryApacheOFBiz(val *AdvisoryApacheOFBiz) *NullableAdvisoryApacheOFBiz {
	return &NullableAdvisoryApacheOFBiz{value: val, isSet: true}
}

func (v NullableAdvisoryApacheOFBiz) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAdvisoryApacheOFBiz) UnmarshalJSON(src []byte) error {
	v.isSet = true
