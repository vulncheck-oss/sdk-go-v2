...
// checks if the RenderResponseWithMetadataArrayAdvisorySambaPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisorySambaPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisorySambaPaginatePagination struct for RenderResponseWithMetadataArrayAdvisorySambaPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisorySambaPaginatePagination() *RenderResponseWithMetadataArrayAdvisorySambaPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisorySambaPaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisorySamba and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisorySambaPaginatePagination) SetData(v []AdvisorySamba) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisorySambaPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisorySambaPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisorySambaPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisorySambaPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisorySambaPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisorySambaPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisorySambaPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisorySambaPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisorySambaPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisorySambaPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisorySambaPaginatePagination(val *RenderResponseWithMetadataArrayAdvisorySambaPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisorySambaPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisorySambaPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisorySambaPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisorySambaPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
