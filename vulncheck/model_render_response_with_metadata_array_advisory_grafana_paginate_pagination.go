...
// checks if the RenderResponseWithMetadataArrayAdvisoryGrafanaPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryGrafanaPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryGrafanaPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryGrafanaPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryGrafanaPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryGrafanaPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryGrafanaPaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisoryGrafana and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryGrafanaPaginatePagination) SetData(v []AdvisoryGrafana) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryGrafanaPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryGrafanaPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryGrafanaPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryGrafanaPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryGrafanaPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryGrafanaPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryGrafanaPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryGrafanaPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryGrafanaPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryGrafanaPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryGrafanaPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryGrafanaPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryGrafanaPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryGrafanaPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryGrafanaPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryGrafanaPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
