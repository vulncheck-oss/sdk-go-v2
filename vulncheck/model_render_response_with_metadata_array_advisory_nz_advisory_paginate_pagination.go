...
// checks if the RenderResponseWithMetadataArrayAdvisoryNZAdvisoryPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryNZAdvisoryPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryNZAdvisoryPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryNZAdvisoryPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryNZAdvisoryPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryNZAdvisoryPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryNZAdvisoryPaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisoryNZAdvisory and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryNZAdvisoryPaginatePagination) SetData(v []AdvisoryNZAdvisory) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryNZAdvisoryPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryNZAdvisoryPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryNZAdvisoryPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryNZAdvisoryPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryNZAdvisoryPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryNZAdvisoryPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryNZAdvisoryPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryNZAdvisoryPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryNZAdvisoryPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryNZAdvisoryPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryNZAdvisoryPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryNZAdvisoryPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryNZAdvisoryPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryNZAdvisoryPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryNZAdvisoryPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryNZAdvisoryPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
