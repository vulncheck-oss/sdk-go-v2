...
// checks if the AdvisoryXerox type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AdvisoryXerox{}

// AdvisoryXerox struct for AdvisoryXerox
...
func (o AdvisoryXerox) MarshalJSON() ([]byte, error) {
...
func (o AdvisoryXerox) ToMap() (map[string]interface{}, error) {
...
type NullableAdvisoryXerox struct {
	value *AdvisoryXerox
	isSet bool
}

func (v NullableAdvisoryXerox) Get() *AdvisoryXerox {
	return v.value
}

func (v *NullableAdvisoryXerox) Set(val *AdvisoryXerox) {
	v.value = val
	v.isSet = true
}

func (v NullableAdvisoryXerox) IsSet() bool {
	return v.isSet
}

func (v *NullableAdvisoryXerox) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAdvisoryXerox(val *AdvisoryXerox) *NullableAdvisoryXerox {
	return &NullableAdvisoryXerox{value: val, isSet: true}
}

func (v NullableAdvisoryXerox) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAdvisoryXerox) UnmarshalJSON(src []byte) error {
	v.isSet = true
