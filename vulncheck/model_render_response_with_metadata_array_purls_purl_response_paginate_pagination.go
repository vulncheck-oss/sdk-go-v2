...
// checks if the RenderResponseWithMetadataArrayPurlsPurlResponsePaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayPurlsPurlResponsePaginatePagination{}

// RenderResponseWithMetadataArrayPurlsPurlResponsePaginatePagination struct for RenderResponseWithMetadataArrayPurlsPurlResponsePaginatePagination
type RenderResponseWithMetadataArrayPurlsPurlResponsePaginatePagination struct {
...
func NewRenderResponseWithMetadataArrayPurlsPurlResponsePaginatePagination() *RenderResponseWithMetadataArrayPurlsPurlResponsePaginatePagination {
	this := RenderResponseWithMetadataArrayPurlsPurlResponsePaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []PurlsPurlResponse and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayPurlsPurlResponsePaginatePagination) SetData(v []PurlsPurlResponse) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayPurlsPurlResponsePaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayPurlsPurlResponsePaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayPurlsPurlResponsePaginatePagination struct {
	value *RenderResponseWithMetadataArrayPurlsPurlResponsePaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayPurlsPurlResponsePaginatePagination) Get() *RenderResponseWithMetadataArrayPurlsPurlResponsePaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayPurlsPurlResponsePaginatePagination) Set(val *RenderResponseWithMetadataArrayPurlsPurlResponsePaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayPurlsPurlResponsePaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayPurlsPurlResponsePaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayPurlsPurlResponsePaginatePagination(val *RenderResponseWithMetadataArrayPurlsPurlResponsePaginatePagination) *NullableRenderResponseWithMetadataArrayPurlsPurlResponsePaginatePagination {
	return &NullableRenderResponseWithMetadataArrayPurlsPurlResponsePaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayPurlsPurlResponsePaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayPurlsPurlResponsePaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
