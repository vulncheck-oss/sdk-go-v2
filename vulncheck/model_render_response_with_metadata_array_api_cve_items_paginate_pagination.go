...
// checks if the RenderResponseWithMetadataArrayApiCveItemsPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayApiCveItemsPaginatePagination{}

// RenderResponseWithMetadataArrayApiCveItemsPaginatePagination struct for RenderResponseWithMetadataArrayApiCveItemsPaginatePagination
...
func NewRenderResponseWithMetadataArrayApiCveItemsPaginatePagination() *RenderResponseWithMetadataArrayApiCveItemsPaginatePagination {
	this := RenderResponseWithMetadataArrayApiCveItemsPaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []ApiCveItems and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayApiCveItemsPaginatePagination) SetData(v []ApiCveItems) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayApiCveItemsPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayApiCveItemsPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayApiCveItemsPaginatePagination struct {
	value *RenderResponseWithMetadataArrayApiCveItemsPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayApiCveItemsPaginatePagination) Get() *RenderResponseWithMetadataArrayApiCveItemsPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayApiCveItemsPaginatePagination) Set(val *RenderResponseWithMetadataArrayApiCveItemsPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayApiCveItemsPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayApiCveItemsPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayApiCveItemsPaginatePagination(val *RenderResponseWithMetadataArrayApiCveItemsPaginatePagination) *NullableRenderResponseWithMetadataArrayApiCveItemsPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayApiCveItemsPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayApiCveItemsPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayApiCveItemsPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
