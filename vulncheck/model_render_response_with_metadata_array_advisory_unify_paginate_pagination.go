...
// checks if the RenderResponseWithMetadataArrayAdvisoryUnifyPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryUnifyPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryUnifyPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryUnifyPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryUnifyPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryUnifyPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryUnifyPaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisoryUnify and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryUnifyPaginatePagination) SetData(v []AdvisoryUnify) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryUnifyPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryUnifyPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryUnifyPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryUnifyPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryUnifyPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryUnifyPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryUnifyPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryUnifyPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryUnifyPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryUnifyPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryUnifyPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryUnifyPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryUnifyPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryUnifyPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryUnifyPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryUnifyPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
