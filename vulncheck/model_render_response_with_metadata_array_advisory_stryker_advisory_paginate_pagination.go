...
// checks if the RenderResponseWithMetadataArrayAdvisoryStrykerAdvisoryPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryStrykerAdvisoryPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryStrykerAdvisoryPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryStrykerAdvisoryPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryStrykerAdvisoryPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryStrykerAdvisoryPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryStrykerAdvisoryPaginatePagination{}
	return &this
}
...
func (o *RenderResponseWithMetadataArrayAdvisoryStrykerAdvisoryPaginatePagination) GetData() []AdvisoryStrykerAdvisory {
	if o == nil || IsNil(o.Data) {
		var ret []AdvisoryStrykerAdvisory
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []AdvisoryStrykerAdvisory and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryStrykerAdvisoryPaginatePagination) SetData(v []AdvisoryStrykerAdvisory) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryStrykerAdvisoryPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryStrykerAdvisoryPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryStrykerAdvisoryPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryStrykerAdvisoryPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryStrykerAdvisoryPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryStrykerAdvisoryPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryStrykerAdvisoryPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryStrykerAdvisoryPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryStrykerAdvisoryPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryStrykerAdvisoryPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryStrykerAdvisoryPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryStrykerAdvisoryPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryStrykerAdvisoryPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryStrykerAdvisoryPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryStrykerAdvisoryPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryStrykerAdvisoryPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
