...
// checks if the RenderResponseWithMetadataArrayAdvisoryApacheOpenMeetingsPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryApacheOpenMeetingsPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryApacheOpenMeetingsPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryApacheOpenMeetingsPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryApacheOpenMeetingsPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryApacheOpenMeetingsPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryApacheOpenMeetingsPaginatePagination{}
	return &this
}
...
func (o *RenderResponseWithMetadataArrayAdvisoryApacheOpenMeetingsPaginatePagination) GetData() []AdvisoryApacheOpenMeetings {
	if o == nil || IsNil(o.Data) {
		var ret []AdvisoryApacheOpenMeetings
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []AdvisoryApacheOpenMeetings and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryApacheOpenMeetingsPaginatePagination) SetData(v []AdvisoryApacheOpenMeetings) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryApacheOpenMeetingsPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryApacheOpenMeetingsPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryApacheOpenMeetingsPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryApacheOpenMeetingsPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryApacheOpenMeetingsPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryApacheOpenMeetingsPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryApacheOpenMeetingsPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryApacheOpenMeetingsPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryApacheOpenMeetingsPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryApacheOpenMeetingsPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryApacheOpenMeetingsPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryApacheOpenMeetingsPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryApacheOpenMeetingsPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryApacheOpenMeetingsPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryApacheOpenMeetingsPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryApacheOpenMeetingsPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
