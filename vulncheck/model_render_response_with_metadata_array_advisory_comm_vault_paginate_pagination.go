...
// checks if the RenderResponseWithMetadataArrayAdvisoryCommVaultPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryCommVaultPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryCommVaultPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryCommVaultPaginatePagination
type RenderResponseWithMetadataArrayAdvisoryCommVaultPaginatePagination struct {
	Benchmark *float32 `json:"_benchmark,omitempty"`
	Meta *PaginatePagination `json:"_meta,omitempty"`
	Data []AdvisoryCommVault `json:"data,omitempty"`
}
...
func NewRenderResponseWithMetadataArrayAdvisoryCommVaultPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryCommVaultPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryCommVaultPaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisoryCommVault and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryCommVaultPaginatePagination) SetData(v []AdvisoryCommVault) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryCommVaultPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryCommVaultPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryCommVaultPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryCommVaultPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryCommVaultPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryCommVaultPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryCommVaultPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryCommVaultPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryCommVaultPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryCommVaultPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryCommVaultPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryCommVaultPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryCommVaultPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryCommVaultPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryCommVaultPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryCommVaultPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
