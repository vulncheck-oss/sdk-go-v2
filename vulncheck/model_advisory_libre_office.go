...
// checks if the AdvisoryLibreOffice type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AdvisoryLibreOffice{}

// AdvisoryLibreOffice struct for AdvisoryLibreOffice
...
func (o AdvisoryLibreOffice) MarshalJSON() ([]byte, error) {
...
func (o AdvisoryLibreOffice) ToMap() (map[string]interface{}, error) {
...
type NullableAdvisoryLibreOffice struct {
	value *AdvisoryLibreOffice
	isSet bool
}

func (v NullableAdvisoryLibreOffice) Get() *AdvisoryLibreOffice {
	return v.value
}

func (v *NullableAdvisoryLibreOffice) Set(val *AdvisoryLibreOffice) {
	v.value = val
	v.isSet = true
}

func (v NullableAdvisoryLibreOffice) IsSet() bool {
	return v.isSet
}

func (v *NullableAdvisoryLibreOffice) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAdvisoryLibreOffice(val *AdvisoryLibreOffice) *NullableAdvisoryLibreOffice {
	return &NullableAdvisoryLibreOffice{value: val, isSet: true}
}

func (v NullableAdvisoryLibreOffice) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAdvisoryLibreOffice) UnmarshalJSON(src []byte) error {
	v.isSet = true
