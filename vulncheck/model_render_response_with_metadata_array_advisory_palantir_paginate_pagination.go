...
// checks if the RenderResponseWithMetadataArrayAdvisoryPalantirPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryPalantirPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryPalantirPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryPalantirPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryPalantirPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryPalantirPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryPalantirPaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisoryPalantir and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryPalantirPaginatePagination) SetData(v []AdvisoryPalantir) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryPalantirPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryPalantirPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryPalantirPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryPalantirPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryPalantirPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryPalantirPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryPalantirPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryPalantirPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryPalantirPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryPalantirPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryPalantirPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryPalantirPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryPalantirPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryPalantirPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryPalantirPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryPalantirPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
