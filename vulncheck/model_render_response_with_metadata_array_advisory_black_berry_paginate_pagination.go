...
// checks if the RenderResponseWithMetadataArrayAdvisoryBlackBerryPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryBlackBerryPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryBlackBerryPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryBlackBerryPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryBlackBerryPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryBlackBerryPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryBlackBerryPaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisoryBlackBerry and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryBlackBerryPaginatePagination) SetData(v []AdvisoryBlackBerry) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryBlackBerryPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryBlackBerryPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryBlackBerryPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryBlackBerryPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryBlackBerryPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryBlackBerryPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryBlackBerryPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryBlackBerryPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryBlackBerryPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryBlackBerryPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryBlackBerryPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryBlackBerryPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryBlackBerryPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryBlackBerryPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryBlackBerryPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryBlackBerryPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
