...
// checks if the RenderResponseWithMetadataArrayAdvisoryZoomPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryZoomPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryZoomPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryZoomPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryZoomPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryZoomPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryZoomPaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisoryZoom and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryZoomPaginatePagination) SetData(v []AdvisoryZoom) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryZoomPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryZoomPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryZoomPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryZoomPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryZoomPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryZoomPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryZoomPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryZoomPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryZoomPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryZoomPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryZoomPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryZoomPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryZoomPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryZoomPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryZoomPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryZoomPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
