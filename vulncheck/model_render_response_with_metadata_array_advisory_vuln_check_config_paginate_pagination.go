...
// checks if the RenderResponseWithMetadataArrayAdvisoryVulnCheckConfigPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryVulnCheckConfigPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryVulnCheckConfigPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryVulnCheckConfigPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryVulnCheckConfigPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryVulnCheckConfigPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryVulnCheckConfigPaginatePagination{}
	return &this
}
...
func (o *RenderResponseWithMetadataArrayAdvisoryVulnCheckConfigPaginatePagination) GetData() []AdvisoryVulnCheckConfig {
	if o == nil || IsNil(o.Data) {
		var ret []AdvisoryVulnCheckConfig
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []AdvisoryVulnCheckConfig and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryVulnCheckConfigPaginatePagination) SetData(v []AdvisoryVulnCheckConfig) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryVulnCheckConfigPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryVulnCheckConfigPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryVulnCheckConfigPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryVulnCheckConfigPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryVulnCheckConfigPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryVulnCheckConfigPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryVulnCheckConfigPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryVulnCheckConfigPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryVulnCheckConfigPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryVulnCheckConfigPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryVulnCheckConfigPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryVulnCheckConfigPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryVulnCheckConfigPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryVulnCheckConfigPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryVulnCheckConfigPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryVulnCheckConfigPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
