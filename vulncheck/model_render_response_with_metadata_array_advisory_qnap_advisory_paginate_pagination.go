...
// checks if the RenderResponseWithMetadataArrayAdvisoryQNAPAdvisoryPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryQNAPAdvisoryPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryQNAPAdvisoryPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryQNAPAdvisoryPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryQNAPAdvisoryPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryQNAPAdvisoryPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryQNAPAdvisoryPaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisoryQNAPAdvisory and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryQNAPAdvisoryPaginatePagination) SetData(v []AdvisoryQNAPAdvisory) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryQNAPAdvisoryPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryQNAPAdvisoryPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryQNAPAdvisoryPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryQNAPAdvisoryPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryQNAPAdvisoryPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryQNAPAdvisoryPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryQNAPAdvisoryPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryQNAPAdvisoryPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryQNAPAdvisoryPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryQNAPAdvisoryPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryQNAPAdvisoryPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryQNAPAdvisoryPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryQNAPAdvisoryPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryQNAPAdvisoryPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryQNAPAdvisoryPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryQNAPAdvisoryPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
