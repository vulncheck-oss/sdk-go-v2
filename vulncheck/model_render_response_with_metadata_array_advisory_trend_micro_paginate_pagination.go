...
// checks if the RenderResponseWithMetadataArrayAdvisoryTrendMicroPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryTrendMicroPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryTrendMicroPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryTrendMicroPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryTrendMicroPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryTrendMicroPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryTrendMicroPaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisoryTrendMicro and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryTrendMicroPaginatePagination) SetData(v []AdvisoryTrendMicro) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryTrendMicroPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryTrendMicroPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryTrendMicroPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryTrendMicroPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryTrendMicroPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryTrendMicroPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryTrendMicroPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryTrendMicroPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryTrendMicroPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryTrendMicroPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryTrendMicroPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryTrendMicroPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryTrendMicroPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryTrendMicroPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryTrendMicroPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryTrendMicroPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
