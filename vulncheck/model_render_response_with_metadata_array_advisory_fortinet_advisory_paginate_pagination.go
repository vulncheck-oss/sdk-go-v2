...
// checks if the RenderResponseWithMetadataArrayAdvisoryFortinetAdvisoryPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryFortinetAdvisoryPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryFortinetAdvisoryPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryFortinetAdvisoryPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryFortinetAdvisoryPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryFortinetAdvisoryPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryFortinetAdvisoryPaginatePagination{}
	return &this
}
...
func (o *RenderResponseWithMetadataArrayAdvisoryFortinetAdvisoryPaginatePagination) GetData() []AdvisoryFortinetAdvisory {
	if o == nil || IsNil(o.Data) {
		var ret []AdvisoryFortinetAdvisory
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []AdvisoryFortinetAdvisory and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryFortinetAdvisoryPaginatePagination) SetData(v []AdvisoryFortinetAdvisory) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryFortinetAdvisoryPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryFortinetAdvisoryPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryFortinetAdvisoryPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryFortinetAdvisoryPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryFortinetAdvisoryPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryFortinetAdvisoryPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryFortinetAdvisoryPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryFortinetAdvisoryPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryFortinetAdvisoryPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryFortinetAdvisoryPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryFortinetAdvisoryPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryFortinetAdvisoryPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryFortinetAdvisoryPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryFortinetAdvisoryPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryFortinetAdvisoryPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryFortinetAdvisoryPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
