...
// checks if the RenderResponseWithMetadataArrayAdvisoryAvigilonPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryAvigilonPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryAvigilonPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryAvigilonPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryAvigilonPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryAvigilonPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryAvigilonPaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisoryAvigilon and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryAvigilonPaginatePagination) SetData(v []AdvisoryAvigilon) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryAvigilonPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryAvigilonPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryAvigilonPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryAvigilonPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryAvigilonPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryAvigilonPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryAvigilonPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryAvigilonPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryAvigilonPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryAvigilonPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryAvigilonPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryAvigilonPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryAvigilonPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryAvigilonPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryAvigilonPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryAvigilonPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
