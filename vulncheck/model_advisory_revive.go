...
// checks if the AdvisoryRevive type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AdvisoryRevive{}

// AdvisoryRevive struct for AdvisoryRevive
...
// and a boolean to check if the value has been set.
func (o *AdvisoryRevive) GetReferencesOk() ([]string, bool) {
	if o == nil || IsNil(o.References) {
		return nil, false
	}
...
func (o *AdvisoryRevive) SetTitle(v string) {
	o.Title = &v
}
...
func (o AdvisoryRevive) MarshalJSON() ([]byte, error) {
...
func (o AdvisoryRevive) ToMap() (map[string]interface{}, error) {
...
type NullableAdvisoryRevive struct {
	value *AdvisoryRevive
	isSet bool
}

func (v NullableAdvisoryRevive) Get() *AdvisoryRevive {
	return v.value
}

func (v *NullableAdvisoryRevive) Set(val *AdvisoryRevive) {
	v.value = val
	v.isSet = true
}

func (v NullableAdvisoryRevive) IsSet() bool {
	return v.isSet
}

func (v *NullableAdvisoryRevive) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAdvisoryRevive(val *AdvisoryRevive) *NullableAdvisoryRevive {
	return &NullableAdvisoryRevive{value: val, isSet: true}
}

func (v NullableAdvisoryRevive) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAdvisoryRevive) UnmarshalJSON(src []byte) error {
	v.isSet = true
