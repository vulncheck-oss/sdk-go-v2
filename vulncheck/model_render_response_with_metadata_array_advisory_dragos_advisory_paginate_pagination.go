...
// checks if the RenderResponseWithMetadataArrayAdvisoryDragosAdvisoryPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryDragosAdvisoryPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryDragosAdvisoryPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryDragosAdvisoryPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryDragosAdvisoryPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryDragosAdvisoryPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryDragosAdvisoryPaginatePagination{}
	return &this
}
...
func (o *RenderResponseWithMetadataArrayAdvisoryDragosAdvisoryPaginatePagination) GetData() []AdvisoryDragosAdvisory {
	if o == nil || IsNil(o.Data) {
		var ret []AdvisoryDragosAdvisory
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []AdvisoryDragosAdvisory and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryDragosAdvisoryPaginatePagination) SetData(v []AdvisoryDragosAdvisory) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryDragosAdvisoryPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryDragosAdvisoryPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryDragosAdvisoryPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryDragosAdvisoryPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryDragosAdvisoryPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryDragosAdvisoryPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryDragosAdvisoryPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryDragosAdvisoryPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryDragosAdvisoryPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryDragosAdvisoryPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryDragosAdvisoryPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryDragosAdvisoryPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryDragosAdvisoryPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryDragosAdvisoryPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryDragosAdvisoryPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryDragosAdvisoryPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
