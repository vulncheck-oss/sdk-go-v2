...
// checks if the AdvisoryApacheLoggingServices type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AdvisoryApacheLoggingServices{}

// AdvisoryApacheLoggingServices struct for AdvisoryApacheLoggingServices
...
func NewAdvisoryApacheLoggingServices() *AdvisoryApacheLoggingServices {
	this := AdvisoryApacheLoggingServices{}
	return &this
}
...
func (o AdvisoryApacheLoggingServices) MarshalJSON() ([]byte, error) {
...
func (o AdvisoryApacheLoggingServices) ToMap() (map[string]interface{}, error) {
...
type NullableAdvisoryApacheLoggingServices struct {
	value *AdvisoryApacheLoggingServices
	isSet bool
}

func (v NullableAdvisoryApacheLoggingServices) Get() *AdvisoryApacheLoggingServices {
	return v.value
}

func (v *NullableAdvisoryApacheLoggingServices) Set(val *AdvisoryApacheLoggingServices) {
	v.value = val
	v.isSet = true
}

func (v NullableAdvisoryApacheLoggingServices) IsSet() bool {
	return v.isSet
}

func (v *NullableAdvisoryApacheLoggingServices) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAdvisoryApacheLoggingServices(val *AdvisoryApacheLoggingServices) *NullableAdvisoryApacheLoggingServices {
	return &NullableAdvisoryApacheLoggingServices{value: val, isSet: true}
}

func (v NullableAdvisoryApacheLoggingServices) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAdvisoryApacheLoggingServices) UnmarshalJSON(src []byte) error {
	v.isSet = true
