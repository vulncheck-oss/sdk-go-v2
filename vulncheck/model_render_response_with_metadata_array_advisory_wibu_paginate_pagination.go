...
// checks if the RenderResponseWithMetadataArrayAdvisoryWibuPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryWibuPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryWibuPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryWibuPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryWibuPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryWibuPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryWibuPaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisoryWibu and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryWibuPaginatePagination) SetData(v []AdvisoryWibu) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryWibuPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryWibuPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryWibuPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryWibuPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryWibuPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryWibuPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryWibuPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryWibuPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryWibuPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryWibuPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryWibuPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryWibuPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryWibuPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryWibuPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryWibuPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryWibuPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
