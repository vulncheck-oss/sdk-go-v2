...
// checks if the RenderResponseWithMetadataArrayAdvisorySolrPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisorySolrPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisorySolrPaginatePagination struct for RenderResponseWithMetadataArrayAdvisorySolrPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisorySolrPaginatePagination() *RenderResponseWithMetadataArrayAdvisorySolrPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisorySolrPaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisorySolr and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisorySolrPaginatePagination) SetData(v []AdvisorySolr) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisorySolrPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisorySolrPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisorySolrPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisorySolrPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisorySolrPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisorySolrPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisorySolrPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisorySolrPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisorySolrPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisorySolrPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisorySolrPaginatePagination(val *RenderResponseWithMetadataArrayAdvisorySolrPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisorySolrPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisorySolrPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisorySolrPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisorySolrPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
