...
// checks if the AdvisoryReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AdvisoryReference{}

// AdvisoryReference struct for AdvisoryReference
...
func (o AdvisoryReference) MarshalJSON() ([]byte, error) {
...
func (o AdvisoryReference) ToMap() (map[string]interface{}, error) {
...
type NullableAdvisoryReference struct {
	value *AdvisoryReference
	isSet bool
}

func (v NullableAdvisoryReference) Get() *AdvisoryReference {
	return v.value
}

func (v *NullableAdvisoryReference) Set(val *AdvisoryReference) {
	v.value = val
	v.isSet = true
}

func (v NullableAdvisoryReference) IsSet() bool {
	return v.isSet
}

func (v *NullableAdvisoryReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAdvisoryReference(val *AdvisoryReference) *NullableAdvisoryReference {
	return &NullableAdvisoryReference{value: val, isSet: true}
}

func (v NullableAdvisoryReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAdvisoryReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
