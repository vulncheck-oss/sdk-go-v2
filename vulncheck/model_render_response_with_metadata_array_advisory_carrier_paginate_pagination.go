...
// checks if the RenderResponseWithMetadataArrayAdvisoryCarrierPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryCarrierPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryCarrierPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryCarrierPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryCarrierPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryCarrierPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryCarrierPaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisoryCarrier and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryCarrierPaginatePagination) SetData(v []AdvisoryCarrier) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryCarrierPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryCarrierPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryCarrierPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryCarrierPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryCarrierPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryCarrierPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryCarrierPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryCarrierPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryCarrierPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryCarrierPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryCarrierPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryCarrierPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryCarrierPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryCarrierPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryCarrierPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryCarrierPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
