...
// checks if the RenderResponseWithMetadataArrayAdvisoryAutodeskPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryAutodeskPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryAutodeskPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryAutodeskPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryAutodeskPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryAutodeskPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryAutodeskPaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisoryAutodesk and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryAutodeskPaginatePagination) SetData(v []AdvisoryAutodesk) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryAutodeskPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryAutodeskPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryAutodeskPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryAutodeskPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryAutodeskPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryAutodeskPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryAutodeskPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryAutodeskPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryAutodeskPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryAutodeskPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryAutodeskPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryAutodeskPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryAutodeskPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryAutodeskPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryAutodeskPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryAutodeskPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
