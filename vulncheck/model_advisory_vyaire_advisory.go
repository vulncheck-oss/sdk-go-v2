...
// checks if the AdvisoryVYAIREAdvisory type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AdvisoryVYAIREAdvisory{}

// AdvisoryVYAIREAdvisory struct for AdvisoryVYAIREAdvisory
...
func (o AdvisoryVYAIREAdvisory) MarshalJSON() ([]byte, error) {
...
func (o AdvisoryVYAIREAdvisory) ToMap() (map[string]interface{}, error) {
...
type NullableAdvisoryVYAIREAdvisory struct {
	value *AdvisoryVYAIREAdvisory
	isSet bool
}

func (v NullableAdvisoryVYAIREAdvisory) Get() *AdvisoryVYAIREAdvisory {
	return v.value
}

func (v *NullableAdvisoryVYAIREAdvisory) Set(val *AdvisoryVYAIREAdvisory) {
	v.value = val
	v.isSet = true
}

func (v NullableAdvisoryVYAIREAdvisory) IsSet() bool {
	return v.isSet
}

func (v *NullableAdvisoryVYAIREAdvisory) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAdvisoryVYAIREAdvisory(val *AdvisoryVYAIREAdvisory) *NullableAdvisoryVYAIREAdvisory {
	return &NullableAdvisoryVYAIREAdvisory{value: val, isSet: true}
}

func (v NullableAdvisoryVYAIREAdvisory) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAdvisoryVYAIREAdvisory) UnmarshalJSON(src []byte) error {
	v.isSet = true
