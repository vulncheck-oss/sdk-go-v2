...
// checks if the RenderResponseWithMetadataArrayAdvisoryApacheKafkaPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryApacheKafkaPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryApacheKafkaPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryApacheKafkaPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryApacheKafkaPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryApacheKafkaPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryApacheKafkaPaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisoryApacheKafka and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryApacheKafkaPaginatePagination) SetData(v []AdvisoryApacheKafka) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryApacheKafkaPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryApacheKafkaPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryApacheKafkaPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryApacheKafkaPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryApacheKafkaPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryApacheKafkaPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryApacheKafkaPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryApacheKafkaPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryApacheKafkaPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryApacheKafkaPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryApacheKafkaPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryApacheKafkaPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryApacheKafkaPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryApacheKafkaPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryApacheKafkaPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryApacheKafkaPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
