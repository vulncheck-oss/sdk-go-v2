...
// checks if the RenderResponseWithMetadataArrayAdvisoryPanasonicPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryPanasonicPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryPanasonicPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryPanasonicPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryPanasonicPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryPanasonicPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryPanasonicPaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisoryPanasonic and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryPanasonicPaginatePagination) SetData(v []AdvisoryPanasonic) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryPanasonicPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryPanasonicPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryPanasonicPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryPanasonicPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryPanasonicPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryPanasonicPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryPanasonicPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryPanasonicPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryPanasonicPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryPanasonicPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryPanasonicPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryPanasonicPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryPanasonicPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryPanasonicPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryPanasonicPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryPanasonicPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
