...
// checks if the RenderResponseWithMetadataArrayAdvisoryAndroidAdvisoryPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryAndroidAdvisoryPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryAndroidAdvisoryPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryAndroidAdvisoryPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryAndroidAdvisoryPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryAndroidAdvisoryPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryAndroidAdvisoryPaginatePagination{}
	return &this
}
...
func (o *RenderResponseWithMetadataArrayAdvisoryAndroidAdvisoryPaginatePagination) GetData() []AdvisoryAndroidAdvisory {
	if o == nil || IsNil(o.Data) {
		var ret []AdvisoryAndroidAdvisory
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []AdvisoryAndroidAdvisory and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryAndroidAdvisoryPaginatePagination) SetData(v []AdvisoryAndroidAdvisory) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryAndroidAdvisoryPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryAndroidAdvisoryPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryAndroidAdvisoryPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryAndroidAdvisoryPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryAndroidAdvisoryPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryAndroidAdvisoryPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryAndroidAdvisoryPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryAndroidAdvisoryPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryAndroidAdvisoryPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryAndroidAdvisoryPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryAndroidAdvisoryPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryAndroidAdvisoryPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryAndroidAdvisoryPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryAndroidAdvisoryPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryAndroidAdvisoryPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryAndroidAdvisoryPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
