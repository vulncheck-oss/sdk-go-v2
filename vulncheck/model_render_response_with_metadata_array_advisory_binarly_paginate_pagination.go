...
// checks if the RenderResponseWithMetadataArrayAdvisoryBinarlyPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryBinarlyPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryBinarlyPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryBinarlyPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryBinarlyPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryBinarlyPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryBinarlyPaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisoryBinarly and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryBinarlyPaginatePagination) SetData(v []AdvisoryBinarly) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryBinarlyPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryBinarlyPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryBinarlyPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryBinarlyPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryBinarlyPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryBinarlyPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryBinarlyPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryBinarlyPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryBinarlyPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryBinarlyPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryBinarlyPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryBinarlyPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryBinarlyPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryBinarlyPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryBinarlyPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryBinarlyPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
