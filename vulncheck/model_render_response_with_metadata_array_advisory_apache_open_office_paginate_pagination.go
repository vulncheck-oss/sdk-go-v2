...
// checks if the RenderResponseWithMetadataArrayAdvisoryApacheOpenOfficePaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryApacheOpenOfficePaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryApacheOpenOfficePaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryApacheOpenOfficePaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryApacheOpenOfficePaginatePagination() *RenderResponseWithMetadataArrayAdvisoryApacheOpenOfficePaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryApacheOpenOfficePaginatePagination{}
	return &this
}
...
func (o *RenderResponseWithMetadataArrayAdvisoryApacheOpenOfficePaginatePagination) GetData() []AdvisoryApacheOpenOffice {
	if o == nil || IsNil(o.Data) {
		var ret []AdvisoryApacheOpenOffice
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []AdvisoryApacheOpenOffice and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryApacheOpenOfficePaginatePagination) SetData(v []AdvisoryApacheOpenOffice) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryApacheOpenOfficePaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryApacheOpenOfficePaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryApacheOpenOfficePaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryApacheOpenOfficePaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryApacheOpenOfficePaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryApacheOpenOfficePaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryApacheOpenOfficePaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryApacheOpenOfficePaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryApacheOpenOfficePaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryApacheOpenOfficePaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryApacheOpenOfficePaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryApacheOpenOfficePaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryApacheOpenOfficePaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryApacheOpenOfficePaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryApacheOpenOfficePaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryApacheOpenOfficePaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
