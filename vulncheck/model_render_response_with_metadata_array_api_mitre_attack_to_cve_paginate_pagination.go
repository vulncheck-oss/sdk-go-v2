...
// checks if the RenderResponseWithMetadataArrayApiMitreAttackToCVEPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayApiMitreAttackToCVEPaginatePagination{}

// RenderResponseWithMetadataArrayApiMitreAttackToCVEPaginatePagination struct for RenderResponseWithMetadataArrayApiMitreAttackToCVEPaginatePagination
...
func NewRenderResponseWithMetadataArrayApiMitreAttackToCVEPaginatePagination() *RenderResponseWithMetadataArrayApiMitreAttackToCVEPaginatePagination {
	this := RenderResponseWithMetadataArrayApiMitreAttackToCVEPaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []ApiMitreAttackToCVE and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayApiMitreAttackToCVEPaginatePagination) SetData(v []ApiMitreAttackToCVE) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayApiMitreAttackToCVEPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayApiMitreAttackToCVEPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayApiMitreAttackToCVEPaginatePagination struct {
	value *RenderResponseWithMetadataArrayApiMitreAttackToCVEPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayApiMitreAttackToCVEPaginatePagination) Get() *RenderResponseWithMetadataArrayApiMitreAttackToCVEPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayApiMitreAttackToCVEPaginatePagination) Set(val *RenderResponseWithMetadataArrayApiMitreAttackToCVEPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayApiMitreAttackToCVEPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayApiMitreAttackToCVEPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayApiMitreAttackToCVEPaginatePagination(val *RenderResponseWithMetadataArrayApiMitreAttackToCVEPaginatePagination) *NullableRenderResponseWithMetadataArrayApiMitreAttackToCVEPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayApiMitreAttackToCVEPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayApiMitreAttackToCVEPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayApiMitreAttackToCVEPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
