...
// checks if the AdvisoryMoxaAdvisory type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AdvisoryMoxaAdvisory{}

// AdvisoryMoxaAdvisory struct for AdvisoryMoxaAdvisory
...
func (o AdvisoryMoxaAdvisory) MarshalJSON() ([]byte, error) {
...
func (o AdvisoryMoxaAdvisory) ToMap() (map[string]interface{}, error) {
...
type NullableAdvisoryMoxaAdvisory struct {
	value *AdvisoryMoxaAdvisory
	isSet bool
}

func (v NullableAdvisoryMoxaAdvisory) Get() *AdvisoryMoxaAdvisory {
	return v.value
}

func (v *NullableAdvisoryMoxaAdvisory) Set(val *AdvisoryMoxaAdvisory) {
	v.value = val
	v.isSet = true
}

func (v NullableAdvisoryMoxaAdvisory) IsSet() bool {
	return v.isSet
}

func (v *NullableAdvisoryMoxaAdvisory) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAdvisoryMoxaAdvisory(val *AdvisoryMoxaAdvisory) *NullableAdvisoryMoxaAdvisory {
	return &NullableAdvisoryMoxaAdvisory{value: val, isSet: true}
}

func (v NullableAdvisoryMoxaAdvisory) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAdvisoryMoxaAdvisory) UnmarshalJSON(src []byte) error {
	v.isSet = true
