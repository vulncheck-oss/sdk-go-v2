...
// checks if the RenderResponseWithMetadataArrayAdvisorySymfonyPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisorySymfonyPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisorySymfonyPaginatePagination struct for RenderResponseWithMetadataArrayAdvisorySymfonyPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisorySymfonyPaginatePagination() *RenderResponseWithMetadataArrayAdvisorySymfonyPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisorySymfonyPaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisorySymfony and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisorySymfonyPaginatePagination) SetData(v []AdvisorySymfony) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisorySymfonyPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisorySymfonyPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisorySymfonyPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisorySymfonyPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisorySymfonyPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisorySymfonyPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisorySymfonyPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisorySymfonyPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisorySymfonyPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisorySymfonyPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisorySymfonyPaginatePagination(val *RenderResponseWithMetadataArrayAdvisorySymfonyPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisorySymfonyPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisorySymfonyPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisorySymfonyPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisorySymfonyPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
