...
// checks if the RenderResponseWithMetadataArrayAdvisorySentinelOnePaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisorySentinelOnePaginatePagination{}

// RenderResponseWithMetadataArrayAdvisorySentinelOnePaginatePagination struct for RenderResponseWithMetadataArrayAdvisorySentinelOnePaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisorySentinelOnePaginatePagination() *RenderResponseWithMetadataArrayAdvisorySentinelOnePaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisorySentinelOnePaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisorySentinelOne and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisorySentinelOnePaginatePagination) SetData(v []AdvisorySentinelOne) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisorySentinelOnePaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisorySentinelOnePaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisorySentinelOnePaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisorySentinelOnePaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisorySentinelOnePaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisorySentinelOnePaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisorySentinelOnePaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisorySentinelOnePaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisorySentinelOnePaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisorySentinelOnePaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisorySentinelOnePaginatePagination(val *RenderResponseWithMetadataArrayAdvisorySentinelOnePaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisorySentinelOnePaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisorySentinelOnePaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisorySentinelOnePaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisorySentinelOnePaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
