...
// checks if the RenderResponseWithMetadataArrayAdvisoryNHSPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryNHSPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryNHSPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryNHSPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryNHSPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryNHSPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryNHSPaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisoryNHS and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryNHSPaginatePagination) SetData(v []AdvisoryNHS) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryNHSPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryNHSPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryNHSPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryNHSPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryNHSPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryNHSPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryNHSPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryNHSPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryNHSPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryNHSPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryNHSPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryNHSPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryNHSPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryNHSPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryNHSPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryNHSPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
