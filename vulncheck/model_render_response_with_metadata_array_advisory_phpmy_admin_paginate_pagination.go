...
// checks if the RenderResponseWithMetadataArrayAdvisoryPHPMyAdminPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryPHPMyAdminPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryPHPMyAdminPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryPHPMyAdminPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryPHPMyAdminPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryPHPMyAdminPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryPHPMyAdminPaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisoryPHPMyAdmin and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryPHPMyAdminPaginatePagination) SetData(v []AdvisoryPHPMyAdmin) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryPHPMyAdminPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryPHPMyAdminPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryPHPMyAdminPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryPHPMyAdminPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryPHPMyAdminPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryPHPMyAdminPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryPHPMyAdminPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryPHPMyAdminPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryPHPMyAdminPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryPHPMyAdminPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryPHPMyAdminPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryPHPMyAdminPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryPHPMyAdminPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryPHPMyAdminPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryPHPMyAdminPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryPHPMyAdminPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
