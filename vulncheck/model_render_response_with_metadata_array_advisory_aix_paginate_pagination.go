...
// checks if the RenderResponseWithMetadataArrayAdvisoryAIXPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryAIXPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryAIXPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryAIXPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryAIXPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryAIXPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryAIXPaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisoryAIX and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryAIXPaginatePagination) SetData(v []AdvisoryAIX) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryAIXPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryAIXPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryAIXPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryAIXPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryAIXPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryAIXPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryAIXPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryAIXPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryAIXPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryAIXPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryAIXPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryAIXPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryAIXPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryAIXPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryAIXPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryAIXPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
