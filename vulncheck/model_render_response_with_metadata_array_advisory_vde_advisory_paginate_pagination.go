...
// checks if the RenderResponseWithMetadataArrayAdvisoryVDEAdvisoryPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryVDEAdvisoryPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryVDEAdvisoryPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryVDEAdvisoryPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryVDEAdvisoryPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryVDEAdvisoryPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryVDEAdvisoryPaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisoryVDEAdvisory and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryVDEAdvisoryPaginatePagination) SetData(v []AdvisoryVDEAdvisory) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryVDEAdvisoryPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryVDEAdvisoryPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryVDEAdvisoryPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryVDEAdvisoryPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryVDEAdvisoryPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryVDEAdvisoryPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryVDEAdvisoryPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryVDEAdvisoryPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryVDEAdvisoryPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryVDEAdvisoryPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryVDEAdvisoryPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryVDEAdvisoryPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryVDEAdvisoryPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryVDEAdvisoryPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryVDEAdvisoryPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryVDEAdvisoryPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
