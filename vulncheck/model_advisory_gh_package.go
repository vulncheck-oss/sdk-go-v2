...
// checks if the AdvisoryGHPackage type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AdvisoryGHPackage{}

// AdvisoryGHPackage struct for AdvisoryGHPackage
...
func (o AdvisoryGHPackage) MarshalJSON() ([]byte, error) {
...
func (o AdvisoryGHPackage) ToMap() (map[string]interface{}, error) {
...
type NullableAdvisoryGHPackage struct {
	value *AdvisoryGHPackage
	isSet bool
}

func (v NullableAdvisoryGHPackage) Get() *AdvisoryGHPackage {
	return v.value
}

func (v *NullableAdvisoryGHPackage) Set(val *AdvisoryGHPackage) {
	v.value = val
	v.isSet = true
}

func (v NullableAdvisoryGHPackage) IsSet() bool {
	return v.isSet
}

func (v *NullableAdvisoryGHPackage) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAdvisoryGHPackage(val *AdvisoryGHPackage) *NullableAdvisoryGHPackage {
	return &NullableAdvisoryGHPackage{value: val, isSet: true}
}

func (v NullableAdvisoryGHPackage) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAdvisoryGHPackage) UnmarshalJSON(src []byte) error {
	v.isSet = true
