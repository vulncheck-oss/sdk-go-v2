...
// checks if the RenderResponseWithMetadataArrayAdvisorySonatypePaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisorySonatypePaginatePagination{}

// RenderResponseWithMetadataArrayAdvisorySonatypePaginatePagination struct for RenderResponseWithMetadataArrayAdvisorySonatypePaginatePagination
type RenderResponseWithMetadataArrayAdvisorySonatypePaginatePagination struct {
	Benchmark *float32 `json:"_benchmark,omitempty"`
	Meta *PaginatePagination `json:"_meta,omitempty"`
	Data []AdvisorySonatype `json:"data,omitempty"`
}
...
func NewRenderResponseWithMetadataArrayAdvisorySonatypePaginatePagination() *RenderResponseWithMetadataArrayAdvisorySonatypePaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisorySonatypePaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisorySonatype and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisorySonatypePaginatePagination) SetData(v []AdvisorySonatype) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisorySonatypePaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisorySonatypePaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisorySonatypePaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisorySonatypePaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisorySonatypePaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisorySonatypePaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisorySonatypePaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisorySonatypePaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisorySonatypePaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisorySonatypePaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisorySonatypePaginatePagination(val *RenderResponseWithMetadataArrayAdvisorySonatypePaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisorySonatypePaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisorySonatypePaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisorySonatypePaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisorySonatypePaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
