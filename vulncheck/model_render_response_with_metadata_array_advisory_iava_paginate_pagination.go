...
// checks if the RenderResponseWithMetadataArrayAdvisoryIAVAPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryIAVAPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryIAVAPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryIAVAPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryIAVAPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryIAVAPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryIAVAPaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisoryIAVA and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryIAVAPaginatePagination) SetData(v []AdvisoryIAVA) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryIAVAPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryIAVAPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryIAVAPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryIAVAPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryIAVAPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryIAVAPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryIAVAPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryIAVAPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryIAVAPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryIAVAPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryIAVAPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryIAVAPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryIAVAPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryIAVAPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryIAVAPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryIAVAPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
