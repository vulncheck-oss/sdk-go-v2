...
// checks if the RenderResponseWithMetadataArrayAdvisoryMicrosoftCVRFPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryMicrosoftCVRFPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryMicrosoftCVRFPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryMicrosoftCVRFPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryMicrosoftCVRFPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryMicrosoftCVRFPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryMicrosoftCVRFPaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisoryMicrosoftCVRF and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryMicrosoftCVRFPaginatePagination) SetData(v []AdvisoryMicrosoftCVRF) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryMicrosoftCVRFPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryMicrosoftCVRFPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryMicrosoftCVRFPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryMicrosoftCVRFPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryMicrosoftCVRFPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryMicrosoftCVRFPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryMicrosoftCVRFPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryMicrosoftCVRFPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryMicrosoftCVRFPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryMicrosoftCVRFPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryMicrosoftCVRFPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryMicrosoftCVRFPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryMicrosoftCVRFPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryMicrosoftCVRFPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryMicrosoftCVRFPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryMicrosoftCVRFPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
