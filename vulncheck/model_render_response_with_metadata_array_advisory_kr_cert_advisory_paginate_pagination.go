...
// checks if the RenderResponseWithMetadataArrayAdvisoryKRCertAdvisoryPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryKRCertAdvisoryPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryKRCertAdvisoryPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryKRCertAdvisoryPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryKRCertAdvisoryPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryKRCertAdvisoryPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryKRCertAdvisoryPaginatePagination{}
	return &this
}
...
func (o *RenderResponseWithMetadataArrayAdvisoryKRCertAdvisoryPaginatePagination) GetData() []AdvisoryKRCertAdvisory {
	if o == nil || IsNil(o.Data) {
		var ret []AdvisoryKRCertAdvisory
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []AdvisoryKRCertAdvisory and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryKRCertAdvisoryPaginatePagination) SetData(v []AdvisoryKRCertAdvisory) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryKRCertAdvisoryPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryKRCertAdvisoryPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryKRCertAdvisoryPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryKRCertAdvisoryPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryKRCertAdvisoryPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryKRCertAdvisoryPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryKRCertAdvisoryPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryKRCertAdvisoryPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryKRCertAdvisoryPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryKRCertAdvisoryPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryKRCertAdvisoryPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryKRCertAdvisoryPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryKRCertAdvisoryPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryKRCertAdvisoryPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryKRCertAdvisoryPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryKRCertAdvisoryPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
