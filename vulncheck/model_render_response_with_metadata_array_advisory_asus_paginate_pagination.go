...
// checks if the RenderResponseWithMetadataArrayAdvisoryAsusPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryAsusPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryAsusPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryAsusPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryAsusPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryAsusPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryAsusPaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisoryAsus and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryAsusPaginatePagination) SetData(v []AdvisoryAsus) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryAsusPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryAsusPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryAsusPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryAsusPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryAsusPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryAsusPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryAsusPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryAsusPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryAsusPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryAsusPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryAsusPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryAsusPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryAsusPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryAsusPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryAsusPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryAsusPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
