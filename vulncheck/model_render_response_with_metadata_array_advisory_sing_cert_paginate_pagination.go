...
// checks if the RenderResponseWithMetadataArrayAdvisorySingCertPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisorySingCertPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisorySingCertPaginatePagination struct for RenderResponseWithMetadataArrayAdvisorySingCertPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisorySingCertPaginatePagination() *RenderResponseWithMetadataArrayAdvisorySingCertPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisorySingCertPaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisorySingCert and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisorySingCertPaginatePagination) SetData(v []AdvisorySingCert) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisorySingCertPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisorySingCertPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisorySingCertPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisorySingCertPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisorySingCertPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisorySingCertPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisorySingCertPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisorySingCertPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisorySingCertPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisorySingCertPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisorySingCertPaginatePagination(val *RenderResponseWithMetadataArrayAdvisorySingCertPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisorySingCertPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisorySingCertPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisorySingCertPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisorySingCertPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
