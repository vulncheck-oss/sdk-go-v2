...
// checks if the RenderResponseWithMetadataArrayAdvisoryArubaPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryArubaPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryArubaPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryArubaPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryArubaPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryArubaPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryArubaPaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisoryAruba and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryArubaPaginatePagination) SetData(v []AdvisoryAruba) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryArubaPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryArubaPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryArubaPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryArubaPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryArubaPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryArubaPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryArubaPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryArubaPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryArubaPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryArubaPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryArubaPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryArubaPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryArubaPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryArubaPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryArubaPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryArubaPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
