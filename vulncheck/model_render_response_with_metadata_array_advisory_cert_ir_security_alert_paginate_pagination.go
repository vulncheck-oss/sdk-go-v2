...
// checks if the RenderResponseWithMetadataArrayAdvisoryCertIRSecurityAlertPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryCertIRSecurityAlertPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryCertIRSecurityAlertPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryCertIRSecurityAlertPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryCertIRSecurityAlertPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryCertIRSecurityAlertPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryCertIRSecurityAlertPaginatePagination{}
	return &this
}
...
func (o *RenderResponseWithMetadataArrayAdvisoryCertIRSecurityAlertPaginatePagination) GetData() []AdvisoryCertIRSecurityAlert {
	if o == nil || IsNil(o.Data) {
		var ret []AdvisoryCertIRSecurityAlert
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []AdvisoryCertIRSecurityAlert and assigns it to the Data field.
...
func (o RenderResponseWithMetadataArrayAdvisoryCertIRSecurityAlertPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryCertIRSecurityAlertPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryCertIRSecurityAlertPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryCertIRSecurityAlertPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryCertIRSecurityAlertPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryCertIRSecurityAlertPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryCertIRSecurityAlertPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryCertIRSecurityAlertPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryCertIRSecurityAlertPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryCertIRSecurityAlertPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryCertIRSecurityAlertPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryCertIRSecurityAlertPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryCertIRSecurityAlertPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryCertIRSecurityAlertPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryCertIRSecurityAlertPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryCertIRSecurityAlertPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
