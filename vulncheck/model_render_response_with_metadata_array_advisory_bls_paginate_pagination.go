...
// checks if the RenderResponseWithMetadataArrayAdvisoryBLSPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryBLSPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryBLSPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryBLSPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryBLSPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryBLSPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryBLSPaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisoryBLS and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryBLSPaginatePagination) SetData(v []AdvisoryBLS) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryBLSPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryBLSPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryBLSPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryBLSPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryBLSPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryBLSPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryBLSPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryBLSPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryBLSPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryBLSPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryBLSPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryBLSPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryBLSPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryBLSPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryBLSPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryBLSPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
