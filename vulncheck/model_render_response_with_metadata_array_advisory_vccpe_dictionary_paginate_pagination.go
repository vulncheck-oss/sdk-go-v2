...
// checks if the RenderResponseWithMetadataArrayAdvisoryVCCPEDictionaryPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryVCCPEDictionaryPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryVCCPEDictionaryPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryVCCPEDictionaryPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryVCCPEDictionaryPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryVCCPEDictionaryPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryVCCPEDictionaryPaginatePagination{}
	return &this
}
...
func (o *RenderResponseWithMetadataArrayAdvisoryVCCPEDictionaryPaginatePagination) GetData() []AdvisoryVCCPEDictionary {
	if o == nil || IsNil(o.Data) {
		var ret []AdvisoryVCCPEDictionary
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []AdvisoryVCCPEDictionary and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryVCCPEDictionaryPaginatePagination) SetData(v []AdvisoryVCCPEDictionary) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryVCCPEDictionaryPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryVCCPEDictionaryPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryVCCPEDictionaryPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryVCCPEDictionaryPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryVCCPEDictionaryPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryVCCPEDictionaryPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryVCCPEDictionaryPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryVCCPEDictionaryPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryVCCPEDictionaryPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryVCCPEDictionaryPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryVCCPEDictionaryPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryVCCPEDictionaryPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryVCCPEDictionaryPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryVCCPEDictionaryPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryVCCPEDictionaryPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryVCCPEDictionaryPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
