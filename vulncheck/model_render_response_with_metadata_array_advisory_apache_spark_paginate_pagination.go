...
// checks if the RenderResponseWithMetadataArrayAdvisoryApacheSparkPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryApacheSparkPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryApacheSparkPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryApacheSparkPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryApacheSparkPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryApacheSparkPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryApacheSparkPaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisoryApacheSpark and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryApacheSparkPaginatePagination) SetData(v []AdvisoryApacheSpark) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryApacheSparkPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryApacheSparkPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryApacheSparkPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryApacheSparkPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryApacheSparkPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryApacheSparkPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryApacheSparkPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryApacheSparkPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryApacheSparkPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryApacheSparkPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryApacheSparkPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryApacheSparkPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryApacheSparkPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryApacheSparkPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryApacheSparkPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryApacheSparkPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
