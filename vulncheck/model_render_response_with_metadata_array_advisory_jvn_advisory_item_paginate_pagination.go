...
// checks if the RenderResponseWithMetadataArrayAdvisoryJVNAdvisoryItemPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryJVNAdvisoryItemPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryJVNAdvisoryItemPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryJVNAdvisoryItemPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryJVNAdvisoryItemPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryJVNAdvisoryItemPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryJVNAdvisoryItemPaginatePagination{}
	return &this
}
...
func (o *RenderResponseWithMetadataArrayAdvisoryJVNAdvisoryItemPaginatePagination) GetData() []AdvisoryJVNAdvisoryItem {
	if o == nil || IsNil(o.Data) {
		var ret []AdvisoryJVNAdvisoryItem
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []AdvisoryJVNAdvisoryItem and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryJVNAdvisoryItemPaginatePagination) SetData(v []AdvisoryJVNAdvisoryItem) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryJVNAdvisoryItemPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryJVNAdvisoryItemPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryJVNAdvisoryItemPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryJVNAdvisoryItemPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryJVNAdvisoryItemPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryJVNAdvisoryItemPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryJVNAdvisoryItemPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryJVNAdvisoryItemPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryJVNAdvisoryItemPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryJVNAdvisoryItemPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryJVNAdvisoryItemPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryJVNAdvisoryItemPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryJVNAdvisoryItemPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryJVNAdvisoryItemPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryJVNAdvisoryItemPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryJVNAdvisoryItemPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
