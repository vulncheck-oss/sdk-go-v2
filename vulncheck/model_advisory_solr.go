...
// checks if the AdvisorySolr type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AdvisorySolr{}

// AdvisorySolr struct for AdvisorySolr
...
func (o AdvisorySolr) MarshalJSON() ([]byte, error) {
...
func (o AdvisorySolr) ToMap() (map[string]interface{}, error) {
...
type NullableAdvisorySolr struct {
	value *AdvisorySolr
	isSet bool
}

func (v NullableAdvisorySolr) Get() *AdvisorySolr {
	return v.value
}

func (v *NullableAdvisorySolr) Set(val *AdvisorySolr) {
	v.value = val
	v.isSet = true
}

func (v NullableAdvisorySolr) IsSet() bool {
	return v.isSet
}

func (v *NullableAdvisorySolr) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAdvisorySolr(val *AdvisorySolr) *NullableAdvisorySolr {
	return &NullableAdvisorySolr{value: val, isSet: true}
}

func (v NullableAdvisorySolr) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAdvisorySolr) UnmarshalJSON(src []byte) error {
	v.isSet = true
