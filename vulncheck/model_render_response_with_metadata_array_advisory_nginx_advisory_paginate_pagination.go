...
// checks if the RenderResponseWithMetadataArrayAdvisoryNginxAdvisoryPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryNginxAdvisoryPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryNginxAdvisoryPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryNginxAdvisoryPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryNginxAdvisoryPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryNginxAdvisoryPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryNginxAdvisoryPaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisoryNginxAdvisory and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryNginxAdvisoryPaginatePagination) SetData(v []AdvisoryNginxAdvisory) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryNginxAdvisoryPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryNginxAdvisoryPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryNginxAdvisoryPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryNginxAdvisoryPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryNginxAdvisoryPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryNginxAdvisoryPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryNginxAdvisoryPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryNginxAdvisoryPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryNginxAdvisoryPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryNginxAdvisoryPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryNginxAdvisoryPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryNginxAdvisoryPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryNginxAdvisoryPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryNginxAdvisoryPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryNginxAdvisoryPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryNginxAdvisoryPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
