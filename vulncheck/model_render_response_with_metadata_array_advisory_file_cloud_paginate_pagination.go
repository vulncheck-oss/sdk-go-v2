...
// checks if the RenderResponseWithMetadataArrayAdvisoryFileCloudPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryFileCloudPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryFileCloudPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryFileCloudPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryFileCloudPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryFileCloudPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryFileCloudPaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisoryFileCloud and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryFileCloudPaginatePagination) SetData(v []AdvisoryFileCloud) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryFileCloudPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryFileCloudPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryFileCloudPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryFileCloudPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryFileCloudPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryFileCloudPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryFileCloudPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryFileCloudPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryFileCloudPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryFileCloudPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryFileCloudPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryFileCloudPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryFileCloudPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryFileCloudPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryFileCloudPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryFileCloudPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
