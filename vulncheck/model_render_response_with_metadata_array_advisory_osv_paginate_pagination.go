...
// checks if the RenderResponseWithMetadataArrayAdvisoryOSVPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryOSVPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryOSVPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryOSVPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryOSVPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryOSVPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryOSVPaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisoryOSV and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryOSVPaginatePagination) SetData(v []AdvisoryOSV) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryOSVPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryOSVPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryOSVPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryOSVPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryOSVPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryOSVPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryOSVPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryOSVPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryOSVPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryOSVPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryOSVPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryOSVPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryOSVPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryOSVPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryOSVPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryOSVPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
