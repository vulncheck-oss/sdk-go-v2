...
// checks if the RenderResponseWithMetadataArrayAdvisoryPureStoragePaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryPureStoragePaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryPureStoragePaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryPureStoragePaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryPureStoragePaginatePagination() *RenderResponseWithMetadataArrayAdvisoryPureStoragePaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryPureStoragePaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisoryPureStorage and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryPureStoragePaginatePagination) SetData(v []AdvisoryPureStorage) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryPureStoragePaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryPureStoragePaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryPureStoragePaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryPureStoragePaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryPureStoragePaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryPureStoragePaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryPureStoragePaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryPureStoragePaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryPureStoragePaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryPureStoragePaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryPureStoragePaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryPureStoragePaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryPureStoragePaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryPureStoragePaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryPureStoragePaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryPureStoragePaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
