...
// checks if the RenderResponseWithMetadataArrayAdvisoryEndOfLifePaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryEndOfLifePaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryEndOfLifePaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryEndOfLifePaginatePagination
type RenderResponseWithMetadataArrayAdvisoryEndOfLifePaginatePagination struct {
	Benchmark *float32 `json:"_benchmark,omitempty"`
	Meta *PaginatePagination `json:"_meta,omitempty"`
	Data []AdvisoryEndOfLife `json:"data,omitempty"`
}
...
func NewRenderResponseWithMetadataArrayAdvisoryEndOfLifePaginatePagination() *RenderResponseWithMetadataArrayAdvisoryEndOfLifePaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryEndOfLifePaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisoryEndOfLife and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryEndOfLifePaginatePagination) SetData(v []AdvisoryEndOfLife) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryEndOfLifePaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryEndOfLifePaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryEndOfLifePaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryEndOfLifePaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryEndOfLifePaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryEndOfLifePaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryEndOfLifePaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryEndOfLifePaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryEndOfLifePaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryEndOfLifePaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryEndOfLifePaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryEndOfLifePaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryEndOfLifePaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryEndOfLifePaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryEndOfLifePaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryEndOfLifePaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
