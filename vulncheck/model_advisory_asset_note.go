...
// checks if the AdvisoryAssetNote type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AdvisoryAssetNote{}

// AdvisoryAssetNote struct for AdvisoryAssetNote
...
func (o AdvisoryAssetNote) MarshalJSON() ([]byte, error) {
...
func (o AdvisoryAssetNote) ToMap() (map[string]interface{}, error) {
...
type NullableAdvisoryAssetNote struct {
	value *AdvisoryAssetNote
	isSet bool
}

func (v NullableAdvisoryAssetNote) Get() *AdvisoryAssetNote {
	return v.value
}

func (v *NullableAdvisoryAssetNote) Set(val *AdvisoryAssetNote) {
	v.value = val
	v.isSet = true
}

func (v NullableAdvisoryAssetNote) IsSet() bool {
	return v.isSet
}

func (v *NullableAdvisoryAssetNote) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAdvisoryAssetNote(val *AdvisoryAssetNote) *NullableAdvisoryAssetNote {
	return &NullableAdvisoryAssetNote{value: val, isSet: true}
}

func (v NullableAdvisoryAssetNote) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAdvisoryAssetNote) UnmarshalJSON(src []byte) error {
	v.isSet = true
