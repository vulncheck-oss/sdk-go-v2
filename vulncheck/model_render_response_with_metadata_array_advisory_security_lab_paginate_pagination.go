...
// checks if the RenderResponseWithMetadataArrayAdvisorySecurityLabPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisorySecurityLabPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisorySecurityLabPaginatePagination struct for RenderResponseWithMetadataArrayAdvisorySecurityLabPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisorySecurityLabPaginatePagination() *RenderResponseWithMetadataArrayAdvisorySecurityLabPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisorySecurityLabPaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisorySecurityLab and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisorySecurityLabPaginatePagination) SetData(v []AdvisorySecurityLab) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisorySecurityLabPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisorySecurityLabPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisorySecurityLabPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisorySecurityLabPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisorySecurityLabPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisorySecurityLabPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisorySecurityLabPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisorySecurityLabPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisorySecurityLabPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisorySecurityLabPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisorySecurityLabPaginatePagination(val *RenderResponseWithMetadataArrayAdvisorySecurityLabPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisorySecurityLabPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisorySecurityLabPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisorySecurityLabPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisorySecurityLabPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
