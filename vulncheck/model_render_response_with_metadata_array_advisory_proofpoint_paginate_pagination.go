...
// checks if the RenderResponseWithMetadataArrayAdvisoryProofpointPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryProofpointPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryProofpointPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryProofpointPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryProofpointPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryProofpointPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryProofpointPaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisoryProofpoint and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryProofpointPaginatePagination) SetData(v []AdvisoryProofpoint) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryProofpointPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryProofpointPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryProofpointPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryProofpointPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryProofpointPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryProofpointPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryProofpointPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryProofpointPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryProofpointPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryProofpointPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryProofpointPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryProofpointPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryProofpointPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryProofpointPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryProofpointPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryProofpointPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
