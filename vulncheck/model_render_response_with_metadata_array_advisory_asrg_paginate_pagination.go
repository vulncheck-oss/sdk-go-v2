...
// checks if the RenderResponseWithMetadataArrayAdvisoryASRGPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryASRGPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryASRGPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryASRGPaginatePagination
...
func NewRenderResponseWithMetadataArrayAdvisoryASRGPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryASRGPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryASRGPaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisoryASRG and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryASRGPaginatePagination) SetData(v []AdvisoryASRG) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryASRGPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryASRGPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryASRGPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryASRGPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryASRGPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryASRGPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryASRGPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryASRGPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryASRGPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryASRGPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryASRGPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryASRGPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryASRGPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryASRGPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryASRGPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryASRGPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
