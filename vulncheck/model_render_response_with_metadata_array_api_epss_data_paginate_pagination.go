...
// checks if the RenderResponseWithMetadataArrayApiEPSSDataPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayApiEPSSDataPaginatePagination{}

// RenderResponseWithMetadataArrayApiEPSSDataPaginatePagination struct for RenderResponseWithMetadataArrayApiEPSSDataPaginatePagination
...
func NewRenderResponseWithMetadataArrayApiEPSSDataPaginatePagination() *RenderResponseWithMetadataArrayApiEPSSDataPaginatePagination {
	this := RenderResponseWithMetadataArrayApiEPSSDataPaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []ApiEPSSData and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayApiEPSSDataPaginatePagination) SetData(v []ApiEPSSData) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayApiEPSSDataPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayApiEPSSDataPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayApiEPSSDataPaginatePagination struct {
	value *RenderResponseWithMetadataArrayApiEPSSDataPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayApiEPSSDataPaginatePagination) Get() *RenderResponseWithMetadataArrayApiEPSSDataPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayApiEPSSDataPaginatePagination) Set(val *RenderResponseWithMetadataArrayApiEPSSDataPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayApiEPSSDataPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayApiEPSSDataPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayApiEPSSDataPaginatePagination(val *RenderResponseWithMetadataArrayApiEPSSDataPaginatePagination) *NullableRenderResponseWithMetadataArrayApiEPSSDataPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayApiEPSSDataPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayApiEPSSDataPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayApiEPSSDataPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
