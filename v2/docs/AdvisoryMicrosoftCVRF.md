...
`func (o *AdvisoryMicrosoftCVRF) GetUpdatedAt() string`

GetUpdatedAt returns the UpdatedAt field if non-nil, zero value otherwise.

### GetUpdatedAtOk

`func (o *AdvisoryMicrosoftCVRF) GetUpdatedAtOk() (*string, bool)`
...
`func (o *AdvisoryMicrosoftCVRF) SetUpdatedAt(v string)`

SetUpdatedAt sets UpdatedAt field to given value.

### HasUpdatedAt

`func (o *AdvisoryMicrosoftCVRF) HasUpdatedAt() bool`
