...
// checks if the AdvisoryPhilipsAdvisory type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AdvisoryPhilipsAdvisory{}

// AdvisoryPhilipsAdvisory advisory.PhilipsAdvisory
...
func (o AdvisoryPhilipsAdvisory) MarshalJSON() ([]byte, error) {
...
type NullableAdvisoryPhilipsAdvisory struct {
	value *AdvisoryPhilipsAdvisory
	isSet bool
}

func (v NullableAdvisoryPhilipsAdvisory) Get() *AdvisoryPhilipsAdvisory {
	return v.value
}

func (v *NullableAdvisoryPhilipsAdvisory) Set(val *AdvisoryPhilipsAdvisory) {
	v.value = val
	v.isSet = true
}

func (v NullableAdvisoryPhilipsAdvisory) IsSet() bool {
	return v.isSet
}

func (v *NullableAdvisoryPhilipsAdvisory) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAdvisoryPhilipsAdvisory(val *AdvisoryPhilipsAdvisory) *NullableAdvisoryPhilipsAdvisory {
	return &NullableAdvisoryPhilipsAdvisory{value: val, isSet: true}
}

func (v NullableAdvisoryPhilipsAdvisory) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAdvisoryPhilipsAdvisory) UnmarshalJSON(src []byte) error {
	v.isSet = true
