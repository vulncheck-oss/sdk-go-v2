...
// checks if the AdvisoryFanuc type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AdvisoryFanuc{}

// AdvisoryFanuc advisory.Fanuc
...
func (o AdvisoryFanuc) MarshalJSON() ([]byte, error) {
...
func (o AdvisoryFanuc) ToMap() (map[string]interface{}, error) {
...
type NullableAdvisoryFanuc struct {
	value *AdvisoryFanuc
	isSet bool
}

func (v NullableAdvisoryFanuc) Get() *AdvisoryFanuc {
	return v.value
}

func (v *NullableAdvisoryFanuc) Set(val *AdvisoryFanuc) {
	v.value = val
	v.isSet = true
}

func (v NullableAdvisoryFanuc) IsSet() bool {
	return v.isSet
}

func (v *NullableAdvisoryFanuc) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAdvisoryFanuc(val *AdvisoryFanuc) *NullableAdvisoryFanuc {
	return &NullableAdvisoryFanuc{value: val, isSet: true}
}

func (v NullableAdvisoryFanuc) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAdvisoryFanuc) UnmarshalJSON(src []byte) error {
	v.isSet = true
