...
// checks if the AdvisoryQualys type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AdvisoryQualys{}

// AdvisoryQualys advisory.Qualys
...
// SetExploits gets a reference to the given []string and assigns it to the Exploits field.
...
func (o AdvisoryQualys) MarshalJSON() ([]byte, error) {
...
func (o AdvisoryQualys) ToMap() (map[string]interface{}, error) {
...
type NullableAdvisoryQualys struct {
	value *AdvisoryQualys
	isSet bool
}

func (v NullableAdvisoryQualys) Get() *AdvisoryQualys {
	return v.value
}

func (v *NullableAdvisoryQualys) Set(val *AdvisoryQualys) {
	v.value = val
	v.isSet = true
}

func (v NullableAdvisoryQualys) IsSet() bool {
	return v.isSet
}

func (v *NullableAdvisoryQualys) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAdvisoryQualys(val *AdvisoryQualys) *NullableAdvisoryQualys {
	return &NullableAdvisoryQualys{value: val, isSet: true}
}

func (v NullableAdvisoryQualys) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAdvisoryQualys) UnmarshalJSON(src []byte) error {
	v.isSet = true
