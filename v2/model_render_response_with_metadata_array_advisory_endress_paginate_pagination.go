...
// checks if the RenderResponseWithMetadataArrayAdvisoryEndressPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryEndressPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryEndressPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryEndressPaginatePagination
type RenderResponseWithMetadataArrayAdvisoryEndressPaginatePagination struct {
	Benchmark *float32 `json:"_benchmark,omitempty"`
	Meta *PaginatePagination `json:"_meta,omitempty"`
	Data []AdvisoryEndress `json:"data,omitempty"`
}
...
func NewRenderResponseWithMetadataArrayAdvisoryEndressPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryEndressPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryEndressPaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisoryEndress and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryEndressPaginatePagination) SetData(v []AdvisoryEndress) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryEndressPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryEndressPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryEndressPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryEndressPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryEndressPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryEndressPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryEndressPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryEndressPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryEndressPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryEndressPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryEndressPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryEndressPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryEndressPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryEndressPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryEndressPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryEndressPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
