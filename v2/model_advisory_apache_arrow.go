...
// checks if the AdvisoryApacheArrow type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AdvisoryApacheArrow{}

// AdvisoryApacheArrow advisory.ApacheArrow
...
func (o AdvisoryApacheArrow) MarshalJSON() ([]byte, error) {
...
func (o AdvisoryApacheArrow) ToMap() (map[string]interface{}, error) {
...
type NullableAdvisoryApacheArrow struct {
	value *AdvisoryApacheArrow
	isSet bool
}

func (v NullableAdvisoryApacheArrow) Get() *AdvisoryApacheArrow {
	return v.value
}

func (v *NullableAdvisoryApacheArrow) Set(val *AdvisoryApacheArrow) {
	v.value = val
	v.isSet = true
}

func (v NullableAdvisoryApacheArrow) IsSet() bool {
	return v.isSet
}

func (v *NullableAdvisoryApacheArrow) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAdvisoryApacheArrow(val *AdvisoryApacheArrow) *NullableAdvisoryApacheArrow {
	return &NullableAdvisoryApacheArrow{value: val, isSet: true}
}

func (v NullableAdvisoryApacheArrow) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAdvisoryApacheArrow) UnmarshalJSON(src []byte) error {
	v.isSet = true
