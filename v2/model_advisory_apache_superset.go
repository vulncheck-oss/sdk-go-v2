...
// checks if the AdvisoryApacheSuperset type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AdvisoryApacheSuperset{}

// AdvisoryApacheSuperset advisory.ApacheSuperset
...
func (o AdvisoryApacheSuperset) MarshalJSON() ([]byte, error) {
...
func (o AdvisoryApacheSuperset) ToMap() (map[string]interface{}, error) {
...
type NullableAdvisoryApacheSuperset struct {
	value *AdvisoryApacheSuperset
	isSet bool
}

func (v NullableAdvisoryApacheSuperset) Get() *AdvisoryApacheSuperset {
	return v.value
}

func (v *NullableAdvisoryApacheSuperset) Set(val *AdvisoryApacheSuperset) {
	v.value = val
	v.isSet = true
}

func (v NullableAdvisoryApacheSuperset) IsSet() bool {
	return v.isSet
}

func (v *NullableAdvisoryApacheSuperset) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAdvisoryApacheSuperset(val *AdvisoryApacheSuperset) *NullableAdvisoryApacheSuperset {
	return &NullableAdvisoryApacheSuperset{value: val, isSet: true}
}

func (v NullableAdvisoryApacheSuperset) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAdvisoryApacheSuperset) UnmarshalJSON(src []byte) error {
	v.isSet = true
