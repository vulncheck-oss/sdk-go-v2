...
// checks if the RenderResponseWithMetadataArrayAdvisoryGHSAPaginatePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderResponseWithMetadataArrayAdvisoryGHSAPaginatePagination{}

// RenderResponseWithMetadataArrayAdvisoryGHSAPaginatePagination struct for RenderResponseWithMetadataArrayAdvisoryGHSAPaginatePagination
type RenderResponseWithMetadataArrayAdvisoryGHSAPaginatePagination struct {
	Benchmark *float32 `json:"_benchmark,omitempty"`
	Meta *PaginatePagination `json:"_meta,omitempty"`
	Data []AdvisoryGHSA `json:"data,omitempty"`
}
...
func NewRenderResponseWithMetadataArrayAdvisoryGHSAPaginatePagination() *RenderResponseWithMetadataArrayAdvisoryGHSAPaginatePagination {
	this := RenderResponseWithMetadataArrayAdvisoryGHSAPaginatePagination{}
	return &this
}
...
// SetData gets a reference to the given []AdvisoryGHSA and assigns it to the Data field.
func (o *RenderResponseWithMetadataArrayAdvisoryGHSAPaginatePagination) SetData(v []AdvisoryGHSA) {
	o.Data = v
}

func (o RenderResponseWithMetadataArrayAdvisoryGHSAPaginatePagination) MarshalJSON() ([]byte, error) {
...
func (o RenderResponseWithMetadataArrayAdvisoryGHSAPaginatePagination) ToMap() (map[string]interface{}, error) {
...
type NullableRenderResponseWithMetadataArrayAdvisoryGHSAPaginatePagination struct {
	value *RenderResponseWithMetadataArrayAdvisoryGHSAPaginatePagination
	isSet bool
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryGHSAPaginatePagination) Get() *RenderResponseWithMetadataArrayAdvisoryGHSAPaginatePagination {
	return v.value
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryGHSAPaginatePagination) Set(val *RenderResponseWithMetadataArrayAdvisoryGHSAPaginatePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryGHSAPaginatePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryGHSAPaginatePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderResponseWithMetadataArrayAdvisoryGHSAPaginatePagination(val *RenderResponseWithMetadataArrayAdvisoryGHSAPaginatePagination) *NullableRenderResponseWithMetadataArrayAdvisoryGHSAPaginatePagination {
	return &NullableRenderResponseWithMetadataArrayAdvisoryGHSAPaginatePagination{value: val, isSet: true}
}

func (v NullableRenderResponseWithMetadataArrayAdvisoryGHSAPaginatePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderResponseWithMetadataArrayAdvisoryGHSAPaginatePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
